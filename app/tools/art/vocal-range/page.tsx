      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px' }}>
              <thead>
                <tr style={{ borderBottom: '1px solid var(--border)' }}>
                  ...
                  <th scope="col" style={{ padding: '10px 12px', textAlign: 'center', color: 'var(--purple-600)', fontWeight: 700 }}>음역</th>
              ...
              <tbody>
                {[
                  ...
                  <tr key={i} style={{ borderBottom: '1px solid var(--border)', background: i % 2 === 0 ? 'transparent' : 'var(--bg2)' }}>
                    ...
                    <td style={{ padding: '10px 12px', textAlign: 'center', color: 'var(--purple-600)', fontFamily: 'var(--font-sans)', fontWeight: 800 }}>{row[1]}</td>
        ...
        <section>
          ...
          <ul style={{ fontSize: '13px', color: 'var(--muted)', lineHeight: 1.85, listStyle: 'none', padding: 0, margin: 0 }}>
            ...
            <li>· <strong style={{ color: 'var(--orange-600)' }}>±3~6 키</strong> — 큰 폭 조정 필요 (편곡 영향 있음)</li>
          </ul>
        ...
        <section>
          ...
          <div style={{ background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 'var(--radius-m)', padding: '14px 18px' }}>
            <ul style={{ paddingLeft: 18, margin: 0, fontSize: 13, color: 'var(--muted)', lineHeight: 1.85 }}>
              ...
              <li style={{ color: 'var(--red-600)' }}><strong>금기 — 무리한 고음·소리 지르기</strong>: 성대 결절·출혈 위험</li>
            </ul>
          </div>
          <p style={{ fontSize: '13px', color: 'var(--muted)', marginTop: '10px', lineHeight: 1.7 }}>
