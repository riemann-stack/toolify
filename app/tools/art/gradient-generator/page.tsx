  ...
  return (
    <div style={{ maxWidth: '880px', margin: '0 auto', padding: '60px 24px 80px' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px' }}>
              ...
              <tbody>
                {[
                  ...
                  ['OKLCH', '인지 균등 (CSS Color 4)', 'UI 그라디언트 ★ 권장',      '채도 높은 색은 색역 밖으로 나갈 수 있음'],
        ...
        {/* 2. 그라디언트 유형 */}
        <section>
          <h2 style={sectionTitle}>그라디언트 유형 6종 — 언제 무엇을 쓸까</h2>
          <ul style={{ ...faqAnswer, paddingLeft: '20px', lineHeight: 2 }}>
            ...
            <li><strong>Conic</strong> — 시계 방향으로 회전. 도넛 차트·360° 색환·로딩 인디케이터.</li>
            <li><strong>Mesh</strong> — 4 모서리 색상 합성. 부드럽고 트렌디한 SaaS 스타일 (Stripe·Mesh.cool). CSS는 multi-radial-gradient로 출력.</li>
            <li><strong>Repeating (Linear·Radial)</strong> — 한 싸이클을 반복해 패턴·스트라이프·줄무늬 배경. 반복 주기 슬라이더(5~100%)로 싸이클 너비를 조절합니다.</li>
          </ul>
        </section>
...
// 사용: <div className="bg-mesh-1" />`}</div>
            ...
            <div>
              ...
              <div style={faqAnswer}>
                Figma의 <strong>Angular 그라디언트</strong>가 CSS conic-gradient에 해당합니다 — fill 종류에서 Angular를 선택하고 색상 스톱을 같은 순서로 배치하면 됩니다. Sketch도 Angular를 지원합니다. 주의할 점은 파일 교환 쪽입니다:
                <ul style={{ paddingLeft: '20px', margin: '8px 0' }}>
                  <li><strong>SVG 임포트는 부정확</strong>: SVG 포맷 자체가 conic을 지원하지 않아 본 도구의 SVG 내보내기는 radial로 폴백됩니다</li>
                  <li><strong>Figma CSS 복사(Dev Mode)</strong>: angular 그라디언트에서 값이 부정확하다는 보고가 있습니다</li>
                  <li><strong>정확한 이관</strong>: 본 도구의 PNG 다운로드를 배치하거나, 툴 안에서 Angular로 다시 만드는 것이 안전합니다</li>
                </ul>
              </div>
            </div>
