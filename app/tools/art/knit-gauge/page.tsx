...
const FAQ_LD = [
  ...
  { "q":"코 게이지와 단 게이지 둘 다 맞춰야 하나요?","a":"코 게이지가 우선입니다. 코 게이지는 가로 폭(둘레)을 결정하므로 옷의 핏을 좌우해요. 단 게이지는 길이를 결정하지만, 길이는 \"몇 단\"이 아닌 \"cm로\" 측정해 마감하면 됩니다 (예: \"55cm가 될 때까지 떠 줍니다\"). 실제 패턴 다수도 길이는 cm로 표기. 패턴 대비 코 게이지 차이(%)와 단 게이지 차이(%)가 15%p 이상 벌어지면 본 도구가 자동으로 경고를 띄워 줍니다 (탭 2)." },
    ...
    <div style={{ maxWidth: '880px', margin: '0 auto', padding: '60px 24px 80px' }}>
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          ...
          실제 패턴 다수도 길이는 cm로 표기. 패턴 대비 코 게이지 차이(%)와 단 게이지 차이(%)가 15%p 이상 벌어지면 본 도구가 자동으로 경고를 띄워 줍니다 (탭 2).
        </p>
      </details>
