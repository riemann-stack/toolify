...
const FAQ_LD = [
  ...
  { "q":"한국·미국·일본 단위 차이는?","a":"코 게이지 측정 단위: • 한국·유럽: 10cm² (4 inch² 와 거의 동일) • 미국: 4 inch² (= 10.16cm) • 일본: 10cm² 표준 본 도구는 셋 다 토글로 지원합니다. 또한 바늘 호수도 mm·US·UK 동시 표기 (탭 4). • 미국식 6호 = 4.0mm = 영국식 8호 • 일본식 호수는 mm 표기와 약간 달라 (일본 5호 = 3.6mm). 본 도구는 mm 단위 우선." },
