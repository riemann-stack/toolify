...
const FAQ_LD = [
  ...
  { q: "안료 농도가 다른데 같은 비율이면 같은 색?", a: "아닙니다. 같은 1ml라도 <strong>안료 농도(pigment load)</strong>에 따라 결과가 크게 달라집니다.<br /> • <strong>전문가 물감</strong>(신한 SWC·홀베인·다니엘 스미스): 안료 농도 ↑ → 적은 양으로도 진함<br /> • <strong>학생용 물감</strong>(펜텔 포스터컬러, 알파·신한 학생용 라인 등): 안료 농도 ↓, 체질안료 ↑ → 같은 양이라도 흐림<br /> • <strong>젤 푸드컬러</strong>: 액상보다 3~5배 수준으로 진하게 소개됨 → 훨씬 적게 사용<br /> 본 도구의 [분량 환산] 탭에 <strong>사용량 보정 슬라이더(0.5×~2.0×)</strong>가 있으니, 진한 안료는 0.5×, 흐린 안료는 1.5×~2× 적용하세요." },
...
export default function PaintMixPage() {
  return (
    <div style={{ maxWidth: '880px', margin: '0 auto', padding: '60px 24px 80px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 10, marginTop: 14 }}>
          <div style={{ background: 'var(--bg3)', borderTop: '3px solid #9333EA', borderRadius: 10, padding: '14px 16px' }}>
            ...
            <p style={{ fontSize: 13, color: 'var(--text)', margin: '0 0 6px', lineHeight: 1.7 }}>
              ...
              이 도구는 섞는 비율의 평균색으로 근사해, 같은 양을 섞으면 어두운 회색이 나옵니다.
            </p>
      ...
      <div style={card}>
        <p style={{ fontSize: 14, color: 'var(--text)', lineHeight: 1.85, marginTop: 0 }}>
          한국 작가·취미생이 자주 만드는 색의 12색 물감 비율입니다. 본 페이지의 [레시피·색환] 탭에서 카드 클릭으로 즉시 적용 가능.
        </p>
        ...
        <p style={{ marginTop: 12, fontSize: 12, color: 'var(--muted)', lineHeight: 1.7 }}>
          ⓘ 본 표는 일부 미리보기이며, 더 많은 레시피(테라코타·세이지·코랄·플럼·아이보리 등)는 [레시피·색환] 탭에서 확인 가능합니다.
        </p>
      </div>
