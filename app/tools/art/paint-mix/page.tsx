...
const FAQ_LD = [
  ...
  { "q":"살색은 어떻게 만들어요?","a":"밝기에 따라 비율이 다릅니다. 본 도구의 [📚 레시피] 탭에 3종 톤이 있습니다: • 밝은 살색 (아기·어린이): 흰색 8 + 빨강 1 + 노랑 1 • 중간 살색 (일반 동양인): 흰색 5 + 주황 2 + 빨강 1 • 어두운 살색 (구릿빛): 갈색 3 + 주황 2 + 흰색 4 핵심은 흰색 베이스 + 주황(빨강+노랑)입니다. 너무 빨간 살색이 나오면 노랑을 더 추가하세요. 인물의 그림자 색은 살색에 보색(파랑·보라)을 살짝 섞으면 자연스럽습니다." },
  ...
  { "q":"푸드컬러는 어떤 비율로 사용?","a":"식약처 허가 식용 색소(타르색소·천연색소)만 사용해야 하며, 미술용 안료는 절대 식용 금지입니다. • 젤 푸드컬러: 이쑤시개로 살짝 찍어 첨가 (1g 이하). 색이 진하고 반죽 묽어짐 적음 • 액상 푸드컬러: 1방울씩 추가. 풍부한 색은 5~10방울 필요 • 천연 색소(비트·당근·시금치 분말): 분말 1~3% 첨가, 발색은 약하지만 안전 • 30분 후 발색 확인 — 시간이 지날수록 진해지므로 처음엔 적게 베이킹 작업은 베이커 퍼센트 계산기·베이킹 레시피 환산도 함께 활용하세요." },
