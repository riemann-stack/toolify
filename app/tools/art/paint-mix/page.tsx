...
const FAQ_LD = [
  ...
  { "q":"안료 농도가 다른데 같은 비율이면 같은 색?","a":"아닙니다. 같은 1ml라도 안료 농도(pigment load)에 따라 결과가 크게 달라집니다. • 전문가 물감(신한 SWC·홀베인·다니엘 스미스): 안료 농도 ↑ → 적은 양으로도 진함 • 학생용 물감(펜텔 포스터컬러, 알파·신한 학생용 라인 등): 안료 농도 ↓, 체질안료 ↑ → 같은 양이라도 흐림 • 젤 푸드컬러: 액상보다 3~5배 수준으로 진하게 소개됨 → 훨씬 적게 사용 본 도구의 [분량 환산] 탭에 안료 농도 보정 슬라이더(0.5×~2.0×)가 있으니, 진한 안료는 0.5×, 흐린 안료는 1.5×~2× 적용하세요." },
