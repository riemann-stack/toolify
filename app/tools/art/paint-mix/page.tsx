...
const FAQ_LD = [
  { "q":"모니터 색이랑 실제 물감 색이 왜 다른가요?","a":"모니터는 빛(RGB)을 더하는 방식, 물감은 빛(CMY)을 흡수하는 방식이기 때문입니다. 둘은 본질적으로 다른 색 공간이라 100% 일치할 수 없어요. 또한 모니터마다 색 보정이 달라(sRGB / P3 / AdobeRGB), 같은 HEX도 화면별로 다르게 보입니다. 본 도구는 sRGB 기준이며, 실제 물감 결과는 안료 종류·매체(수성/유성)·종이/캔버스·건조 변색까지 반영해 차이가 생깁니다. 정확한 색은 반드시 소량 테스트 후 작업하세요." },
  { "q":"Subtractive·Additive·RYB 모델 차이는?","a":"Subtractive(물감): 안료가 빛을 흡수. 3원색 CMY(시안·마젠타·옐로우), 모두 섞으면 검정. 본 도구의 기본값이며 실제 물감 혼합과 가장 비슷. Additive(빛): 빛이 더해짐. 3원색 RGB(빨강·초록·파랑), 모두 합치면 흰색. 모니터·LED·무대 조명용. RYB(전통): 학교 미술 빨강·노랑·파랑 3원색. 직관적이지만 과학적으론 CMY가 더 정확. 학교 수업·아동 교육용. 같은 빨강+파랑이라도 모델별 결과가 달라집니다 — Subtractive는 어두운 보라, Additive는 마젠타, RYB는 자주빛 보라." },
  { "q":"살색은 어떻게 만들어요?","a":"밝기에 따라 비율이 다릅니다. 본 도구의 [📚 레시피] 탭에 3종 톤이 있습니다: • 밝은 살색 (아기·어린이): 흰색 8 + 빨강 1 + 노랑 1 • 중간 살색 (중간 밝기 톤): 흰색 5 + 주황 2 + 빨강 1 • 어두운 살색 (구릿빛): 갈색 3 + 주황 2 + 흰색 4 핵심은 흰색 베이스 + 주황(빨강+노랑)입니다. 실제 피부톤은 밝기 외에 웜·쿨·뉴트럴 언더톤 차이가 있으므로 위 비율은 출발점 예시로 쓰고, 너무 빨간 살색이 나오면 노랑을 더 추가하세요. 인물의 그림자 색은 살색에 보색(파랑·보라)을 살짝 섞으면 자연스럽습니다." },
  { "q":"보색을 섞으면 왜 회색·갈색이 나오나요?","a":"보색은 색환에서 마주 보는 색으로, 두 색이 흡수하는 빛의 파장이 정확히 가시광선 전체를 덮습니다. 물감이 모든 빛을 흡수하면 = 빛이 안 반사됨 = 회색·갈색·검정처럼 보여요. • 빨강 + 초록 = 갈색·올리브 • 주황 + 파랑 = 회색·진청 • 노랑 + 보라 = 카키·회록 이 특성을 활용해 그림자·중성색을 만들 때 검정만 추가하지 말고 보색을 살짝 섞으면 살아있는 회색이 됩니다. (작가들이 자주 쓰는 테크닉)" },
  { "q":"빨강 + 파랑 = 보라가 항상 나오나요?","a":"이론적으론 보라지만 실제론 탁한 갈색·회보라가 자주 나옵니다. 이유는 대부분의 빨강이 약간의 노랑을 포함하기 때문이에요. 카드뮴 레드는 노랑 기운, 알리자린 크림슨은 파랑 기운. 빨강에 노랑이 섞이면 + 파랑 → 3원색이 모두 모여 회색·갈색이 됩니다. 선명한 보라를 원하면 알리자린 크림슨(파랑 기운 빨강) + 울트라마린 또는 퀴나크리돈 마젠타 + 코발트 블루 조합을 쓰세요. 학교 12색 빨강만으로는 한계가 있습니다." },
  { "q":"안료 농도가 다른데 같은 비율이면 같은 색?","a":"아닙니다. 같은 1ml라도 안료 농도(pigment load)에 따라 결과가 크게 달라집니다. • 전문가 물감(신한 SWC·홀베인·다니엘 스미스): 안료 농도 ↑ → 적은 양으로도 진함 • 학생용 물감(펜텔 포스터컬러, 알파·신한 학생용 라인 등): 안료 농도 ↓, 체질안료 ↑ → 같은 양이라도 흐림 • 젤 푸드컬러: 액상보다 3~5배 수준으로 진하게 소개됨 → 훨씬 적게 사용 본 도구의 [분량 환산] 탭에 사용량 보정 슬라이더(0.5×~2.0×)가 있으니, 진한 안료는 0.5×, 흐린 안료는 1.5×~2× 적용하세요." },
  { "q":"잉크 혼합 시 주의사항은?","a":"만년필 잉크는 같은 브랜드·같은 베이스끼리만 혼합하세요. 다른 조합은 침전·응집·만년필 막힘 위험이 큽니다. • 비교적 안전한 조합: 같은 브랜드 dye 잉크끼리 (예: 다이아민 + 다이아민) — 같은 브랜드도 보장은 아님 • 위험한 조합: dye + pigment, 다른 브랜드, 산성(iron gall) + 알칼리성 • 혼합 전제 전용 라인(플래티넘 Mix Free, De Atramentis Document 등)만 자유 혼합 권장 • 혼합 전 시린지·작은 용기에서 테스트해 24~48시간 후 침전 확인 • 만년필 분해 청소가 어려운 모델(파일럿 캡리스 등)에는 혼합 잉크 사용 금지 캘리그래피용 펜촉(Nikko·Brause)은 만년필보다 막힘 영향 적어 자유로운 혼합 가능합니다." },
  { "q":"푸드컬러는 어떤 비율로 사용?","a":"식약처 허가 식용 색소(타르색소·천연색소)만 사용해야 하며, 미술용 안료는 절대 식용 금지입니다. 타르색소는 식품 유형별 사용 가능 품목이 법으로 지정돼 있습니다 — 예: 적색 제102호는 캔디·빙과 등 지정 품목에만 쓸 수 있고 빵·떡류에는 사용할 수 없습니다. 제품 라벨의 용도 표시와 식약처 품목별 사용기준을 확인하세요. • 젤 푸드컬러: 이쑤시개로 살짝 찍어 첨가 (1g 이하). 색이 진하고 반죽 묽어짐 적음 • 액상 푸드컬러: 1방울씩 추가. 풍부한 색은 5~10방울 필요 • 천연 색소(비트·당근·시금치 분말): 분말 1~3% 첨가, 발색은 약하지만 안전 • 30분 후 발색 확인 — 시간이 지날수록 진해지므로 처음엔 적게 베이킹 작업은 베이커 퍼센트 계산기·베이킹 레시피 환산도 함께 활용하세요." },
  { "q":"레진 안료는 g 단위로 정확해야 하는 이유?","a":"레진(에폭시)은 화학 경화 반응을 거치므로 안료 비율이 너무 높으면 경화 불량이 발생합니다. • 제조사 권고 우선: 안료 제조사는 통상 레진+경화제 무게의 0.5~3%를, 레진 제조사(ArtResin 등)는 부피 6% 상한을 제시 — 제품 안내가 기준 • 통상 5~6% 초과: 끈적임·표면 결함 등 경화 불량 위험 증가 • 10% 초과: 경화가 제대로 되지 않을 수 있음(연질·미경화 잔류) 전자저울(0.01g)로 정밀 계량하고, 일반 물감/잉크 대신 레진 전용 안료(마이카 파우더·알코올 잉크·레진 페이스트)를 사용하세요. 일반 수성 물감은 레진의 화학 결합을 방해해 경화 불량 원인이 됩니다. ⚠️ 작업 시 환기·장갑·고글 필수. 미경화 레진은 피부 자극·알레르기 유발." },
  { "q":"ΔE(델타 E)가 무엇인가요?","a":"두 색이 사람 눈에 얼마나 다르게 보이는지 수치화한 값입니다 (CIELAB 색공간 거리, 본 도구는 ΔE*ab/CIE76 기준). 작을수록 비슷. • ΔE 0~1: 사람 눈으로 차이를 느끼기 어려움 • ΔE 1~2: 숙련된 관찰자만 근접 관찰로 구별 • ΔE 2~3.5: 일반인도 나란히 비교하면 차이를 인지 (연구상 평균 식별 한계 ΔE ≈ 2.3) • ΔE 3.5~5: 뚜렷한 차이 • ΔE 5+: 서로 다른 색으로 인식 본 도구의 컬러 매칭 탭은 ΔE를 최소화하는 혼합 비율을 brute-force로 탐색합니다. ΔE는 인쇄·도장 업계의 표준 색차 지표이며, 자동차 도장처럼 정밀한 색 관리에는 ΔE2000·CMC 공식이 주로 쓰입니다." }
]
  ...
  return (
    <div style={{ maxWidth: '880px', margin: '0 auto', padding: '60px 24px 80px' }}>
      ...
      <div style={card}>
        ...
        <p style={{ marginTop: 6, fontSize: 12, color: 'var(--muted)', lineHeight: 1.7 }}>
      ...
      <div style={card}>
        <ul style={{ paddingLeft: 18, margin: 0, fontSize: 13, color: 'var(--text)', lineHeight: 2 }}>
          ...
          <li>🖌️ <strong>아크릴</strong> — 6색 기본(티타늄 화이트·카본 블랙·카드뮴 옐로우·카드뮴 레드·울트라마린 블루·프탈로 그린). 건조 후 살짝 어두워지므로 한 톤 밝게 섞기.</li>
          ...
          <li>💎 <strong>레진·에폭시</strong> — 전용 마이카 파우더·레진 안료. 수성 물감은 수분이 경화 반응을 방해. ⚠️ 환기·장갑·고글 필수, 안료는 소량 원칙(제조사 권고 무게 0.5~3% 수준 우선).</li>
        </ul>
      </div>
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          ...
          • <strong>중간 살색 (중간 밝기 톤)</strong>: 흰색 5 + 주황 2 + 빨강 1<br />
          • <strong>어두운 살색 (구릿빛)</strong>: 갈색 3 + 주황 2 + 흰색 4<br />
          핵심은 <strong>흰색 베이스 + 주황(빨강+노랑)</strong>입니다. 실제 피부톤은 밝기 외에 웜·쿨·뉴트럴 언더톤 차이가 있으므로 위 비율은 <strong>출발점 예시</strong>로 쓰고, 너무 빨간 살색이 나오면 노랑을 더 추가하세요. 인물의 그림자 색은 살색에 보색(파랑·보라)을 살짝 섞으면 자연스럽습니다.
        </p>
      </details>
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          ...
          • <strong>학생용 물감</strong>(펜텔 포스터컬러, 알파·신한 학생용 라인 등): 안료 농도 ↓, 체질안료 ↑ → 같은 양이라도 흐림<br />
          • <strong>젤 푸드컬러</strong>: 액상보다 3~5배 수준으로 진하게 소개됨 → 훨씬 적게 사용<br />
          본 도구의 [분량 환산] 탭에 <strong>사용량 보정 슬라이더(0.5×~2.0×)</strong>가 있으니, 진한 안료는 0.5×, 흐린 안료는 1.5×~2× 적용하세요.
        </p>
      </details>
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          ...
          • <strong>비교적 안전한 조합</strong>: 같은 브랜드 dye 잉크끼리 (예: 다이아민 + 다이아민) — 다만 같은 브랜드도 보장은 아님<br />
          • <strong>위험한 조합</strong>: dye + pigment, 다른 브랜드, 산성(iron gall) + 알칼리성<br />
          • <strong>혼합 전제 전용 라인</strong>(플래티넘 Mix Free, De Atramentis Document 등)만 자유 혼합 권장<br />
          • 혼합 전 <strong>시린지·작은 용기에서 테스트</strong>해 24~48시간 후 침전 확인<br />
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          <strong>식약처 허가 식용 색소</strong>(타르색소·천연색소)만 사용해야 하며, 미술용 안료는 절대 식용 금지입니다.
          타르색소는 <strong>식품 유형별 사용 가능 품목이 법으로 지정</strong>돼 있습니다 — 예: 적색 제102호는 캔디·빙과 등 지정 품목에만 쓸 수 있고 <strong>빵·떡류에는 사용할 수 없습니다</strong>. 제품 라벨의 용도 표시와 식약처 품목별 사용기준을 확인하세요.<br />
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          ...
          • <strong>제조사 권고 우선</strong>: 안료 제조사는 통상 레진+경화제 <strong>무게의 0.5~3%</strong>를, 레진 제조사(ArtResin 등)는 <strong>부피 6% 상한</strong>을 제시 — 제품 안내가 기준<br />
          • <strong>통상 5~6% 초과</strong>: 끈적임·표면 결함 등 경화 불량 위험 증가<br />
          • <strong>10% 초과</strong>: 경화가 제대로 되지 않을 수 있음 (연질·미경화 잔류)<br />
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          <strong>두 색이 사람 눈에 얼마나 다르게 보이는지</strong> 수치화한 값입니다 (CIELAB 색공간 거리, 본 도구는 ΔE*ab/CIE76 기준). 작을수록 비슷.<br />
          • <strong>ΔE 0~1</strong>: 사람 눈으로 차이를 느끼기 어려움<br />
          • <strong>ΔE 1~2</strong>: 숙련된 관찰자만 근접 관찰로 구별<br />
          • <strong>ΔE 2~3.5</strong>: 일반인도 나란히 비교하면 차이를 인지 (연구상 평균 식별 한계 ΔE ≈ 2.3)<br />
          • <strong>ΔE 3.5~5</strong>: 뚜렷한 차이<br />
          • <strong>ΔE 5+</strong>: 서로 다른 색으로 인식<br />
          본 도구의 <strong>컬러 매칭</strong> 탭은 ΔE를 최소화하는 혼합 비율을 brute-force로 탐색합니다. ΔE는 인쇄·도장 업계의 표준 색차 지표이며, 자동차 도장처럼 정밀한 색 관리에는 지각 균일성을 보정한 ΔE2000·CMC 공식이 주로 쓰입니다.
        </p>
      </details>
