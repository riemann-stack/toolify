...
const FAQ_LD = [
  { "q":"4인 가족 김장은 몇 포기가 적당한가요?","a":"3개월 분량 12~15포기가 표준입니다 (보통 소비 패턴 기준). 매끼 김치 잘 먹는 가정 + 김치찌개·볶음밥 활용이 많으면 15~20포기. 김치 가끔 먹는 가정은 6~10포기. 김장 1년치 (직장인 자취 + 부모님 보내기)는 25~40포기. 본 도구의 「소비 패턴」으로 자동 조정됩니다." },
  { "q":"김장철 농산물 가격은 어떻게 확인하나요?","a":"KAMIS (kamis.or.kr) — 한국농수산식품유통공사 일일 소매·도매가. aT 농수산물 가격정보 — 산지·도매·소매 추세. aT 김장 비용 발표 — 매년 11월 초 4인 가족 평균 발표. 전통시장·마트 광고지 — 실구매가는 더 저렴 (특히 농협 하나로마트 김장 행사). 본 도구는 KAMIS 자동 연동으로, 「최신 시세」 버튼으로 갱신할 수 있습니다." },
  { "q":"김장 비용을 줄이는 팁이 있나요?","a":"김장철 직전 (10월 말): 배추·무 가격이 평년보다 안정되며 11월 첫째 주가 보통 최저점. 농협 하나로마트 김장 행사: 11월 한 달 진행, 일반 마트 대비 10~20% 저렴. 전통시장 + 농산물 직거래: 도매상 통하면 30% 절감. 주말 알뜰장: 시·구청 주최 김장 알뜰장 (서울 마포구·강서구 등). 이웃·친구와 공동 구매: 마늘 1접·고춧가루 1박스 분할. 가족 김장 모임: 노동력 분담 + 양념 한 번에." },
  { "q":"김장 김치는 얼마나 보관되나요?","a":"김치냉장고 0~3℃: 6~12개월 (가장 권장). 일반 냉장고 4℃: 2~3개월 (점점 시어짐). 실온: 1~3일 (이후 빠르게 익음). 김치냉장고 없으면 12월~2월 베란다 보관도 가능 (영하 5℃ 이상 유지). 너무 익은 김치는 김치찌개·볶음밥·만두소·김치전 활용 — 레시피 비율 계산기로 응용." },
  { "q":"김장이 처음인데 실패 안 하려면?","a":"첫해는 4~6포기로 소량 시작 — 본 도구 결과의 절반으로 시도. 절임이 70% — 짠맛 부족하면 양념이 빠지고 너무 짜면 못 먹으니, 4~6시간 절이며 중간에 뒤집고 배추 잎이 휘면 완료. 양념은 미리 만들어 1~3시간 숙성 — 따로 두면 맛이 어우러짐. 버무릴 때 위생 장갑 + 큰 다라이 — 손맛은 위생적으로. 김치통은 80%만 — 발효 가스로 부풀어 가득 채우면 흘러넘침. 실온 1~2일 후 김치냉장고로 — 발효 시작 시점에 옮깁니다." },
  { "q":"본 도구의 가격이 우리 동네와 다른데요?","a":"KAMIS는 서울 소매가 평균이라 지역별 차이가 있습니다. 각 재료의 단가 칸을 직접 클릭해서 마트 광고지·전통시장 가격으로 수정 가능 — 총액이 자동 재계산됩니다. 지역 차이 일반 경향: 서울·수도권은 평균 또는 +5~10%, 지방 도시는 -5~15%, 도서·산간은 +10~20%, 농산물 산지 (전남·경북)는 -20~30%." }
]
        ...
        <section>
          ...
          <div style={card}>
            ...
            <ul style={{ fontSize: '13px', color: 'var(--muted)', lineHeight: 1.9, paddingLeft: '20px', margin: 0 }}>
              ...
              <li><strong style={{ color: 'var(--text)' }}>시세 조회 실패 시</strong>: 최근 KAMIS 평균값을 대신 표시 — 각 재료 단가는 직접 수정 가능</li>
              <li><strong style={{ color: 'var(--text)' }}>시세 갱신</strong>: 1시간 단위 자동 갱신</li>
            ...
            <p style={{ fontSize: '12px', color: 'var(--muted)', marginTop: '10px', marginBottom: 0, lineHeight: 1.7 }}>
              💡 시세 원본은 <a href="https://www.kamis.or.kr" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--accent)' }}>KAMIS 농산물 가격정보 (kamis.or.kr)</a>에서 직접 확인할 수 있습니다.
            </p>
          </div>
        </section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '10px' }}>
            {[
              ...
              <div key={i} style={{ background: 'var(--bg2)', border: `1px solid ${b.color}44`, borderRadius: 'var(--radius-m)', padding: '14px 16px' }}>
                ...
                <p style={{ fontSize: '12px', color: 'var(--text)', fontWeight: 600, marginBottom: '4px', fontFamily: 'var(--font-sans)' }}>{b.date}</p>
