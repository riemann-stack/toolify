...
const FAQ_LD = [
  { "q":"4인 가족 김장은 몇 포기가 적당한가요?","a":"3개월 분량 12~15포기가 표준입니다 (보통 소비 패턴 기준). 매끼 김치 잘 먹는 가정 + 김치찌개·볶음밥 활용 多 → 15~20포기 김치 가끔 먹는 가정 → 6~10포기 김장 1년치 (직장인 자취 + 부모님 보내기) → 25~40포기 본 도구의 「소비 패턴」으로 자동 조정." },
  { "q":"김장철 농산물 가격은 어떻게 확인하나요?","a":"KAMIS (kamis.or.kr) — 한국농수산식품유통공사 일일 소매·도매가 aT 농수산물 가격정보 — 산지·도매·소매 추세 aT 김장 비용 발표 — 매년 11월 초 4인 가족 평균 발표 전통시장 · 마트 광고지 — 실구매가는 더 저렴 (특히 농협 하나로마트 김장 행사) 본 도구는 KAMIS 자동 연동 — 「↻ 최신 시세」 버튼으로 갱신." },
  { "q":"김장 비용을 줄이는 팁이 있나요?","a":"김장철 직전 (10월 말): 배추·무 가격이 평년보다 안정. 11월 첫째 주가 보통 최저점 농협 하나로마트 김장 행사: 11월 한 달 진행. 일반 마트 대비 10~20% 저렴 전통시장 + 농산물 직거래: 도매상 통하면 30% 절감 주말 알뜰장: 시·구청 주최 김장 알뜰장 (서울 마포구·강서구 등) 이웃·친구와 공동 구매: 마늘 1접·고춧가루 1박스 분할 가족 김장 모임: 노동력 분담 + 양념 한 번에" },
  ...
  { "q":"김장이 처음인데 실패 안 하려면?","a":"첫해는 4~6포기로 소량 시작 — 본 도구 결과의 절반으로 시도 절임이 70% — 짠맛 부족하면 양념 빠짐, 너무 짜면 못 먹음. 4~6시간 + 중간 뒤집기 + 배추 잎이 휘면 됨 양념은 미리 만들어 1~3시간 숙성 — 따로 두면 맛이 어우러짐 버무릴 때 위생 장갑 + 큰 다라이 — 손맛은 위생적으로 김치통은 80%만 — 발효 가스로 부풀음. 가득 채우면 흘러넘침 실온 1~2일 후 김냉 — 발효 시작 시점에 옮김" },
  { "q":"본 도구의 가격이 우리 동네와 다른데요?","a":"KAMIS는 서울 소매가 평균이라 지역별 차이가 있습니다. 각 재료의 단가 칸을 직접 클릭해서 마트 광고지·전통시장 가격으로 수정 가능 — 총액이 자동 재계산됩니다. 지역 차이 일반 경향: 서울·수도권: 평균 또는 +5~10% 지방 도시: 평균 -5~15% 도서·산간: +10~20% 농산물 산지 (전남·경북): -20~30%" }
]
