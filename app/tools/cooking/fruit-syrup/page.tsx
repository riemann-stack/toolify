...
const FAQ_LD = [
              ...
              {
                q: '얼마나 숙성해야 마실 수 있나요?',
                a: '딸기·레몬은 며칠이면 사용 가능하고, 오미자는 100일 전후면 풍미가 어우러집니다. 매실청은 식약처 안내대로 약 3~4개월 담근 뒤 매실을 건지고, 서늘한 곳에서 6개월 이상 더 숙성한 다음 마시는 것이 좋습니다. 계산기에서 담근 날짜를 입력하면 과일별 사용 가능일·건지기·숙성 완료일(매실)·소비기한이 자동으로 표시됩니다.',
              },
              {
                q: '완성된 청은 어떻게 마시나요?',
              ...
              },
              {
                ...
                a: "아닙니다. '100일'은 널리 쓰이는 관행 표현이고, 식약처 공식 안내는 <strong>'그늘진 실온에서 약 3~4개월 담금 후 매실 제거'</strong>입니다. 3~4개월은 약 90~120일이므로 100일 관행과 하한이 겹칩니다. 본 계산기의 매실·오미자 건지기 기본값(100일)도 관행 기준이며, 매실은 건진 뒤 6개월 숙성 완료일을 일정에 따로 표시합니다.",
              },
            ]
  ...
  return (
    <ToolPage width={760} slug="/tools/cooking/fruit-syrup">
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
        ...
        {/* 1. 왜 1:1인가 */}
        <section>
          <h2 className="g-h2">과일청, 왜 설탕 1:1 비율이 기본일까?</h2>
          <p className="g-p">
          ...
          <Callout tone="tip" title="핵심은 위생">
            과일과 용기의 물기를 완전히 제거하는 것이 비율보다 중요합니다. 설탕이 다 녹기 전 초기에는 표면의 물기나 과일 조각이 공기에 닿는 부분부터 곰팡이가 생기기 쉽습니다.
          </Callout>
        </section>

        {/* 2. 담그는 법 */}
        <section>
          <h2 className="g-h2">실패 없이 담그는 법 — 5단계</h2>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
            {[
              ...
              <div key={item.step} style={{ ...card, display: 'flex', gap: '14px' }}>
                <span style={{ fontFamily: 'var(--font-sans)', fontSize: '18px', fontWeight: 800, color: ACCENT, minWidth: '22px' }}>{item.step}</span>
                <div>
        ...
        {/* 3. 식약처 공식 매실청 담금법 */}
        <section>
          <h2 className="g-h2">식약처 공식 매실청 안전 담금법 (2026)</h2>
          <p className="g-p">
              ...
              <tbody>
                {[
                  ...
                  <tr key={i} style={{ borderBottom: '1px solid var(--border)', background: i % 2 === 0 ? 'transparent' : 'var(--bg2)' }}>
                    ...
                    <td style={{ padding: '9px 10px', textAlign: 'right', color: ACCENT, fontWeight: 700, fontFamily: 'var(--font-sans)', whiteSpace: 'nowrap' }}>{r[1]}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <Callout tone="note" title="적용 범위">
            위 안내는 매실청을 대상으로 합니다. 레몬청·유자청 등 과일청 전반을 다룬 정부 공식 안내는 확인되지 않았으므로, 다른 과일은 아래 통용 관행 기준값을 참고하세요. 식약처 문서에 &lsquo;100일&rsquo;이라는 표현은 없습니다(담금 기간은 약 3~4개월).
          </Callout>
        </section>

        {/* 4. 과일별 기준값 표 */}
        <section>
          <h2 className="g-h2">과일별 설탕 비율·건지기·소비기한 — 본 도구 기준값</h2>
          <p className="g-p">
          ...
          <div className="tableScroll">
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px', minWidth: 520 }}>
              ...
              <tbody>
                {[
                  ['매실',   '1 : 1', '~20일', '건진 뒤 6개월 숙성', '100일', '건진 날부터 12개월'],
          ...
          <p className="g-note">
            ※ 매실·오미자의 &lsquo;100일&rsquo;은 통용 관행 — 식약처 매실청 안내는 &lsquo;약 3~4개월(≈90~120일) 담금 후 제거&rsquo;로 하한이 겹칩니다. 매실은 식약처 안내에 따라 건진 뒤 6개월 숙성 완료일을 따로 표시하고, 소비기한도 건진 날부터 셉니다. 저당(1:1 미만)으로 담그면 계산기가 소비기한을 1~2개월로 자동 단축하고, 과일을 건지는 경우에는 건진 날부터 셉니다(매실은 이때 숙성 완료일 대신 냉장 소비기한만 표시).
          </p>
        </section>

        {/* 5. 제철 과일 캘린더 */}
        <section>
          <h2 className="g-h2">제철 과일 캘린더 — 청 담그기 좋은 때</h2>
          <p className="g-p">
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px', minWidth: 420 }}>
              ...
              <tbody>
                {[
                  ...
                  <tr key={i} style={{ borderBottom: '1px solid var(--border)', background: i % 2 === 0 ? 'transparent' : 'var(--bg2)' }}>
                    <td style={{ padding: '9px 10px', fontWeight: 700, color: 'var(--text)', fontFamily: 'var(--font-sans)', whiteSpace: 'nowrap' }}>{r[0]}</td>
        ...
        {/* 6. 과일 보관 궁합 */}
        <section>
          <h2 className="g-h2">과일 보관 궁합 — 같이 두면 빨리 무릅니다</h2>
          <p className="g-p">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginBottom: 12 }}>
            <div style={{ ...card, borderLeft: '3px solid var(--red-600)' }}>
              <p style={{ fontSize: '13px', fontWeight: 700, color: 'var(--red-600)', marginBottom: '8px' }}>에틸렌 多 (따로 보관)</p>
            ...
            <div style={{ ...card, borderLeft: '3px solid var(--cyan-600)' }}>
              <p style={{ fontSize: '13px', fontWeight: 700, color: 'var(--cyan-600)', marginBottom: '8px' }}>에틸렌 민감 (멀리 둘 것)</p>
              <ul style={{ fontSize: '13px', color: 'var(--muted)', lineHeight: 1.85, listStyle: 'none', padding: 0, margin: 0 }}>
                <li>· 키위 · 딸기 · 포도</li>
                <li>· 감귤류(레몬·오렌지)</li>
                <li>· 잎채소 · 오이 · 브로콜리</li>
