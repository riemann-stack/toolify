...
const FAQ_LD = [
  ...
  { "q":"틀이 다른데 같은 레시피를 사용 가능한가요?","a":"본 도구의 &ldquo;분량 변환&rdquo; 탭을 활용하세요. 예: 표준 파운드틀(20×8×7, 반죽 약 470g) 레시피를 소형 파운드틀(15×6×6, 약 230g) 2개로 나누면 ×0.98 (230×2=460g/470g). 원형 케이크틀은 호수·높이에 따라 부피가 달라지니 케이크 틀 환산 계산기를 쓰세요. 다만 ① 굽는 시간은 별도 조정(작을수록 ↓·클수록 ↑) ② 마카롱·머랭처럼 민감한 품목은 신중히 환산해야 합니다." },
  ...
  return (
    <ToolPage width={880} slug="/tools/cooking/baking-recipe">
      ...
      <p style={{ fontSize: '13px', color: 'var(--muted)', lineHeight: 1.7, margin: '0 0 24px' }}>
        원형 케이크틀(1~3호)은 <Link href="/tools/cooking/cake-pan" style={{ color: 'var(--accent)', fontWeight: 600 }}>케이크 틀 환산 계산기</Link>에서 지름·높이로 부피를 비교해 환산하세요.
      </p>
      ...
      <details style={faqDetails}>
        ...
        <div style={faqAnswer}>
          ...
          원형 케이크틀은 호수·높이에 따라 부피가 달라지니 <Link href="/tools/cooking/cake-pan" style={{ color: 'var(--accent)', fontWeight: 600 }}>케이크 틀 환산 계산기</Link>를 쓰세요.
