...
export const metadata = buildMetadata({
  ...
  description: '마들렌·파운드·쿠키·머핀·마카롱 등 제과 10종 비율 자동 + 식감 보정·틀 용량 분량 변환·프리셋 19종.',
      ...
      <div style={{ ...card, padding: 0, overflow: 'hidden' }}>
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          ...
          <tbody>
            ...
            <tr><td style={cell}>표준 마카롱 (지름 4cm)</td><td style={cell}>껍질 1장 12g</td><td style={cell}>50개(껍질·25쌍) = 600g 반죽</td></tr>
