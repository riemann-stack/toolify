      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px' }}>
            {[
              ...
              <div key={i} style={{ background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: '10px', padding: '11px 14px' }}>
                ...
                <p style={{ fontSize: '15px', color: 'var(--yellow-700)', fontFamily: 'var(--font-sans)', fontWeight: 800, margin: '2px 0' }}>{it.val}</p>
              ...
              <tbody>
                {[
                  ...
                  <tr key={i} style={{ borderBottom: '1px solid var(--border)', background: i % 2 === 0 ? 'transparent' : 'var(--bg2)' }}>
                    ...
                    <td style={{ padding: '8px 12px', color: 'var(--text)', fontFamily: 'var(--font-sans)', fontWeight: 700 }}>{row[1]}</td>
                    <td style={{ padding: '8px 12px', color: 'var(--text)', fontFamily: 'var(--font-sans)', fontWeight: 700 }}>{row[2]}</td>
                    <td style={{ padding: '8px 12px', color: 'var(--muted)', fontFamily: 'var(--font-mono)' }}>{row[3]}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '6px', marginBottom: '12px' }}>
            {['소금', '간장', '고추장', '된장', '쌈장', '고춧가루', '식초', '맛술', '꿀', '물엿', '올리고당', '다진마늘', '다진생강', '후추', '미원', '머스타드', '케첩'].map(name => (
              <div key={name} style={{ background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 'var(--radius-s)', padding: '7px 11px', fontSize: 13, color: 'var(--text)', textAlign: 'center', fontFamily: 'var(--font-sans)' }}>
                {name}
              </div>
            ))}
          </div>
        ...
        <section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
            ...
            <div style={{ background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 'var(--radius-m)', padding: '14px 18px' }}>
              <p style={{ fontSize: '14px', fontWeight: 700, color: 'var(--yellow-700)', marginBottom: '6px' }}>🍞 베이킹</p>
              <ul style={{ fontSize: '13px', color: 'var(--muted)', lineHeight: 1.85, listStyle: 'none', padding: 0, margin: 0 }}>
                <li>· 비율 매우 중요 (±5%)</li>
                <li>· 정확한 값 그대로 사용</li>
                <li>· 부피보다 무게(g) 측정</li>
        ...
        <section>
          ...
          <p style={{ fontSize: '13px', color: 'var(--muted)', lineHeight: 1.7, marginTop: '12px', background: 'rgba(16,185,129,0.06)', border: '1px solid rgba(16,185,129,0.30)', borderRadius: 10, padding: '10px 13px' }}>
            <strong style={{ color: 'var(--emerald-600)' }}>장점</strong>: 중복 구매 방지 · 정확한 양 파악 · 시간 절약 · 마트 동선 효율화.
          </p>
        </section>
