...
const FAQ_LD = [
  ...
  { "q":"임산부·아이는 어떤 차가 안전한가요?","a":"카페인이 없는 차가 안전합니다. • ✅ 허브티 (카모마일·페퍼민트·라벤더) — 카페인 0 • ✅ 루이보스 — 카페인 0, 항산화·미네랄 풍부 • ⚠️ 백차·녹차 — 저카페인이라 가끔 OK이지만 임산부는 1일 1잔 이내 • ❌ 홍차·말차·옥로 — 카페인 높음, 임신 후기·수유 중 비추천 단, 일부 허브(세이지·로즈마리·특정 한약차)는 임산부 금기이니 라벨 확인 필수. 정확한 권고는 산부인과·소아과와 상담하세요." },
