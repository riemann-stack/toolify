...
const FAQ_LD = [
  ...
  { "q":"말차와 녹차는 같은 차인가요?","a":"같은 차나무에서 나온 다른 형태입니다. 말차(抹茶)는 차광 재배한 녹차(텐차)를 맷돌로 곱게 갈아 가루로 만든 것. 일반 녹차는 잎을 우려서 잎은 버리지만, 말차는 가루 자체를 마시므로 카테킨·카페인·항산화 성분을 통째로 섭취합니다. 그래서 카페인이 일반 녹차의 2~3배에 달해요." },
  ...
  { "q":"냉침차는 카페인이 정말 적은가요?","a":"네, 일반적으로 핫추출 대비 30~50% 적게 추출됩니다. 카페인은 고온에서 더 잘 녹기 때문이에요. 탄닌도 약 50% 적어 부드러운 맛이 납니다. 단, 시간이 길어 총 추출량은 비슷할 수 있고, 향·풍미는 핫추출이 더 강합니다. 카페인 민감자·임산부는 냉침 + 저카페인 차(백차·허브) 조합이 안전해요." },
  ...
  { "q":"임산부·아이는 어떤 차가 안전한가요?","a":"카페인이 없다고 곧 임신 중 안전이라는 뜻은 아닙니다. • ✅ 루이보스 — 카페인 0, 항산화·미네랄 풍부 • ⚠️ 허브티 (카모마일·페퍼민트·라벤더) — 카페인은 없지만 허브별로 임신 중 안전성 근거가 달라 섭취 전 산부인과 확인 권장 • ⚠️ 백차·녹차 — 저카페인이라 가끔 OK이지만 임산부는 1일 1잔 이내 • ❌ 홍차·말차·옥로 — 카페인 높음, 임신 후기·수유 중 비추천 단, 일부 허브(세이지·로즈마리·특정 한약차)는 임산부 금기이니 라벨 확인 필수. 정확한 권고는 산부인과·소아과와 상담하세요." },
