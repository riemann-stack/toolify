...
const FAQ_LD = [
  { "q":"녹차는 왜 70~80°C로 우려야 하나요?","a":"녹차는 비발효차로 카테킨·탄닌이 매우 높아 끓는 물(95°C+)로 우리면 떫음·쓴맛이 폭증합니다. 70~80°C로 낮추면 카테킨이 천천히 추출되며, 단맛 성분(테아닌·아미노산)이 잘 살아납니다. 옥로(교쿠로)는 더 낮은 50~60°C로 우려 우마미(감칠맛)를 극대화해요." },
  { "q":"우림 시간을 길게 하면 더 진해지나요?","a":"아니요. 떫음·쓴맛만 폭증합니다. 차의 단맛·향 성분은 1~3분에 거의 추출이 끝나고, 그 이후엔 탄닌·카페인만 계속 우러나와요. 진하게 마시고 싶다면 찻잎 양을 늘리거나(1.5배), 물을 줄이거나, 온도를 미세 조정하세요. 시간을 늘리는 건 가장 잘못된 선택입니다." },
  { "q":"보이차 세차는 왜 하나요?","a":"보이차는 장기 저장(생차 10년+, 숙차 5년+)된 발효차로 표면에 먼지·잡내가 있을 수 있어요. 뜨거운 물로 10초 빠르게 헹구고 첫 물을 버리면: ① 먼지·이물질 제거 ② 찻잎이 물을 흡수해 다음 추출이 잘 됨 (찻잎 깨우기) ③ 보관 중 생긴 산화물·잡내 제거 우롱차도 같은 이유로 세차하며, 녹차·홍차는 신선해서 세차 안 합니다." },
  { "q":"말차와 녹차는 같은 차인가요?","a":"같은 차나무에서 나온 다른 형태입니다. 말차(抹茶)는 차광 재배한 녹차(텐차)를 맷돌로 곱게 갈아 가루로 만든 것. 일반 녹차는 잎을 우려서 잎은 버리지만, 말차는 가루 자체를 마시므로 카테킨·카페인·항산화 성분을 통째로 섭취합니다. 가루 1g당 카페인은 약 32mg(일본식품표준성분표 8정)으로 녹차 잎과 비슷하지만, 잎을 우려 마시는 녹차와 달리 전부를 섭취하므로 한 잔으로 먹는 카페인은 더 많아요." },
  { "q":"카모마일·페퍼민트·루이보스 우리는 시간 차이?","a":"모두 카페인 0이며 끓는 물로 우리지만 시간은 다릅니다. • 카모마일: 5~7분 (뚜껑 덮고 향 보존) • 페퍼민트: 5분 (오래 우리면 멘톨이 떫어짐) • 루이보스: 5~10분 (오래 우려도 떫음 적음, 임산부·아이도 OK) 허브티는 잎이 아닌 꽃·뿌리·줄기라 추출이 느려 5분 이상 필요해요." },
  { "q":"냉침차는 카페인이 정말 적은가요?","a":"네, 일반적으로 핫추출 대비 30~50% 적게 추출됩니다. 카페인은 고온에서 더 잘 녹기 때문이에요. 탄닌도 약 50% 적어 부드러운 맛이 납니다. 단, 시간이 길어 총 추출량은 비슷할 수 있고, 향·풍미는 핫추출이 더 강합니다. 카페인 민감자라면 냉침으로 카페인을 줄일 수 있어요. 임산부는 카페인 없는 루이보스를 권하고, 허브티는 종류별로 임신 중 안전성이 달라 산부인과 확인이 필요해요. 백차는 녹차와 카페인이 비슷해 저카페인 차로 보기 어렵습니다." },
  { "q":"다관·게이완·머그 어느 게 좋나요?","a":"용도가 다릅니다. • 게이완 (개완): 광동·복건식 작은 사발. 우롱·보이·백차 표준 (작게 여러 번) • 다관 (차호): 전통 중국식 작은 주전자. 옥로·우롱·보이에 적합 • 머그 + 티볼: 서양식. 1회 우림용. 녹차·홍차·허브에 편리 • 티백: 편의·휴대용. 시간을 30~50% 단축 입문자는 머그+티볼로 시작하고, 우롱·보이를 즐기게 되면 게이완을 추천합니다." },
  { "q":"같은 찻잎으로 몇 번까지 우릴 수 있나요?","a":"차 종류·품질에 따라 다릅니다. • 녹차·홍차: 2~3탕 (이후 풍미 약함) • 백차: 3~4탕 • 우롱차: 5~8탕 (고산차·동방미인 더 많이 가능) • 보이차: 6~10탕 (오래 묵힌 차일수록 다탕 가능) • 허브티: 1~2탕 (재추출은 향이 약함) • 티백: 1탕 권장 (분쇄가 너무 가늘어 2탕은 떫음) 탕마다 시간을 점점 늘리는 것이 다탕 우림의 정석입니다." },
  { "q":"임산부·아이는 어떤 차가 안전한가요?","a":"카페인이 없다고 곧 임신 중 안전이라는 뜻은 아닙니다. • ✅ 루이보스 — 카페인 0, 항산화·미네랄 풍부 • ⚠️ 허브티 (카모마일·페퍼민트·라벤더) — 카페인은 없지만 허브별로 임신 중 안전성 근거가 달라 섭취 전 산부인과 확인 권장 • ⚠️ 백차·녹차 — 카페인이 중간 정도(백차도 녹차와 비슷하거나 더 높을 수 있음)라 임산부는 1일 1잔 이내 • ❌ 홍차·말차·옥로 — 카페인 높음, 임신 후기·수유 중 비추천 단, 일부 허브(세이지·로즈마리·특정 한약차)는 임산부 금기이니 라벨 확인 필수. 정확한 권고는 산부인과·소아과와 상담하세요." },
  { "q":"차에 가장 좋은 물은? (연수·경수·정수)","a":"연수(Soft Water, 미네랄 적은 물)가 가장 좋습니다. 한국 수돗물은 비교적 연수에 가까워 정수 후 사용하면 무난해요. • ✅ 정수기물·연수 생수 (백두산수·삼다수): 차의 향·맛 잘 살아남 • ⚠️ 경수 (에비앙 등 미네랄 풍부 물): 차에 침전·맛 변화 발생, 부적합 • ❌ 증류수: 미네랄 0이라 향이 평면적이고 깊이 없음 일본 차업계는 경도 30~80mg/L를 가장 이상적으로 봅니다. 그리고 한 번 끓였다 식힌 물이 산소가 빠져 차 추출에 더 좋아요." }
]
    ...
    <ToolPage width={880} slug="/tools/cooking/tea">
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13, minWidth: 560 }}>
            <thead>
              <tr style={{ background: 'var(--bg3)' }}>
                <th scope="col" style={{ padding: '10px 12px', textAlign: 'left', color: 'var(--muted)', fontSize: 11 }}>차</th>
                <th scope="col" style={{ padding: '10px 12px', textAlign: 'left', color: 'var(--muted)', fontSize: 11 }}>온도</th>
                <th scope="col" style={{ padding: '10px 12px', textAlign: 'left', color: 'var(--muted)', fontSize: 11 }}>1탕</th>
                <th scope="col" style={{ padding: '10px 12px', textAlign: 'left', color: 'var(--muted)', fontSize: 11 }}>비율</th>
                <th scope="col" style={{ padding: '10px 12px', textAlign: 'left', color: 'var(--muted)', fontSize: 11 }}>카페인</th>
              </tr>
            </thead>
            <tbody>
              {[
                ...
                ['💚 말차',   '70~80°C', '즉시 격불', '2g/70ml', '32mg/g'],
                ['🤍 백차',   '75~85°C', '2~3분',   '1:50', '25mg/g'],
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          ...
          가루 1g당 카페인은 약 32mg(일본식품표준성분표 8정)으로 녹차 잎과 비슷하지만, 잎을 우려 마시는 녹차와 달리 전부를 섭취하므로 한 잔으로 먹는 카페인은 더 많아요.
        </p>
      </details>
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          ...
          카페인 민감자라면 냉침으로 카페인을 줄일 수 있어요. 임산부는 카페인 없는 루이보스를 권하고,
          허브티는 종류별로 임신 중 안전성이 달라 산부인과 확인이 필요해요. 백차는 녹차와 카페인이 비슷해 저카페인 차로 보기 어렵습니다.
        </p>
      </details>
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          카페인이 없다고 곧 임신 중 안전이라는 뜻은 아닙니다.<br />
          • ✅ <strong>루이보스</strong> — 카페인 0, 항산화·미네랄 풍부<br />
          • ⚠️ <strong>허브티 (카모마일·페퍼민트·라벤더)</strong> — 카페인은 없지만 허브별로 임신 중 안전성 근거가 달라 섭취 전 산부인과 확인 권장<br />
          • ⚠️ <strong>백차·녹차</strong> — 카페인이 중간 정도(백차도 녹차와 비슷하거나 더 높을 수 있음)라 임산부는 1일 1잔 이내<br />
