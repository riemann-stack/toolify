...
const FAQ_LD = [
  ...
  { "q":"홈브루가 카페보다 얼마나 싼가요?","a":"2026년 가격 기준, 원두 100g 25,000원이면 1잔(원두 16g) ≈ 약 4,000원이지만, 이건 SP 원두(스페셜티) 기준이고 일반 원두는 100g 10,000~15,000원 → 1잔 약 1,500~2,400원. 카페 1잔 4,500~5,500원 대비 1잔당 2,000~3,500원 절감, 1일 1잔이면 월 6~10만원 / 연 70~120만원 절감이 가능합니다. 비용 비교 탭에서 본인 원두 가격으로 정확히 계산해 보세요." },
  ...
  return (
    <div style={{ maxWidth: '880px', margin: '0 auto', padding: '60px 24px 80px' }}>
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          2026년 가격 기준, 원두 100g 25,000원이면 <strong>1잔(원두 16g) ≈ 약 4,000원</strong>이지만,
