...
const FAQ_LD = [
  ...
  { "q":"4인 가족 삼겹살 파티 장보기 어떻게 하나요?","a":"본 도구의 🛒 장보기 목록 탭 활용(성인 3 + 아이 1, 메인·밥과 함께 기준): 삼겹살 약 650~790g · 쌈채소 약 160~200g (1팩) · 두부 1모 (300g) · 쌀 약 290~355g (또는 즉석밥 3~4개). 고기 위주로 먹는다면 '탄수화물 없음'을 고르면 늘어납니다. ⚠️ 추가 메뉴(냉면·볶음밥) 시 고기 -20%, 술 안주 겸 시 +10%. 마트 패키지 단위(1kg) 권장 (남는 건 다음 식사)." },
    ...
    <ToolPage width={880} slug="/tools/cooking/serving">
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '48px' }}>
        ...
        <div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
            {[
              { title: '🥓 삼겹살 파티 (4인)', items: '삼겹살 720~880g · 쌈채소 180~220g (1팩) · 두부 1모 · 쌀 약 360g' },
          ...
          <details style={faqDetails}>
            ...
            <div style={faqAnswer}>
              ...
              <ul style={{ paddingLeft: 18, marginTop: 8 }}>
                <li>삼겹살 약 650~790g (성인 3 + 아이 1, 메인·밥과 함께)</li>
                <li>쌈채소 약 160~200g (1팩)</li>
                <li>두부 1모 (300g)</li>
                <li>쌀 약 290~355g (또는 즉석밥 3~4개)</li>
              </ul>
