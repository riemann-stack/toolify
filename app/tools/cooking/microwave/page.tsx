...
const FAQ_LD = [
  { "q":"700W를 900W로 바꾸면 시간이 얼마나 줄어드나요?","a":"공식: 새 시간 = 기준 시간 × (기준 W / 새 W). • 700W 2분 → 900W: 2 × (700/900) ≈ 1분 33초 (약 22% 감소) • 700W 5분 → 900W: 5 × (700/900) ≈ 3분 53초 • 700W 1분 → 1000W: 1 × (700/1000) = 42초 (1000W 보정 -5% 추가) 기억하기 쉬운 비율: 700W → 900W는 약 78%의 시간이면 충분." },
  ...
  { "q":"햇반 데우는 표준 시간은?","a":"햇반 라벨 기준 1000W 2분 / 700W 2분 30초~3분. 내 전자레인지 W로 환산: • 600W: 약 3분 30초 • 700W: 약 2분 30초~3분 • 800W: 약 2분 15초 • 900W: 약 2분 • 1000W: 약 1분 50초 • 1200W: 약 1분 30초 데운 후 한 번 섞어주면 갓 지은 밥처럼 부드러움. 본 도구의 식품 프리셋 탭에서 정확히 계산됩니다." }
]
