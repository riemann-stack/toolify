...
const FAQ_LD = [
  { "q":"700W를 900W로 바꾸면 시간이 얼마나 줄어드나요?","a":"공식: 새 시간 = 기준 시간 × (기준 W / 새 W). • 700W 2분 → 900W: 2 × (700/900) ≈ 1분 33초 (약 22% 감소) • 700W 5분 → 900W: 5 × (700/900) ≈ 3분 53초 • 700W 1분 → 1000W: 1 × (700/1000)에 고출력 -5% 보정 ≈ 40초 기억하기 쉬운 비율: 700W → 900W는 약 78%의 시간이면 충분." },
  { "q":"출력이 낮을수록 시간이 더 필요한 이유?","a":"전자레인지의 W는 음식에 전달되는 마이크로파 에너지의 양입니다. 저출력일수록 같은 시간에 전달되는 에너지가 적어 가열에 더 오래 걸립니다. 또한 저출력은 효율도 함께 떨어져 단순 비례보다 5~10% 더 시간 필요. 본 도구는 600W 이하에 자동 +7% 보정을 적용합니다." },
  { "q":"양을 2배로 하면 시간도 2배인가요?","a":"아니요. 양이 늘면 시간은 비선형(N^0.75)으로 증가합니다. • 1인분 → 2인분: ×1.68 (2배 X) • 1인분 → 3인분: ×2.28 • 1인분 → 5인분: ×3.34 이유: 양이 많아도 표면적은 비례 증가하지 않고, 마이크로파가 동시에 여러 부분을 가열하기 때문. 정확한 보정은 식품 프리셋 탭의 인분 슬라이더에서 자동 계산됩니다." },
  { "q":"냉동·냉장·상온 시작 온도 차이?","a":"시작 온도가 높을수록 시간이 적게 듭니다. 냉동에서 시작할 때를 기준으로 냉장은 약 20%, 상온은 약 40% 짧게 잡습니다. 라벨 시간은 제품이 원래 보관되는 상태를 전제로 하므로, 본 도구는 식품마다 라벨 기준 보관 상태(햇반·즉석국은 상온, 편의점 도시락·우유는 냉장, 냉동식품은 냉동)를 표준으로 두고 다른 온도에서 시작할 때만 시간을 보정합니다. 예: 햇반은 상온 보관 제품이라 700W 2분이 라벨 그대로이고, 집에서 얼린 밥이라면 냉동을 골라 약 3분 20초로 계산됩니다." },
  { "q":"계란을 전자레인지에 데우면 왜 안 되나요?","a":"🚨 폭발 위험 때문입니다. 계란 노른자·흰자가 가열되면 내부 수증기 압력이 급격히 상승하지만 껍질이 압력을 가두어 폭발이 일어납니다. 입에 넣고 씹는 순간 폭발한 사례도 있어 부상 위험 큼. • ❌ 통째 가열 절대 금지 • ✅ 계란을 깨서 그릇에 풀거나, 노른자에 칼집을 낸 후 가열 • ✅ 삶은 계란을 데우려면 반으로 잘라서 가열 이는 메추리알·생선 알·소시지 통째 등 껍질 있는 모든 식품에 해당." },
  { "q":"알루미늄 호일·금속 그릇은 왜 안 되나요?","a":"🚨 스파크 → 화재 위험. 마이크로파가 금속 표면에 닿으면 전자가 급격히 이동하며 작은 번개(스파크)가 발생합니다. 심하면 마그네트론(본체) 손상·화재. • ❌ 알루미늄 호일·캔·금속 그릇·포크·금색·은색 테두리 그릇 • ❌ 빵의 트위스트 타이(철사 포함) • ⚠️ 가장 흔한 사고: 금색·은색 테두리 도자기 (중고·빈티지 주의) • ✅ 도자기·내열유리·PP 5번 플라스틱만 안전." },
  { "q":"비닐 봉지째 데워도 되나요?","a":"전용 비닐만 가능. 그것도 한쪽 끝을 1~2cm 잘라야 폭발 방지. • ✅ CJ·오뚜기 즉석국 등 전자레인지용 표시 — 끝 자르고 OK • ⚠️ 일반 비닐은 녹거나 환경호르몬 용출 • ❌ 닫힌 비닐 그대로는 폭발 제일 안전한 방법은 내열 그릇에 옮긴 후 가열. 위생적이고 균일하게 가열됨." },
  { "q":"가운데가 안 데워지는 이유?","a":"마이크로파는 음식 표면에서 약 2~4cm 안쪽까지만 직접 가열. 가운데는 열 전도로 데워져 시간이 걸립니다. 해결법: 1. 중간에 한 번 섞기 (1/2 지점에서 멈추고 휘젓기) 2. 가장자리에 음식 두기 (도넛 형태 배치) 3. 휴지 활용 (가열 → 1분 휴지 → 추가 가열) 4. 회전판 청소 (회전이 안 되면 가열 매우 불균일)" },
  { "q":"빵을 데우면 왜 딱딱해지나요?","a":"마이크로파는 빵 안의 수분을 빠르게 날려버려서 식는 즉시 딱딱해집니다. (수분 빠진 빵 = 굳은 빵) 해결법: • 10초 단위로 짧게 가열 (오래 X) • 물 한 방울 뿌리고 가열 (수분 보충) • 젖은 키친타올 위에 빵 올려 가열 (찜 효과) • 가장 좋은 방법은 오븐 토스터·후라이팬. 전자레인지는 비상용으로만." },
  { "q":"햇반 데우는 표준 시간은?","a":"햇반 라벨은 보통 700W 약 2분(제품에 따라 1000W 1분 30초). 본 도구의 즉석밥 프리셋(상온 보관·700W 2분 기준)으로 내 전자레인지 W 환산: • 600W: 약 2분 30초 • 700W: 약 2분 • 800W: 약 1분 45초 • 900W: 약 1분 33초 • 1000W: 약 1분 20초 • 1200W: 약 1분 7초. 데운 후 한 번 섞어주면 갓 지은 밥처럼 부드러움. 식품 프리셋 탭에서 정확히 계산됩니다." }
]
    ...
    <ToolPage width={880} slug="/tools/cooking/microwave">
      ...
      <div style={card}>
        ...
        <ul style={{ paddingLeft: 18, margin: '12px 0 0', fontSize: 13, color: 'var(--muted)', lineHeight: 1.95 }}>
          ...
          <li><strong style={{ color: 'var(--text)' }}>예: 700W 5분 → 600W</strong>: 5 × (700/600) + 저출력 보정 ≈ <strong>6분 15초</strong></li>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13, minWidth: 560 }}>
            <thead>
              <tr style={{ background: 'var(--bg3)' }}>
                <th scope="col" style={{ padding: '10px 12px', textAlign: 'left', color: 'var(--muted)', fontSize: 11 }}>식품</th>
                <th scope="col" style={{ padding: '10px 12px', textAlign: 'left', color: 'var(--muted)', fontSize: 11 }}>700W 표준</th>
                <th scope="col" style={{ padding: '10px 12px', textAlign: 'left', color: 'var(--muted)', fontSize: 11 }}>핵심 팁</th>
              </tr>
            </thead>
            <tbody>
              {[
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          ...
          • <strong>700W 1분</strong> → 1000W: 1 × (700/1000)에 고출력 -5% 보정 ≈ <strong>40초</strong><br />
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          ...
          • <strong>❄️ 냉동 (-18°C)</strong>: 기준<br />
          • <strong>🧊 냉장 (4°C)</strong>: 냉동 대비 약 <strong>-20%</strong><br />
          • <strong>🌡️ 상온 (20°C)</strong>: 냉동 대비 약 <strong>-40%</strong><br />
          라벨 시간은 제품이 원래 보관되는 상태를 전제로 합니다. 그래서 본 도구는 식품마다 라벨 기준 보관 상태
          (햇반·즉석국은 상온, 편의점 도시락·우유는 냉장, 냉동식품은 냉동)를 표준으로 두고, 다른 온도에서 시작할 때만 시간을 보정합니다.<br />
          예: 햇반은 상온 보관 제품이라 700W 2분이 라벨 그대로이고, 집에서 얼린 밥이라면 냉동을 골라 약 3분 20초로 계산됩니다.
        </p>
      </details>
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          햇반 라벨은 보통 <strong>700W 약 2분</strong> (제품에 따라 1000W 1분 30초).<br />
          본 도구의 즉석밥 프리셋(상온 보관·700W 2분 기준)으로 내 전자레인지 W 환산:<br />
          • <strong>600W</strong>: 약 2분 30초<br />
          • <strong>700W</strong>: 약 2분<br />
          • <strong>800W</strong>: 약 1분 45초<br />
          • <strong>900W</strong>: 약 1분 33초<br />
          • <strong>1000W</strong>: 약 1분 20초<br />
          • <strong>1200W</strong>: 약 1분 7초<br />
          데운 후 <strong>한 번 섞어주면</strong> 갓 지은 밥처럼 부드러움. 식품 프리셋 탭에서 정확히 계산됩니다.
        </p>
      </details>
