...
const FAQ_LD = [
  ...
  { "q":"냉동·냉장·상온 시작 온도 차이?","a":"시작 온도가 높을수록 시간이 적게 듭니다. • ❄️ 냉동 (-18°C): 라벨 표준 • 🧊 냉장 (4°C): 표준 대비 -20% • 🌡️ 상온 (20°C): 표준 대비 -40% 예: 햇반 700W 2분(냉동) → 냉장 보관이면 1분 36초, 상온이면 1분 12초. 단 상온 보관은 식품 안전상 권장하지 않으니 냉장 권장." },
  ...
  { "q":"햇반 데우는 표준 시간은?","a":"햇반 라벨은 보통 700W 약 2분(제품에 따라 1000W 1분 30초). 본 도구의 냉동밥 프리셋(700W 2분 기준)으로 내 전자레인지 W 환산: • 600W: 약 2분 30초 • 700W: 약 2분 • 800W: 약 1분 45초 • 900W: 약 1분 33초 • 1000W: 약 1분 20초 • 1200W: 약 1분 7초. 데운 후 한 번 섞어주면 갓 지은 밥처럼 부드러움. 식품 프리셋 탭에서 정확히 계산됩니다." }
]
    ...
    <div style={{ maxWidth: '880px', margin: '0 auto', padding: '60px 24px 80px' }}>
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          ...
          본 도구의 냉동밥 프리셋(700W 2분 기준)으로 내 전자레인지 W 환산:<br />
