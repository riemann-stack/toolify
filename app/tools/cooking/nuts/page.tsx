...
const FAQ_LD = [
  ...
  { "q":"브라질너트는 왜 1~2알만 먹어야 하나요?","a":"브라질너트는 셀레늄 함량이 매우 높아 1알(약 4~5g)에 평균 70~100μg이 들어 있고 개체 편차도 큽니다(미국 USDA 기준). 성인 하루 셀레늄 권장섭취량은 60μg, 상한섭취량은 400μg이라 1알로도 권장량을 채우고, 매일 3알 이상 먹으면 상한에 가까워지거나 함량이 높은 개체는 넘을 수 있어 하루 1~2알이 권장됩니다. 셀레늄 과잉 섭취 시 탈모, 손발톱 변형, 신경계 손상이 발생할 수 있어요. 본 도구의 셀레늄 자동 경고 활용." },
    ...
    <ToolPage width={880} slug="/tools/cooking/nuts">
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '12px', minWidth: 420 }}>
          ...
          <tbody>
            {[
              ...
              { n: '브라질너트',   s: '10g', c: '약 2알',     k: '66kcal',  v: '셀레늄' },
      ...
      <div style={{ background: 'rgba(255,50,50,0.06)', border: '2px solid rgba(255,80,80,0.4)', borderRadius: 'var(--radius-m)', padding: '16px 20px', marginBottom: '14px' }}>
        ...
        <ul style={{ fontSize: '13px', color: 'var(--text)', lineHeight: 1.9, paddingLeft: 20, margin: 0 }}>
          <li>성인 하루 셀레늄 권장섭취량: <strong>60μg</strong> (2020 한국인 영양소 섭취기준)</li>
          <li>상한섭취량: <strong>400μg</strong> — 이 이상 독성</li>
          <li>브라질너트 <strong>1알</strong>로도 하루 권장섭취량을 채울 수 있음</li>
          <li>매일 <strong>3알 이상</strong>이면 상한(400μg)에 가까워지고, 함량이 높은 개체는 넘을 수 있음 — 하루 1~2알 권장</li>
        </ul>
      </div>
      <div style={card}>
      ...
      <details style={faqDetails}>
        <summary style={faqSummary}>Q2. 브라질너트는 왜 1~2알만 먹어야 하나요?</summary>
        <div style={faqAnswer}>
          브라질너트는 셀레늄 함량이 매우 높아 <strong style={{ color: 'var(--text)' }}>1알(약 4~5g)에 평균 70~100μg</strong>이 들어 있고 개체 편차도 큽니다(미국 USDA 기준). 성인 하루 셀레늄 권장섭취량은 60μg, 상한섭취량은 400μg이라 1알로도 권장량을 채우고, 매일 3알 이상 먹으면 상한에 가까워지거나 함량이 높은 개체는 넘을 수 있어 하루 1~2알이 권장됩니다. 셀레늄 과잉 섭취 시 탈모, 손발톱 변형, 신경계 손상이 발생할 수 있어요. 본 도구의 셀레늄 자동 경고 활용.
        </div>
      </details>
