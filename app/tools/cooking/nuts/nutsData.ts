...
export const NUTS_DATA: NutData[] = [
  { key: 'almond',       name: '아몬드',       icon: '🥜', color: '#D4A373',
  ...
  { key: 'walnut',       name: '호두',         icon: '🧠', color: '#6B4423',
  ...
  { key: 'cashew',       name: '캐슈넛',       icon: '🌙', color: '#E8D4A0',
  ...
  { key: 'brazilNut',    name: '브라질너트',   icon: '⚠️', color: '#4A2C20',
  ...
  { key: 'peanut',       name: '땅콩',         icon: '🟤', color: '#C8956D',
  ...
  { key: 'sunflowerSeed', name: '해바라기씨',  icon: '🌻', color: '#4A5D23',
  ...
  { key: 'pumpkinSeed',  name: '호박씨',       icon: '🎃', color: '#2D5016',
  ...
  { key: 'pistachio',    name: '피스타치오',   icon: '💚', color: '#93C572',
  ...
  { key: 'pecan',        name: '피칸',         icon: '🍂', color: '#8B4513',
  ...
  { key: 'macadamia',    name: '마카다미아',   icon: '⚪', color: '#F5F1E6',
  ...
  { key: 'hazelnut',     name: '헤이즐넛',     icon: '🟫', color: '#654321',
    ...
    maxDaily: 30, warning: null, danger: false, allergyGroup: 'tree',
    benefit: ['심혈관 건강', '혈당 조절', '뼈 건강'] },
  { key: 'pineNut',      name: '잣',           icon: '🌲', color: '#6B8E4E',
...
export const POPULAR_MIXES: MixPreset[] = [
  ...
  {
    id: 'cardio', name: '❤️ 심혈관 믹스', desc: '불포화지방 · 항염증',
    items: [
      { key: 'walnut',     grams: 10 },
      { key: 'almond',     grams: 10 },
      { key: 'pecan',      grams: 8 },
  ...
  {
    id: 'balanced', name: '⚖️ 균형 믹스', desc: '종합 영양 · 일상 추천',
    items: [
      { key: 'almond',      grams: 8 },
      { key: 'walnut',      grams: 8 },
      { key: 'cashew',      grams: 8 },
