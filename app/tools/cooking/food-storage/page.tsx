...
const FAQ_LD = [
              ...
              { q: '국·찌개는 냉장고에서 며칠까지 안전한가요?',
                a: '2~3일 이내가 권장 기준입니다. 먹기 직전에 팔팔 끓이는 것은 그때 먹을 분량을 안전하게 하려는 것이지 보관 기한을 늘려 주지 않습니다. 일부 세균의 포자와 독소는 끓여도 남고, 끓이고 식히기를 반복할수록 풍미가 사라지고 식중독 위험도 누적됩니다. 먹을 만큼만 덜어 데우고 남는 양은 1회분씩 냉동하세요. 김치찌개·된장찌개 등 발효 베이스는 4일까지도 가능하지만, 맑은 국·미역국은 2일 안에 먹는 것이 안전합니다.' },
