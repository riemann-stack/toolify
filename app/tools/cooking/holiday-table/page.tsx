...
const FAQ_LD = [
  { "q":"4인 가족 설날 차례상 비용은 보통 얼마인가요?","a":"aT(한국농수산식품유통공사)가 매년 발표하는 4인 가족 설날 차례상 비용은 2026년 설 조사를 포함한 최근 기준 전통시장 약 28~33만 원, 대형 마트 36~42만 원입니다. 본 도구는 표준 분량·평균 시세 기준이라 「설날 + 차례상 + 4인」이 약 25만 원 내외로, aT 전통시장가의 하단에 가깝습니다(aT 조사는 분량이 더 넉넉). 간소 차림은 약 15만 원까지 내려갑니다. 명절 성수기 실시간 시세를 반영하면 더 오를 수 있으니 위 계산기로 확인하세요." },
  ...
  { "q":"4인 가족 추석 차례상 vs 식사 위주 비용 차이?","a":"본 도구 기준 (4인, 표준 분량·평균 시세): 추석 차례상(정석) 약 25만 원, 간소 차림 약 13만 원, 식사 위주 약 13만 원. 차례상이 가장 비싼 이유는 어동육서·조율이시 등 격식을 위해 다양한 종류를 소량씩 갖춰야 해서 단위당 비용이 올라가기 때문입니다. 참고로 aT 발표 4인 추석 차례상은 최근 조사(2025년 추석 포함) 기준 전통시장 약 25~30만·마트 35~40만 원으로, 본 도구는 표준 분량 기준이라 다소 낮습니다. 명절 성수기 실시간 시세 반영 시 더 오를 수 있습니다." },
...
export default function HolidayTablePage() {
  return (
    <div style={{ maxWidth: '880px', margin: '0 auto', padding: '60px 24px 80px' }}>
      ...
      <UpdatedMeta
        date="2026년 7월"
        basis="aT 설·추석 차례상 비용 조사(2026년 설 포함)·KAMIS 일별 시세 기준"
        sources={[
        ...
        <section>
          ...
          <details style={faqDetails}>
            ...
            <div style={faqAnswer}>
              ...
              2026년 설 조사를 포함한 최근 기준 전통시장 <strong style={{ color: 'var(--accent)' }}>약 28~33만 원</strong>, <strong>대형 마트 36~42만 원</strong>입니다.
          ...
          <details style={faqDetails}>
            ...
            <div style={faqAnswer}>
              ...
              <br /><br />
              참고로 <strong style={{ color: 'var(--text)' }}>aT 발표</strong> 4인 추석 차례상은 최근 조사(2025년 추석 포함) 기준 전통시장 약 25~30만·마트 35~40만 원으로, 본 도구는 표준 분량 기준이라 다소 낮습니다. 명절 성수기 실시간 시세 반영 시 더 오를 수 있습니다.
            </div>
          </details>
