...
const FAQ_LD = [
  { "q":"4인 가족 설날 차례상 비용은 보통 얼마인가요?","a":"aT(한국농수산식품유통공사)가 2026년 2월 6일 조사한 4인 가족 설 차례상 비용은 평균 약 20만 3천 원(전통시장 약 18만 5천 원, 대형유통업체 약 22만 8천 원)입니다. aT 조사는 24개 품목 기준이라 품목 구성이 본 도구와 다릅니다. 본 도구로 「설날 + 차례상 + 4인」을 계산하면 갈비찜·전 3종 등을 넉넉히 넣은 정석 기준이라 약 25만 원 내외, 간소 차림은 약 15만 원입니다. 명절 성수기 실시간 시세를 반영하면 더 오를 수 있으니 위 계산기로 확인하세요." },
  ...
  { "q":"차례상에 올리면 안 되는 음식이 있나요?","a":"전통 금기 음식: 복숭아 — 귀신을 쫓는 과일이라고 여겨짐 꽁치·삼치·갈치 — 「치」자 들어가는 생선 고추·마늘 양념 강한 음식 — 산적·나물에 진한 양념 X (간장·참기름 위주) 붉은팥 — 흰콩·녹두 사용 권장 본 도구의 차례상(정석·간소) 구성은 이 금기를 따라 마늘을 넣지 않았습니다. 식사 위주·음복 식사는 일반 가정식이라 마늘이 들어갑니다. (지역·가문별 차이 있을 수 있음)" },
  { "q":"4인 가족 추석 차례상 vs 식사 위주 비용 차이?","a":"본 도구 기준 (4인, 표준 분량·평균 시세): 추석 차례상(정석) 약 25만 원, 간소 차림 약 13만 원, 식사 위주 약 13만 원. 차례상이 가장 비싼 이유는 어동육서·조율이시 등 격식을 위해 다양한 종류를 소량씩 갖춰야 해서 단위당 비용이 올라가기 때문입니다. 참고로 aT가 2026년 9월 18일 조사한 4인 가족 추석 차례상 비용은 평균 약 19만 7천 원(전통시장 약 19만 6천 원, 대형유통업체 약 19만 2천 원)으로 지난해보다 1.5% 내렸습니다. aT 조사는 24개 품목 기준이라 갈비찜 등을 넣은 본 도구의 정석 차림보다 낮게 나옵니다." },
...
export default function HolidayTablePage() {
  return (
    <ToolPage width={880} slug="/tools/cooking/holiday-table">
      ...
      <UpdatedMeta
        date="2026년 9월"
        basis="aT 차례상 비용 조사(2026년 설 2.6·추석 9.18)·KAMIS 일별 시세 기준"
        sources={[
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
        ...
        <section>
          ...
          <p style={{ fontSize: '13px', color: 'var(--muted)', marginTop: '12px', lineHeight: 1.7 }}>
            방향은 제주가 신위를 바라보는 기준이라 <strong style={{ color: 'var(--text)' }}>동쪽은 제주의 오른쪽, 서쪽은 왼쪽</strong>입니다.
            <br />
        ...
        <section>
          ...
          <details style={faqDetails}>
            ...
            <div style={faqAnswer}>
              <strong style={{ color: 'var(--text)' }}>aT(한국농수산식품유통공사)</strong>가 2026년 2월 6일 조사한 4인 가족 설 차례상 비용은
              평균 <strong style={{ color: 'var(--accent)' }}>약 20만 3천 원</strong>(전통시장 약 18만 5천 원, 대형유통업체 약 22만 8천 원)입니다.
              aT 조사는 24개 품목 기준이라 품목 구성이 본 도구와 다릅니다. 본 도구로 「설날 + 차례상 + 4인」을 계산하면 갈비찜·전 3종 등을 넉넉히 넣은 정석 기준이라 <strong style={{ color: 'var(--accent)' }}>약 25만 원 내외</strong>,
              간소 차림은 <strong>약 15만 원</strong>입니다. 명절 성수기 실시간 시세를 반영하면 더 오를 수 있으니 위 계산기로 확인하세요.
            </div>
          </details>
          ...
          <details style={faqDetails}>
            ...
            <div style={faqAnswer}>
              ...
              본 도구의 차례상(정석·간소) 구성은 이 금기를 따라 마늘을 넣지 않았습니다. 식사 위주·음복 식사는 일반 가정식이라 마늘이 들어갑니다. (지역·가문별 차이 있을 수 있음)
            </div>
          </details>
          ...
          <details style={faqDetails}>
            ...
            <div style={faqAnswer}>
              ...
              <br /><br />
              참고로 <strong style={{ color: 'var(--text)' }}>aT</strong>가 2026년 9월 18일 조사한 4인 가족 추석 차례상 비용은 평균 약 19만 7천 원(전통시장 약 19만 6천 원, 대형유통업체 약 19만 2천 원)으로 지난해보다 1.5% 내렸습니다.
              aT 조사는 24개 품목 기준이라 갈비찜 등을 넣은 본 도구의 정석 차림보다 낮게 나옵니다.
            </div>
          </details>
