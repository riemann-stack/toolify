...
const FAQ_LD = [
              ...
              },
              {
                ...
                a: '<strong>저당 수제(14~18°Bx)</strong>는 과일 본래 맛을 살리지만 발효 위험 ↑ → <strong>냉장 1~2주</strong> 보관. <strong>일반 수제(22~28°Bx)</strong>도 발효·곰팡이 위험이 남아 냉장 보관이 기본입니다. <strong>보존용(60~68°Bx)</strong>은 시판 잼 수준으로, 당 농도가 미생물 증식을 억제해 실온 보관이 가능합니다(통상 65°Bx 이상). 굴절계로 측정하면 정확하고, 굴절계 없으면 과일 무게의 50~80%만큼 설탕 첨가 후 농축하세요. 예: 딸기 1kg + 설탕 800g을 농축하면 약 50°Bx — 실온 보관용은 여기서 더 졸여 65°Bx 이상으로 올립니다.',
              },
              {
        ...
        <section>
          ...
          <div style={{ overflowX: 'auto', marginBottom: 12 }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px' }}>
              ...
              <tbody>
                {[
                  ['🍓 잼·청 (저당 수제)', '14~18 °Bx',   '발효 위험 ↑ · 냉장 보관 필수'],
                  ['🍓 잼·청 (일반 수제)', '22~28 °Bx',   '냉장 1~2주 내 소비 권장'],
                  ['🍓 잼·청 (보존용)',   '60~68 °Bx',   '시판 잼 수준 · 실온 보관 가능'],
