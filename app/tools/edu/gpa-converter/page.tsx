...
const FAQ_LD = [
              ...
              },
              {
                ...
                a: 'WES는 미국 대학원에 제출되는 외국 성적을 표준화하는 평가 기관으로, 과목별 평어를 미국 평어로 옮겨 평균을 냅니다. 한국 4.5·4.3 만점에서는 B+ → 3.3, B0 → 3.0처럼 옮겨지므로 대체로 비례 환산보다 높게 나옵니다(4.5만점 4.0점이면 비례 3.56, WES 4.00). 다만 A+와 A0를 둘 다 4.00으로 처리해 상위권 변별이 사라진다(4.0 캡)는 점에서 보수적이라 불립니다.',
              },
              {
