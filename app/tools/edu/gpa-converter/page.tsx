...
const FAQ_LD = [
              {
                ...
                a: '환산 방식에 따라 다릅니다. <strong>비례 환산</strong>: 4.0 / 4.5 × 4.0 = 약 <strong>3.56</strong>. <strong>WES 기준</strong>(백분율 브래킷 기반, 미국 대학원 다수 채택): 4.0점은 백분율 약 89%에 해당해 <strong>A- ≈ 3.70</strong> — 이 구간에서는 비례보다 오히려 높게 나옵니다. <strong>한국 평어 기준</strong>도 비슷하게 3.70 내외. 본 도구의 비교 그리드에서 세 가지 결과를 한 번에 확인할 수 있습니다.',
              },
              {
              ...
              },
              {
                ...
                a: 'WES는 미국 대학원에 제출되는 외국 성적을 표준화하는 공인 기관입니다. 백분율 브래킷 기반이라 구간에 따라 비례 환산보다 낮게(중하위권 구간)도, 높게(A0 부근 — 4.5만점 4.0점이면 3.70)도 나옵니다. 항상 낮은 것이 아니라, A+(95%↑)와 A(90~94%)를 둘 다 4.00으로 동일 처리해 상위권 변별을 무화(4.0 캡)한다는 점에서 보수적이라 불립니다.',
              },
              {
            ...
            {[
              {
                ...
                d: '미국 대학원 다수가 채택하는 World Education Services 표준. 백분율 브래킷 기반이라 구간에 따라 비례보다 낮게도(중하위권), 높게도(A0 부근) 나오며, A+와 A를 둘 다 4.00으로 캡해 상위권 변별을 없앤다는 점에서 보수적입니다.',
                use: '미국 대학원 GRAD 지원, 미국 취업 학력 평가 시 권장',
                c: '#0891B2',
              },
              {
                t: '📏 비례 환산 (단순 비율)',
                d: '단순 비율: US GPA = (한국 GPA / 만점) × 4.0. 계산이 투명해 일부 학교 자체 환산이나 자기소개서용으로 사용. 구간에 따라 WES보다 높게도 낮게도 나옵니다(예: 4.5만점 4.0점은 비례 3.56 < WES 3.70).',
