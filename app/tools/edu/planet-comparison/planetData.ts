...
export const PLANETS: Planet[] = [
  ...
  { id: 'earth', name: '지구',   emoji: '🌍', nameEn: 'Earth',
    ...
    distanceFromSunKm: 149_600_000, color: 'var(--cyan-600)',
  ...
  { id: 'mars', name: '화성',   emoji: '♂️', nameEn: 'Mars',
    ...
    distanceFromSunKm: 227_900_000, color: 'var(--red-600)',
  ...
  { id: 'jupiter', name: '목성', emoji: '♃', nameEn: 'Jupiter',
    ...
    distanceFromSunKm: 778_500_000, color: 'var(--orange-600)',
  ...
  { id: 'saturn', name: '토성',  emoji: '♄', nameEn: 'Saturn',
    ...
    distanceFromSunKm: 1_434_000_000, color: 'var(--yellow-700)',
  ...
  { id: 'uranus', name: '천왕성', emoji: '♅', nameEn: 'Uranus',
    ...
    distanceFromSunKm: 2_871_000_000, color: 'var(--teal-600)',
