...
const FAQ_LD = [
  ...
  { "q":"슈로더 주파수가 뭔가요?","a":"룸 모드가 지배하는 영역과 일반 음향의 경계입니다. 이 미만에서는 모드 영향이 압도적이라 EQ·이퀄라이저로 보정이 잘 안 되고, 베이스 트랩 같은 물리적 처리가 필요합니다. 공식: fs = 2000 × √(RT60 / V) — RT60 0.4초 기준 일반 거실 약 180~200Hz(잔향이 짧은 방은 더 낮아짐). 본 도구는 RT60 기본값 0.4초(보통 거실 평균치)로 계산하며, 방 치수 카드의 슬라이더로 0.2~1.0초 사이에서 바꿀 수 있습니다." },
  ...
  { "q":"본 도구의 RT60 기본값 0.4초가 우리 방과 다르면?","a":"방 치수 카드의 RT60 슬라이더(0.2~1.0초)로 바꿔 보세요. 슈로더 주파수 계산에만 RT60(잔향시간)이 들어가고, 룸 모드 주파수 자체는 방 치수와 온도만으로 정해집니다. 슈로더 주파수는 RT60의 제곱근에 비례해 잔향이 긴 반사성 방(RT60 0.6초)은 약 22% 높아지고, 흡음재가 많은 방(RT60 0.25초)은 약 21% 낮아집니다. 커튼·러그·책장이 많을수록 모드 지배 영역이 좁아지며, 모드 표와 평면도 시각화는 RT60과 무관하게 그대로 유효합니다." },
    ...
    <div style={{ maxWidth: '880px', margin: '0 auto', padding: '60px 24px 80px' }}>
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          ...
          본 도구는 RT60 기본값 0.4초(보통 거실 평균치)로 계산하며, 방 치수 카드의 슬라이더로 0.2~1.0초 사이에서 바꿀 수 있습니다.
        </p>
      </details>
      ...
      <details style={faqDetails}>
        <summary style={faqSummary}>Q5. 본 도구의 RT60 기본값 0.4초가 우리 방과 다르면?</summary>
        <p style={faqAnswer}>
          방 치수 카드의 RT60 슬라이더(0.2~1.0초)로 바꿔 보세요.
          슈로더 주파수 계산에만 <strong>RT60(잔향시간)</strong>이 들어가고, 룸 모드 주파수 자체는 방 치수·온도만으로 정해집니다.<br />
          • 잔향이 긴 반사성 방 (RT60 0.6초): 슈로더 주파수 약 <strong>22% 상승</strong><br />
          • 흡음재가 많은 방 (RT60 0.25초): 약 <strong>21% 하강</strong><br />
          커튼·러그·책장이 많을수록 모드 지배 영역이 좁아지며,
          <strong>모드 표·평면도 시각화는 RT60과 무관</strong>하게 그대로 유효합니다.
        </p>
      </details>
