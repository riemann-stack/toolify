...
const FAQ_LD = [
              ...
              {
                q: '마른 비만은 구체적으로 어떤 기준으로 판정하나요?',
                a: 'BMI가 정상 범위인데 체지방률이 높은 상태로, 통용되는 참고 기준은 <strong>체지방률 남성 25%·여성 30% 이상</strong>입니다. 여기에 허리둘레(남 90cm·여 85cm 이상)나 허리-신장비(WHtR) 0.5 이상이 함께 나타나면 가능성이 더 큽니다. 체지방률은 체성분 분석(InBody 등 생체전기저항 측정)으로 확인하는 것이 일반적이며, 본 도구의 [허리·체지방] 탭에서도 Navy 공식 기반 추정값을 참고할 수 있습니다. 정확한 판정은 검진 기관의 체성분 검사를 권장합니다.',
              },
              {
    ...
    <ToolPage width={760} slug="/tools/health/bmi">
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '48px' }}>
        ...
        <section>
          ...
          <div style={{ background: 'var(--bg2)', border: '1px solid rgba(14,165,233,0.2)', borderRadius: 'var(--radius-m)', padding: '20px 22px', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            {[
              ...
              <div key={i} style={{ background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 10, padding: '11px 14px', display: 'grid', gridTemplateColumns: '32px 1fr auto', gap: 10, alignItems: 'center' }}>
                ...
                <span style={{ fontSize: 13, color: 'var(--accent)', fontFamily: 'var(--font-sans)', fontWeight: 800 }}>{g.range}</span>
              </div>
            ))}
          </div>
        ...
        <section>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginBottom: '16px' }}>
            {[
              ...
              <div key={i} style={{ background: 'var(--bg2)', border: `1px solid ${tip.color}30`, borderRadius: 'var(--radius-m)', padding: '16px 20px', display: 'flex', gap: '14px' }}>
          ...
          <div style={{ background: 'var(--bg2)', border: '1px solid rgba(14,165,233,0.15)', borderRadius: 'var(--radius-m)', padding: '16px 20px' }}>
              ...
              <tbody>
                {[
                  ...
                  <tr key={i} style={{ borderBottom: '1px solid var(--border)', background: i % 2 === 0 ? 'transparent' : 'var(--bg2)' }}>
                    ...
                    <td style={{ padding: '10px 12px', textAlign: 'center', color: 'var(--accent)', fontFamily: 'var(--font-sans)', fontWeight: 700 }}>{a}</td>
        ...
        <section>
          <Disclaimer variant="medical" open>
            ...
            <br />
            체중 강박·거식증 우려 시 — 정신건강 위기상담 <strong>1577-0199</strong> · 자살예방 <strong>109</strong> (24시간)
          </Disclaimer>
        </section>
