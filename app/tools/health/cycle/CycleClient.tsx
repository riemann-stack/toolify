  ...
  return (
    <div className={s.wrap}>
      ...
      >
        ...
        주기 변동이 ±8일 이상이거나 부정출혈·과다 출혈, 임신이 아닌데 3개월 이상 생리가 없을 때, 일상에 지장을 주는 PMS·통증이 있을 때, 그리고 임신 계획이나 피임을 정할 때는 <strong>산부인과 상담</strong>을 받으세요.
      </Disclaimer>
      ...
      {tab === 'fertility' && (
        <div className={s.tabPanel} role="tabpanel" id="cycle-panel-fertility" aria-labelledby="cycle-tab-fertility">
          <div className={s.dangerCard}>
            ...
            <p>
              달력·기초체온 등 주기 기반 피임(가임인지법)은 방법과 실천에 따라 일반적인 사용에서 실패율 편차가 크고 높은 편입니다(미국 CDC 기준 대략 2~23%대). 피임·임신 계획은 반드시 산부인과 상담을 받으세요.
