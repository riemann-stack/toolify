...
const FAQ_LD = [
              ...
              { q: '음주 측정 거부 시 처벌은?', a: '음주 측정 거부는 그 자체로 형사처벌 대상입니다(도로교통법 제148조의2). 면허 취소(5년 결격)와 1~5년 징역 또는 500만~2,000만원 벌금이 부과될 수 있습니다. 처벌 수위가 가장 무거운 0.2% 이상 음주(2~5년 / 1,000만~2,000만원)와 형량 범위가 상당 부분 겹칠 만큼 무겁지만 완전히 동일한 기준은 아닙니다. "측정하지 않으면 불리하지 않다"는 생각은 잘못된 통념입니다.' },
              { q: '어제 12시까지 술 마셨는데 오늘 아침 운전 위험이 남아있나요?', a: '음주량과 신체 조건에 따라 다릅니다. 70kg 남성 + 소주 1병(약 45g), 음주 종료 자정 가정: 최고 BAC 약 0.095 → 면허정지 기준(0.03) 미만 추정 04:22, 완전 분해 추정 06:22로 8시엔 거의 0입니다. 그러나 소주 2병(약 91g)이면 8시에도 약 0.07(면허취소 0.08에 근접), ALDH2 결손·공복 음주면 더 오래 남습니다. <strong>BAC가 낮게 추정되더라도, 그리고 계산값과 관계없이 음주 후 운전은 금지</strong>입니다 — 불확실하면 택시·지하철·대리운전. 본 도구의 「🌅 다음날 아침」 탭은 위험을 참고용으로 추정할 뿐입니다.' },
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '48px' }}>
        ...
        <div>
          ...
          <p style={{ fontSize: '12px', color: 'var(--muted)', marginTop: '10px', lineHeight: 1.6 }}>
            ※ 윤창호법(2019년 6월 BAC 기준 0.05→0.03 강화) 이후 현행 기준. 음주운전으로 사망사고 발생 시 <strong style={{ color: '#DC2626' }}>무기징역까지 가능</strong>합니다. 세부 처벌·면허 결격은 사안에 따라 달라질 수 있어 공식 기준을 확인하세요.
          </p>
        </div>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px' }}>
              ...
              <tbody>
                {[
                  ...
                  ['소주 반병 (180ml)',    '약 22.7g',  '약 0.048%', '약 1.2시간',    '#A16207'],
        ...
        <div>
          ...
          <div style={{ background: 'var(--bg2)', border: '1px solid rgba(234,88,12,0.30)', borderRadius: 12, padding: '16px 18px' }}>
            <p style={{ fontSize: 13, color: '#EA580C', fontWeight: 700, marginBottom: 10 }}>📌 예시: 70kg 남성, 식후, 소주 2병 (약 91g), 음주 종료 자정(00:00)</p>
            <ul style={{ paddingLeft: 18, fontSize: 13, color: 'var(--muted)', lineHeight: 1.85, margin: 0 }}>
              <li>최고 BAC: <strong style={{ color: '#DC2626' }}>0.191</strong> (면허취소 수준)</li>
              <li>면허취소 기준(0.08) 미만 추정: 익일 <strong>07:25</strong></li>
              <li>면허정지 기준(0.03) 미만 추정: 익일 <strong>10:44</strong></li>
              <li>알코올 잔존 추정 종료: 익일 <strong>12:44</strong></li>
              <li>익일 08:00 BAC: <strong style={{ color: '#DC2626' }}>약 0.071</strong> (면허정지 기준 크게 초과 — 출근길 단속 시 면허취소 수준)</li>
            </ul>
          </div>
        ...
        <div>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13, minWidth: 480 }}>
              <thead>
                <tr style={{ borderBottom: '1px solid var(--border)' }}>
                  ...
                  <th scope="col" style={{ padding: '10px 12px', textAlign: 'right', color: '#DC2626', fontWeight: 700 }}>알코올</th>
                </tr>
              </thead>
              <tbody>
          ...
          <p style={{ fontSize: '12px', color: 'var(--muted)', lineHeight: 1.7, marginTop: 8 }}>
            최고 BAC ≈ 0.18 → 면허취소 + 형사처벌. 다음날 9시까지도 0.03 초과 가능. 70kg 남성 기준 (시간 흐름 누적 추정).
          </p>
        </div>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13, minWidth: 480 }}>
              <thead>
                <tr style={{ borderBottom: '1px solid var(--border)' }}>
                  ...
                  <th scope="col" style={{ padding: '10px 12px', textAlign: 'left', color: '#DC2626', fontWeight: 700 }}>위험</th>
                </tr>
              </thead>
              <tbody>
