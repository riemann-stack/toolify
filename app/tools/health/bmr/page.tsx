...
const FAQ_LD = [
              {
                ...
                a: '1919년 처음 발표되고 1984년 개정된(Roza-Shizgal) 기초대사량 계산 공식으로, 임상에서 오래 사용돼 왔습니다. 본 도구가 쓰는 개정판 계수는 — 남성: 88.362 + (13.397×체중kg) + (4.799×키cm) − (5.677×나이), 여성: 447.593 + (9.247×체중kg) + (3.098×키cm) − (4.330×나이) 입니다(원전 1919년 계수와는 다릅니다). 이후 Mifflin-St Jeor 공식도 개발되었으며 두 공식 모두 ±10~14% 수준의 오차가 있을 수 있습니다. 본 도구는 4공식을 모두 비교 표시합니다.',
              },
              {
        ...
        <section>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
            {[
              ...
              { name: '② Harris-Benedict (1919·1984 개정)', tag: '임상 다용', tagColor: '#A16207', desc: '원전 1919년·개정판 1984년(Roza-Shizgal). 본 도구는 개정판 계수 사용. 정확도 약 ±14%(재평가 연구 기준). Mifflin보다 약간 높게 추정. 의료/연구 기록 일관성 ↑.' },
