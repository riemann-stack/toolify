...
const FAQ_LD = [
          ...
          },
          {
            ...
            a: '아닙니다. 다음 모두 별도 발생: ① 증여세(수증자), ② 취득세(시가인정액 기준 3.5%, 조정대상지역의 시가표준액 3억원 이상 주택을 1세대 2주택 이상인 사람이 증여하면 12% — 1세대 1주택자가 배우자·직계존비속에게 주면 3.5%, 지방교육세·농어촌특별세 별도), ③ 자금출처 소명(수증자), ④ 양도세(부담부증여 시 증여자), ⑤ 재산세(이전 후). 부동산 증여 1건 자문료 50~100만원이지만 잘못된 신고 시 가산세·과태료가 훨씬 큽니다. 세무사 상담 필수.',
          },
          {
            q: '유류분이란 무엇인가요?',
    ...
    <div style={{ maxWidth: '880px', margin: '0 auto', padding: '60px 24px 80px' }}>
      ...
      <div style={card}>
        <ul style={{ paddingLeft: '20px', margin: 0, fontSize: '14px', lineHeight: 1.9, color: 'var(--text)' }}>
          <li><strong>일괄공제 5억원</strong> — 기초공제(2억) + 인적공제(자녀 1인당 5천만원 등) 합계와 비교해 큰 금액 적용 (배우자가 단독으로 상속받으면 일괄공제 없이 기초공제 2억 + 인적공제만 가능)</li>
          ...
          <li><strong>장례비 공제</strong> — 실제 사용액 (증빙이 없거나 500만원 미만이어도 500만원, 1천만원 한도, 봉안시설 별도 5백만원)</li>
        </ul>
      </div>
      ...
      <div style={{ ...card, borderTop: '3px solid var(--orange-600)' }}>
        ...
        <ul style={{ paddingLeft: 20, margin: 0, fontSize: 13, lineHeight: 1.9, color: 'var(--text)' }}>
          <li><strong>취득세</strong> (수증자 부담): 일반 3.5% / 조정대상지역 시가표준액 3억원 이상 주택을 1세대 2주택 이상 증여자가 증여하면 12% (1세대 1주택자가 배우자·직계존비속에게 증여하면 3.5%)</li>
