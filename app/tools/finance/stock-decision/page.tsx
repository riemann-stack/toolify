...
const FAQ_LD = [
  ...
  { "q":"다른 youtil 주식 도구와 어떻게 다른가요?","a":"주식 물타기 계산기는 평단·물타기 계산 / 복리 계산기는 장기 수익 시뮬 / 월배당 목표 자산은 배당주 설계 / 공모주 청약 증거금은 IPO 계산 / 본 도구는 의사결정 심리·자가진단·무작위 보조. 본 도구는 계산이 아닌 의사결정 망설임 해결에 특화되어 있습니다." }
]
