...
const FAQ_LD = [
  ...
  { "q":"취득세는 어떻게 계산되나요?","a":"주택 vs 비주택, 명의(1주택/다주택/법인), 지역(조정대상/비규제)에 따라 다릅니다. • 1주택 실거주 6억 이하: 1.1% • 1주택 9억 초과: 3.3% • 다주택 (3주택+): 12% (조정대상 동일) • 법인: 12% (명의·지역 무관) • 비주택 (오피스·상가·토지): 4.6% 본 도구는 위 매트릭스를 자동 적용합니다. 정확한 세액은 세무사 확인 권장." },
  ...
  { "q":"체납 관리비는 누가 부담하나요?","a":"낙찰자(매수인)가 부담합니다 (대법원 판례). 전 소유자가 미납한 관리비도 부동산 매각 후엔 새 소유자가 책임. 단 3년 시효 도과분은 제외. • 입찰 전 필수 조사: 관리사무소 방문 → 미납 관리비 명세서 발급 • 일반 평균: 100~500만원 (장기 빈집은 1,000만원+) • 협상 여지: 관리사무소와 분할 납부·일부 면제 협상 가능 체납 관리비를 무시하고 낙찰받으면 추후 큰 분쟁이 됩니다." },
  ...
  { "q":"1주택 vs 다주택 취득세 차이가 얼마나?","a":"매우 큽니다. 5억 아파트 기준: • 실거주 1주택 (6억 이하): 5억 × 1.1% = 약 550만원 • 다주택 (3주택+): 5억 × 12% = 약 6,000만원 • 차액: 약 5,450만원 (10배) → 다주택 보유 시 추가 매수 의사결정에 결정적 영향. 시나리오 비교 탭에서 본인 가격으로 직접 확인 가능합니다." },
  { "q":"법인 명의로 사면 유리한가요?","a":"2020년 이후 법인 부동산 매수는 매우 불리해졌습니다. • 취득세 12% 단일 (1주택 특례 X) • 종합부동산세 최고 7% (개인 0.6~3%) • 양도소득세 → 법인세 + 추가 20% 가산 • 종합소득세 합산 → 단기 매도 의도가 명확하지 않다면 개인 명의가 절대적으로 유리. 법인은 임대업·개발업·다수 부동산 운용 등 특수 목적에 한정." },
    ...
    <div style={{ maxWidth: '880px', margin: '0 auto', padding: '60px 24px 80px' }}>
      ...
      <div style={{ ...card, padding: 0, overflow: 'hidden' }}>
        <div style={{ overflowX: 'auto' }}>
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13, minWidth: 560 }}>
            ...
            <tbody>
              {[
                ['🏛️ 취득세 (지방교육·농특 포함)',  '낙찰가 1.1~12%',           '필수 / 자동 계산'],
                ['📋 인지세',                       '1억당 7만원',              '필수 / 자동'],
      ...
      <div style={card}>
        <p style={{ fontSize: 14, color: 'var(--text)', lineHeight: 1.85, marginTop: 0 }}>
          취득세는 <strong>명의 유형이 가장 큰 변수</strong>입니다. 같은 5억 아파트도 실거주는 약 550만원, 다주택은 약 6,000만원으로
          <strong style={{ color: 'var(--accent)' }}> 10배 차이</strong>가 납니다.
        </p>
        ...
        <ul style={{ paddingLeft: 18, margin: '12px 0 0', fontSize: 13, color: 'var(--muted)', lineHeight: 1.95 }}>
          ...
          <li><strong style={{ color: 'var(--text)' }}>법인</strong>: 명의·지역 무관 12% 단일</li>
          <li><strong style={{ color: 'var(--text)' }}>특례 감면</strong>: 신혼부부·생애최초·청년·다자녀 등 일부 감면 가능 (별도 신청)</li>
          <li><strong style={{ color: 'var(--text)' }}>주의</strong>: 취득세 외에 지방교육세·농어촌특별세까지 포함된 통합 세율로 표시</li>
        </ul>
      </div>
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          ...
          • 다주택 (3주택+): <strong>12%</strong> (조정대상 동일)<br />
          • 법인: <strong>12%</strong> (명의·지역 무관)<br />
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          <strong>낙찰자(매수인)가 부담</strong>합니다 (대법원 판례).
          전 소유자가 미납한 관리비도 부동산 매각 후엔 새 소유자가 책임. 단 <strong>3년 시효 도과분</strong>은 제외.<br />
          • <strong>입찰 전 필수 조사</strong>: 관리사무소 방문 → 미납 관리비 명세서 발급<br />
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          ...
          • 다주택 (3주택+): 5억 × 12% = <strong>약 6,000만원</strong><br />
          • 차액: <strong style={{ color: 'var(--accent)' }}>약 5,450만원 (10배)</strong><br />
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          ...
          • 취득세 <strong>12% 단일</strong> (1주택 특례 X)<br />
