...
const FAQ_LD = [
  { "q":"경매 부대비용은 평균 낙찰가의 몇 %인가요?","a":"일반 경매 부대비용은 낙찰가의 10~15% 수준입니다. • 5억 낙찰 → 부대비용 5,000~7,500만원 • 1주택 실거주는 5~8%, 다주택·법인은 15~20%까지 올라감 • 명도·수리·체납이 많을수록 비율 ↑ 본 도구로 본인 케이스를 추정해 입찰가 결정에 참고하세요." },
  { "q":"취득세는 어떻게 계산되나요?","a":"주택 vs 비주택, 명의(1주택/다주택/법인), 지역(조정대상/비규제)에 따라 다릅니다 (2026년 지방세법 기준). • 1주택 실거주 6억 이하: 1.1% • 1주택 9억 초과: 3.3% • 조정대상지역 2주택: 8.4% / 3주택 이상: 12.4% • 비조정지역: 2주택 1.1~3.3%(기본세율), 3주택 8.4%, 4주택 이상 12.4% • 법인: 12.4% (명의·지역 무관) • 비주택 (오피스·상가·토지): 4.6% 모두 지방교육세 포함·전용 85㎡ 이하 기준(초과 시 농어촌특별세 추가). 공시가격 1억 이하 주택(비수도권은 2억 이하, 2025.1.2. 이후 취득분)은 정비구역 안이 아니면 중과 제외되며, 도구에서 체크하면 반영됩니다. 본 도구는 위 매트릭스를 자동 적용합니다. 정확한 세액은 세무사 확인 권장." },
  ...
  { "q":"경매 LTV는 얼마까지 가능?","a":"경락잔금대출에도 일반 주택담보대출 규제가 그대로 적용됩니다(2025.10.16 시행 10·15 대책 기준). • 비규제지역: 70% (다주택자·주택임대·매매사업자 60%, 수도권은 6·27 대책 이후 다주택자 추가 구입 주담대 금지) • 규제지역(서울 전역·경기 12곳 등) 무주택자: 40% (생애최초 70%) • 규제지역 유주택자의 추가 주택 구입: 원칙적으로 0% (처분조건부 1주택은 40%) • 수도권·규제지역 주담대 금액 상한: 담보가 15억 이하 6억, 15~25억 4억, 25억 초과 2억. 여기에 DSR 40%(연소득 대비 연 원리금, 스트레스 금리 가산) 한도가 함께 적용돼 가장 작은 값이 한도가 됩니다. 규제는 자주 바뀌니 입찰 전 은행·금융위원회 최신 기준을 확인하세요." },
  { "q":"1주택 vs 다주택 취득세 차이가 얼마나?","a":"매우 큽니다. 5억 아파트 기준 (2026년 지방세법): • 실거주 1주택 (6억 이하): 5억 × 1.1% = 약 550만원 • 다주택 (조정 3주택+ 또는 비조정 4주택+): 5억 × 12.4% = 약 6,200만원 • 차액: 약 5,650만원 (약 11배) → 다주택 보유 시 추가 매수 의사결정에 결정적 영향. 시나리오 비교 탭에서 본인 가격으로 직접 확인 가능합니다." },
  { "q":"법인 명의로 사면 유리한가요?","a":"2020년 이후 법인 부동산 매수는 매우 불리해졌습니다. • 취득세 12.4% 단일 (1주택 특례 X) • 종합부동산세는 기본공제 없이 고율 단일세율 — 2주택 이하 2.7%·3주택 이상 5.0% (개인은 0.5~2.7%, 3주택 이상 중과 최대 5.0%) • 양도소득세 → 법인세 + 추가 20% 가산 • 종합소득세 합산 → 단기 매도 의도가 명확하지 않다면 대부분의 경우 개인 명의가 유리. 법인은 임대업·개발업·다수 부동산 운용 등 특수 목적에 한정." },
  { "q":"유치권·법정지상권 비용은?","a":"물건별 변동 매우 큰 리스크입니다. • 유치권: 점유자가 미수금 주장으로 인도 거부. 수백~수천만원 협상 또는 소송 필요 • 법정지상권: 토지·건물 분리 매각 시 발생. 별도 토지 임차료·매수 협상 • 변호사·법무사 자문료: 사건당 200~500만원 • 소송 시 1~3년 소요, 추가 비용 1,000만원 이상 → 입찰 전 매각물건명세서 + 등기부등본 + 현장 조사로 권리 분석 필수. 자신 없으면 유치권·법정지상권 표시 물건은 회피가 안전합니다." }
]
...
export default function AuctionPage() {
  return (
    <div style={{ maxWidth: '880px', margin: '0 auto', padding: '60px 24px 80px' }}>
      ...
      <UpdatedMeta date="2026년 9월" basis="2026년 지방세법 기준 (취득세율 제11조·중과 제13조의2) · 대출 규제는 2025.10.16 시행 10·15 대책 기준" sources={[{"label":"위택스","href":"https://www.wetax.go.kr"},{"label":"행정안전부","href":"https://www.mois.go.kr"},{"label":"금융위원회 (대출 규제)","href":"https://www.fsc.go.kr"}]} />
      ...
      <div style={card}>
        ...
        <div style={{ background: 'var(--bg3)', borderRadius: 10, padding: '14px 16px', marginTop: 12, overflowX: 'auto' }}>
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13, minWidth: 480 }}>
            ...
            <tbody>
              {[
                ['6억 이하', '1.1%',       '8.4% (비조정 1.1%)',     '12.4%'],
                ['6~9억',    '1.1~3.3%',   '8.4% (비조정 1.1~3.3%)', '12.4%'],
                ['9억 초과', '3.3%',       '8.4% (비조정 3.3%)',     '12.4%'],
              ].map((row, i) => (
                <tr key={i}>
                  {row.map((cell, j) => (
                    <td key={j} style={{
        ...
        <ul style={{ paddingLeft: 18, margin: '12px 0 0', fontSize: 13, color: 'var(--muted)', lineHeight: 1.95 }}>
          <li><strong style={{ color: 'var(--text)' }}>비조정대상지역</strong>: 2주택은 기본세율(1.1~3.3%), 3주택 8.4%, 4주택 이상 12.4% (지방세법 제13조의2)</li>
          <li><strong style={{ color: 'var(--text)' }}>저가주택 중과 제외</strong>: 공시가격(시가표준액) 1억 원 이하 주택은 정비구역 안이 아니면 중과세율 적용 제외(지방세법 시행령 제28조의2). 비수도권은 2025.1.2. 이후 취득분부터 2억 원 이하로 기준이 넓어졌습니다. 계산기에서 체크하면 표준세율로 계산합니다</li>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginTop: 12 }}>
          ...
          <div style={{ background: 'var(--bg3)', borderRadius: 10, padding: '14px 16px' }}>
            ...
            <p style={{ fontSize: 12, color: 'var(--muted)', lineHeight: 1.8, margin: 0 }}>
              ...
              기존 대출 + 신규 대출 합산, 심사 금리에 스트레스 금리 가산.
            </p>
          </div>
        </div>
        <p style={{ marginTop: 12, fontSize: 12, color: 'var(--muted)', lineHeight: 1.7 }}>
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          ...
          본 도구로 본인 케이스를 추정해 입찰가 결정에 참고하세요.
        </p>
      </details>
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          <strong>주택 vs 비주택, 명의(1주택/다주택/법인), 지역(조정대상/비규제)</strong>에 따라 다릅니다 (2026년 지방세법 기준).<br />
          • 1주택 실거주 6억 이하: <strong>1.1%</strong><br />
          • 1주택 9억 초과: <strong>3.3%</strong><br />
          • 조정대상지역 2주택: <strong>8.4%</strong> / 3주택 이상: <strong>12.4%</strong><br />
          • 비조정지역: 2주택 <strong>1.1~3.3%</strong>(기본세율), 3주택 <strong>8.4%</strong>, 4주택 이상 <strong>12.4%</strong><br />
          • 법인: <strong>12.4%</strong> (명의·지역 무관)<br />
          • 비주택 (오피스·상가·토지): <strong>4.6%</strong><br />
          위 세율은 취득세 + 지방교육세 통합 기준(전용 85㎡ 이하). 85㎡ 초과 주택은 농어촌특별세가 추가됩니다.
          공시가격 1억 이하 주택(비수도권은 2억 이하, 2025.1.2. 이후 취득분)은 정비구역 안이 아니면 중과 제외. 정확한 세액은 세무사 확인 권장.
        </p>
      </details>
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          경락잔금대출에도 일반 주택담보대출 규제가 그대로 적용됩니다(2025.10.16 시행 10·15 대책 기준).<br />
          • <strong>비규제지역</strong>: <strong>70%</strong> (다주택자·주택임대·매매사업자 60%, 수도권은 6·27 대책 이후 다주택자 추가 구입 주담대 금지)<br />
          • <strong>규제지역(서울 전역·경기 12곳 등) 무주택자</strong>: <strong>40%</strong> (생애최초 70%)<br />
          • <strong>규제지역 유주택자의 추가 주택 구입</strong>: 원칙적으로 <strong>0%</strong> (처분조건부 1주택은 40%)<br />
          • <strong>수도권·규제지역 금액 상한</strong>: 담보가 15억 이하 6억, 15~25억 4억, 25억 초과 2억<br />
          여기에 <strong>DSR 40%</strong>(연소득 대비 연 원리금, 스트레스 금리 가산) 한도가 함께 적용돼 가장 작은 값이 한도가 됩니다.
          규제는 자주 바뀌니 입찰 전 은행·금융위원회 최신 기준을 확인하세요.
        </p>
      </details>
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          매우 큽니다. <strong>5억 아파트 기준</strong> (2026년 지방세법):<br />
          • 실거주 1주택 (6억 이하): 5억 × 1.1% = <strong>약 550만원</strong><br />
          • 다주택 (조정 3주택+ 또는 비조정 4주택+): 5억 × 12.4% = <strong>약 6,200만원</strong><br />
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          ...
          • 종합부동산세 — 기본공제 없이 고율 단일세율 <strong>2주택 이하 2.7%·3주택 이상 5.0%</strong> (개인 0.5~2.7%, 3주택 이상 중과 최대 5.0%)<br />
          • 양도소득세 → <strong>법인세 + 추가 20% 가산</strong><br />
          • 종합소득세 합산<br />
          → 단기 매도 의도가 명확하지 않다면 <strong>대부분의 경우 개인 명의가 유리</strong>.
