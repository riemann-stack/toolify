...
const FAQ_LD = [
  ...
  { "q":"경매 LTV는 얼마까지 가능?","a":"일반 매매와 동일한 LTV가 적용됩니다. • 비규제지역 + 1주택: 70% (가장 유리) • 규제지역(조정대상지역 등) + 1주택: 50% • 다주택자: 30% 이하 또는 대출 불가 또한 DSR 40%(연소득 대비 연 원리금) 한도가 동시 적용. 둘 중 작은 값 적용. 정확한 한도는 은행·금감원 최신 가이드라인 확인." },
    ...
    <div style={{ maxWidth: '880px', margin: '0 auto', padding: '60px 24px 80px' }}>
      ...
      <div style={card}>
        ...
        <ul style={{ paddingLeft: 18, margin: '12px 0 0', fontSize: 13, color: 'var(--muted)', lineHeight: 1.95 }}>
          ...
          <li><strong style={{ color: 'var(--text)' }}>지방 저가주택 중과 제외</strong>: 지방(비수도권) 공시가격 2억 원 이하 주택은 중과세율 적용 제외 + 주택 수 산정 제외 (2025.1.2. 이후 취득분, 행정안전부 지방세법 시행령 개정 · 2025.4.)</li>
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          ...
          지방(비수도권) 공시가격 2억 이하 주택은 중과 제외(2025.1.2. 이후 취득분). 정확한 세액은 세무사 확인 권장.
        </p>
      </details>
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          ...
          • <strong>규제지역(조정대상지역 등) + 1주택</strong>: <strong>50%</strong><br />
