        ...
        <section>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
            {[
              ...
              {
                q: '1960년 짜장면이 25환이었는데 환산하면 왜 25,000원이 안 나오나요?',
                a: '본 도구는 <strong>전체 소비자물가</strong> 기준 환산입니다. 짜장면 같은 외식비는 1960년 이후 평균 CPI보다 훨씬 빠르게 올랐어요(노동력·임대료·식자재 인플레이션이 외식에 집중). 또한 1960년 짜장면이 정확히 얼마였는지 자료마다 차이가 있습니다(20~50환 범위). 시대별 가격 비교 카드에서 "실질 +X%"는 <strong>실질가격 변동률</strong>을 보여주며, 양수면 CPI보다 더 빠르게 올랐다는 뜻입니다.',
              },
              {
                q: '1950년 월급이 만원(圓)이었는데 지금 얼마예요?',
                a: '1만 圓(1950) = 100환(1953) = 10원(현재 단위). 거기에 1950~2026년 누적 인플레이션을 곱하면 <strong>현재 가치 약 수십만 원 수준</strong>이 나옵니다. 1950년은 전쟁 발발 직후로 초인플레이션 시기였고, 그 시기의 명목 임금은 실질 구매력이 매우 낮았다는 점을 감안하면 합당한 수치예요. 1960년대 이후 한국의 실질 임금이 폭발적으로 성장했다는 걸 보여주는 사례.',
              },
              {
                q: '집값은 왜 일반 CPI보다 훨씬 많이 올랐나요?',
                a: 'CPI 바스켓에서 주거 비용은 <strong>월세·전세 환산값</strong>으로 들어가며 실제 매매가의 변동을 그대로 반영하지 않습니다. 한국은 1990년대 이후 자산가격 상승률이 일반 물가 상승률을 크게 앞질러, 평균 CPI로 환산한 1980년 1천만원은 2024년 약 1억 안팎이지만 실제 서울 아파트 가격은 같은 기간 100배 이상 올랐어요. 자산 인플레이션과 소비자 인플레이션은 서로 다른 현상입니다.',
              },
              {
                q: '제3차 화폐개혁이 있을까요?',
