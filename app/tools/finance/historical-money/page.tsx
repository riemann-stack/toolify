...
const FAQ_LD = [
              ...
              },
              {
                ...
                a: 'CPI 바스켓에서 주거 비용은 <strong>월세·전세 환산값</strong>으로 들어가며 실제 매매가의 변동을 그대로 반영하지 않습니다. 한국은 1990년대 이후 자산가격 상승률이 일반 물가 상승률을 크게 앞질러, 평균 CPI로 환산한 1980년 1천만원은 2024년 약 5,000만원이지만 실제 서울 아파트 가격은 같은 기간 100배 이상 올랐어요. 자산 인플레이션과 소비자 인플레이션은 서로 다른 현상입니다.',
              },
              {
                q: '제3차 화폐개혁이 있을까요?',
