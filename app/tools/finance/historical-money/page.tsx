...
const FAQ_LD = [
              ...
              },
              {
                ...
                a: '본 도구는 <strong>전체 소비자물가</strong> 기준 환산입니다. 250환(1960)은 화폐개혁 단위로 25원(현재 단위)이고, 누적 물가를 곱하면 현재 가치 약 2,500원 수준이에요. 그런데 실제 짜장면은 약 7,000원이죠 — 외식비가 평균 CPI보다 훨씬 빠르게 올랐기 때문(노동력·임대료·식자재 인플레이션이 외식에 집중). 또한 1960년 짜장면 가격은 자료마다 차이가 큽니다(150~250환 범위). 시대별 가격 비교 카드의 "실질 +X%"는 <strong>실질가격 변동률</strong>을 보여주며, 양수면 CPI보다 더 빠르게 올랐다는 뜻입니다.',
              },
              {
                q: '1950년 월급이 만원(圓)이었는데 지금 얼마예요?',
                a: '1만 圓(1950) = 100환(1953) = 10원(현재 단위). 거기에 1950~2026년 누적 물가를 곱하면 <strong>현재 가치 약 7만 원 수준</strong>이 나옵니다. 그만큼 1950년 명목 화폐의 실질 구매력이 낮았다는 뜻이에요. 1950년은 전쟁 발발 직후 초인플레이션 시기라 추정 오차가 특히 크지만, 1960년대 이후 한국의 실질 임금이 폭발적으로 성장했다는 걸 보여주는 사례입니다.',
              },
              {
                q: '집값은 왜 일반 CPI보다 훨씬 많이 올랐나요?',
                a: 'CPI 바스켓에서 주거 비용은 <strong>월세·전세 환산값</strong>으로 들어가며 실제 매매가의 변동을 그대로 반영하지 않습니다. 한국은 1990년대 이후 자산가격 상승률이 일반 물가 상승률을 크게 앞질러, 평균 CPI로 환산한 1980년 1천만원은 현재 가치로 약 5,700만원 수준(본 도구로 확인 가능)이지만 실제 서울 아파트 가격은 같은 기간 100배 이상 올랐어요. 자산 인플레이션과 소비자 인플레이션은 서로 다른 현상입니다.',
              },
              {
                q: '제3차 화폐개혁이 있을까요?',
...
export default function HistoricalMoneyPage() {
  return (
    <div style={{ maxWidth: '880px', margin: '0 auto', padding: '60px 24px 80px' }}>
      ...
      <UpdatedMeta date="2026년 9월" basis="통계청 소비자물가지수(CPI, 2020=100) 기반 · 1965~2025년 연도별 공식 통계, 이전은 추정치 · 2026년 물가 추정(전년 대비 +2%)" sources={[{"label":"통계청 KOSIS","href":"https://kosis.kr"},{"label":"한국은행 경제통계시스템","href":"https://ecos.bok.or.kr"}]} />
