/* ──────────────────────────────────────────────────────
   ...
   ──────────────────────────────────────────────────────
   CPI 데이터: 통계청 소비자물가지수(2020=100). 1965~2025는 연도별 공식 통계(보간 없음),
   2026은 추정, 1945~1964는 한국은행·역사 자료 기반 추정치.
   ────────────────────────────────────────────────────── */
...
// ─── CPI 시계열 (2020=100 기준) ─────────────────────────────
/** 한국 소비자물가지수 (Consumer Price Index, 2020=100)
 *  · 1965~2025: 통계청 연간 소비자물가 상승률(공표치, 소수 첫째 자리)을 2020=100에서 연도별로 누적 역산.
 *    2021~2025는 연간 지수 공표치(2025 = 116.61, 통계청 연간 소비자물가 동향).
 *    연간 상승률 반올림 탓에 KOSIS 지수(DT_1J22003)와 소수 둘째 자리 정도 차이가 날 수 있다 — 매년 1월 KOSIS 값으로 갱신.
 *  · 2026: 추정 (전년 대비 +2% 가정)
 *  · 1945~1964: 한국은행·역사 자료 기반 추정치 (1965년 공식 값에 이어지도록 조정) — 사이 연도는 선형 보간 */
const CPI_KEY: [number, number][] = [
  [1945, 0.00087], // 해방 직후 (추정)
  [1948, 0.00543],
  [1950, 0.01628], // 한국전쟁 발발
  [1952, 0.05427], // 1차 화폐개혁 직전
  [1955, 0.326],   // 환 시기 초기
  [1958, 0.705],
  [1961, 1.411],
  [1962, 1.628],   // 2차 화폐개혁
  // ↓ 1965년부터 통계청 공식 시계열 (연도별, 보간 없음)
  [1965, 2.60], [1966, 2.90], [1967, 3.22], [1968, 3.56], [1969, 4.00],
  [1970, 4.64], [1971, 5.27], [1972, 5.89], [1973, 6.08], [1974, 7.55],
  [1975, 9.46], [1976, 10.91], [1977, 12.02], [1978, 13.76], [1979, 16.28],
  [1980, 20.95], [1981, 25.43], [1982, 27.26], [1983, 28.19], [1984, 28.83],
  [1985, 29.56], [1986, 30.38], [1987, 31.29], [1988, 33.52], [1989, 35.43],
  [1990, 38.47], [1991, 42.05], [1992, 44.66], [1993, 46.80], [1994, 49.75],
  [1995, 51.99], [1996, 54.54], [1997, 56.94], [1998, 61.21], [1999, 61.70],
  [2000, 63.12], [2001, 65.70], [2002, 67.54], [2003, 69.91], [2004, 72.42],
  [2005, 74.45], [2006, 76.09], [2007, 77.99], [2008, 81.66], [2009, 83.94],
  [2010, 86.38], [2011, 89.83], [2012, 91.81], [2013, 93.00], [2014, 94.21],
  [2015, 94.87], [2016, 95.82], [2017, 97.64], [2018, 99.11], [2019, 99.50],
  [2020, 100.00], [2021, 102.50], [2022, 107.72], [2023, 111.59], [2024, 114.18],
  [2025, 116.61],
  [2026, 118.94],  // 추정 (전년 대비 +2%)
]
...
export const PRICE_ITEMS: PriceItem[] = [
  { emoji: '🍜', name: '짜장면 한 그릇',
    prices: { 1960: 250, 1970: 80, 1980: 350, 1990: 1500, 2000: 3500, 2010: 4500, 2020: 5500, 2024: 7000 },
    note: '한국인의 대표 외식 메뉴 (1960년은 환 단위)' },
  { emoji: '🍶', name: '소주 한 병',
  ...
  { emoji: '🍙', name: '신라면 한 봉',
    ...
    note: '1986년 출시' },
  { emoji: '☕', name: '다방·카페 커피 한 잔',
    prices: { 1980: 300, 1990: 500, 2000: 1500, 2010: 3500, 2020: 4500, 2024: 5000 } },
  { emoji: '🎬', name: '영화 티켓 1매',
    prices: { 1960: 1000, 1970: 250, 1980: 1500, 1990: 4500, 2000: 7000, 2010: 8000, 2020: 13000, 2024: 15000 } },
