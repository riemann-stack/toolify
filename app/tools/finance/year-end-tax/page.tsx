    ...
    <div style={{ maxWidth: '880px', margin: '0 auto', padding: '60px 24px 80px' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '48px' }}>
        ...
        <section>
          ...
          <p style={{ ...para, marginBottom: 0 }}>
            한편 <strong style={strong}>표준세액공제 13만원</strong>은 건강·고용보험료 소득공제와 의료비·교육비·기부금·월세 등 특별·월세 세액공제를 하나도 받지 않을 때만 적용되는 택일 항목입니다. 급여가 낮고 공제할 항목이 거의 없는 사회초년생은 표준 13만원이 유리한 경우가 많으니, 굳이 영수증을 모으기보다 연금계좌처럼 효과 큰 공제에 집중하는 편이 낫습니다.
          </p>
        </section>
