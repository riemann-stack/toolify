...
const tdNum: React.CSSProperties = { ...td, color: 'var(--accent-ink)', fontFamily: 'var(--font-sans)', fontWeight: 700 }
    ...
    <ToolPage width={880} slug="/tools/finance/capital-gains-tax">
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '48px' }}>
        ...
        <div>
          ...
          <p style={para}>
            보유기간이 짧으면 세율이 크게 올라갑니다. 주택·조합원입주권을 <strong style={strong}>1년 미만</strong> 보유 후 팔면 <strong style={strong}>70%</strong>, <strong style={strong}>1년 이상 2년 미만</strong>이면 <strong style={strong}>60%</strong>가 적용됩니다. 분양권은 1년 미만 70%, 1년 이상이면 기간과 관계없이 60%입니다. 주택·입주권은 만 2년 이상 보유해야 아래 6~45% 기본 누진세율로 과세되고 비과세 자격이 생기며, 장기보유특별공제는 보유 3년부터(거주분 특례는 거주 2년부터) 의미가 있습니다.
          </p>
          <div style={tableWrap}>
            <table style={table}>
              <thead>
              ...
              <tbody>
                {[
                  ...
                  <tr key={i} style={{ background: i % 2 === 0 ? 'transparent' : 'var(--bg2)' }}>
                    ...
                    <td style={{ ...td, fontFamily: 'var(--font-sans)' }}>{r.d}</td>
                  </tr>
                ))}
              </tbody>
            </table>
