...
const FAQ_LD = [
              {
                ...
                a: '2026년에는 <strong>국민연금이 9%에서 9.5%로 0.5%p 인상</strong>되어 1998년 이후 28년 만의 큰 변화가 있었습니다(2033년 13%까지 매년 0.5%p 단계 인상). 건강보험은 7.09%에서 7.19%로 0.1%p, 장기요양보험도 0.9182%에서 0.9448%로 인상되었습니다. 고용보험은 1.8%로 동결되었으며, 산재보험은 업종별로 12월 말 고시됩니다. 월급 300만원(비과세 제외) 기준 근로자 부담은 약 9,400원 증가합니다(국민연금 +7,500 등 · 비과세 20만원이면 약 8,800원).',
              },
              {
        ...
        <div>
          ...
          <div>
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px' }}>
              <thead>
                <tr style={{ borderBottom: '1px solid var(--border)' }}>
                  <th scope="col" style={{ padding: '10px 12px', textAlign: 'left', color: 'var(--muted)', fontWeight: 500, fontSize: '12px' }}>항목</th>
                  <th scope="col" style={{ padding: '10px 12px', textAlign: 'right', color: 'var(--muted)', fontWeight: 500, fontSize: '12px' }}>금액</th>
                </tr>
              </thead>
              <tbody>
                {[
