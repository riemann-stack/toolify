...
const FAQ_LD = [
  ...
  { q: '단순경비율과 장부 작성, 어느 게 유리한가요?', a: '<strong style="color:var(--text)">실제 경비가 단순경비율보다 크면 장부, 적으면 단순경비율</strong>이 유리합니다. 예: IT 개발자 매출 5천만원 → 단순경비율 64.1%로 3,205만 경비 자동 인정. 실제로 사무실·장비·소프트웨어에 4천만 썼다면 장부 작성이 800만 차이만큼 유리합니다. 다만 장부 작성에는 <strong style="color:var(--text)">증빙(영수증·세금계산서·신용카드)</strong> 보관과 매출·경비 기록 의무가 있습니다. 매출 7,500만(인적용역 기준) 이상이면 단순경비율 적용 자체가 불가능하니 장부가 필수입니다.' },
            ...
            <table style={dedTable}>
              ...
              <tbody>
                {[
                  ...
                  ['노란우산공제',     '200~500만',   '한계세율만큼 절세 (소기업·소상공인 전용)'],
