      ...
      <div style={{ marginTop: '64px', borderTop: '1px solid var(--border)', paddingTop: '40px', display: 'flex', flexDirection: 'column', gap: '48px' }}>
        ...
        <section>
          ...
          <div style={{ overflowX: 'auto' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px' }}>
              <thead>
                <tr style={{ borderBottom: '1px solid var(--border)' }}>
                  <th style={{ padding: '10px 12px', textAlign: 'left', color: 'var(--muted)', fontWeight: 500 }}>대출 종류</th>
                  <th style={{ padding: '10px 12px', textAlign: 'center', color: 'var(--accent)', fontWeight: 700 }}>평균</th>
                  <th style={{ padding: '10px 12px', textAlign: 'center', color: 'var(--muted)', fontWeight: 500 }}>최저~최고</th>
                </tr>
              </thead>
              <tbody>
                {[
                  ...
                  <tr key={i} style={{ borderBottom: '1px solid var(--border)', background: i % 2 === 0 ? 'transparent' : 'var(--bg2)' }}>
                    ...
                    <td style={{ padding: '10px 12px', textAlign: 'center', color: 'var(--accent)', fontFamily: 'Syne, sans-serif', fontWeight: 800 }}>{row[1]}</td>
                    <td style={{ padding: '10px 12px', textAlign: 'center', color: 'var(--muted)', fontFamily: 'Syne, sans-serif' }}>{row[2]}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <section>
          ...
          <div style={{ background: 'var(--bg2)', border: '1px solid rgba(62,200,255,0.30)', borderRadius: 12, padding: '14px 18px' }}>
            <p style={{ fontFamily: 'Syne, sans-serif', fontSize: 16, fontWeight: 800, color: '#3EC8FF', marginBottom: 8 }}>
              📌 예시 — 잔액 2.5억, 5% → 4% 갈아타기
            </p>
        ...
        <section>
          ...
          <div style={{ background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 12, padding: '14px 18px' }}>
            <p style={{ fontSize: '13.5px', fontWeight: 700, color: 'var(--accent)', marginBottom: '6px' }}>💡 대비 방법</p>
        ...
        <section>
          <div style={{ background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 12, padding: '16px 20px' }}>
            ...
            <p style={{ fontSize: '12.5px', color: 'var(--muted)', lineHeight: 1.85, marginBottom: '6px' }}>
              본 대출이자 계산기는 <strong style={{ color: 'var(--text)' }}>표준 공식 기반 추정 도구</strong>입니다. 금융 자문·승인 도구가 아닙니다.
            </p>
            <p style={{ fontSize: '12.5px', color: 'var(--muted)', lineHeight: 1.85, marginBottom: '6px' }}>
              <strong style={{ color: 'var(--text)' }}>본 도구의 한계</strong> — 실제 대출 가능 여부는 신용·소득·LTV·DSR에 따라 다름 / 상환액·이자는 원 단위 절사·절상으로 ±1% 차이 가능 / 중도상환수수료·취급수수료는 은행·상품별 차이 / DSR·LTV 규제는 정책 변경 시 변동 / 변동금리는 기준금리·가산금리 변화 따라 갱신.
            </p>
            <p style={{ fontSize: '12.5px', color: 'var(--muted)', lineHeight: 1.85 }}>
              정확한 상품·조건은 — 본인 거래 은행 상담 / 한국주택금융공사(HF·주담대) / 한국 금융감독원 e-금융민원센터 <strong style={{ color: 'var(--text)' }}>1332</strong> / 채무 상담 한국 신용회복위원회 <strong style={{ color: 'var(--text)' }}>1397</strong>.
            </p>
          </div>
        </section>
