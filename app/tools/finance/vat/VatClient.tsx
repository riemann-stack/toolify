              ...
              <table className={styles.quoteTable}>
                ...
                <tbody>
                  {quoteResult.items.map((it, i) => (
                    <tr key={i}>
                      <td>{it.name || '(품목명 없음)'}{!it.isTaxable && <span style={{ marginLeft: 6, fontSize: 11, color: 'var(--cyan-600)' }}>면세</span>}</td>
                      <td>{it.quantity}</td>
            ...
            <>
              <div className={styles.compareGrid}>
                ...
                <div className={`${styles.compareCard} ${styles.compareCardLoser}`}>
                  ...
                  <p className={styles.compareCardMain} style={{ color: 'var(--red-600)' }}>
          ...
          {netResult && (
            <>
              ...
              <div className={styles.infoBox}>
                ...
                <strong style={{ color: 'var(--cyan-600)' }}>3.3% 원천세</strong>는 사업자 등록 X 프리랜서에게 발주처가 차감 후 입금 (종합소득세 신고 시 정산).
                <strong style={{ color: 'var(--orange-600)' }}>10% 부가세</strong>는 사업자 등록자에게 별도 청구되는 본인 돈이 아닌 신고·납부 의무 금액 (분기별·반기별 신고).
              </div>
            </>
          )}
        </>
            ...
            <>
              ...
              <div className={styles.gsCompareGrid}>
                ...
                <div className={`${styles.gsCard} ${gsResult.tone === 'simplified' ? styles.gsCardWinner : ''} ${gsResult.tone === 'unavailable' ? styles.gsCardDisabled : ''}`}>
                  ...
                  <p className={styles.compareCardMain} style={{ color: gsResult.tone === 'unavailable' ? 'var(--muted)' : 'var(--purple-600)' }}>
