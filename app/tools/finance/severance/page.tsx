...
const FAQ_LD = [
  ...
  { "q":"1년 미만 근무하면 퇴직금이 0인가요?","a":"네, 법정 퇴직금은 0입니다 (근로자퇴직급여보장법 §4). 단: • 회사 자율 지급: 일부 회사는 1년 미만에도 자체 규정으로 지급 • 중도 정산: 1년 직전에 무리하게 퇴사하면 퇴직금 0 위험 • 퇴직금 분쟁: 365일이 며칠 부족하면 입사·퇴사일 정확 확인 + 노무사 상담 본 도구의 시뮬레이터 탭에서 1년 도달까지 며칠 남았는지 확인 가능." },
