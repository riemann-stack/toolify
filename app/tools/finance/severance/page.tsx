...
const FAQ_LD = [
  ...
  { "q":"퇴직소득세가 일반 소득세보다 적은 이유?","a":"여러 해 누적된 소득을 한 번에 받기 때문에 누진세 부담을 덜어주는 특별 계산법이 적용됩니다. • 근속연수공제: 1년당 100~300만원 공제 • 환산급여 ×12/N: 12배 환산 후 누진세율 적용 → 원금 ÷N 다시 분배 • 환산급여공제: 추가 공제 (60~100% 구간) 예: 5년 근속 5,000만원 퇴직금 → 일반 소득세는 1,000만원+, 퇴직소득세는 약 100~200만원 수준 (5~10배 적음)." },
  ...
  { "q":"IRP 의무이전 5,500만원 기준?","a":"퇴직급여 보장법 §17: 퇴직금이 5,500만원을 초과하면 IRP(개인형 퇴직연금) 계좌로 의무 이전. • IRP로 받으면 퇴직소득세 이연 (수령 시 과세) • 일시 인출 시 일반 퇴직소득세 즉시 부과 • 연금 수령 시 30~40% 추가 절세 (연금소득세 적용) IRP 계좌는 미리 개설 (은행·증권사·보험사). 퇴사 전 인사팀에 IRP 정보 제출." },
  { "q":"퇴사일을 며칠 늦추면 얼마나 차이?","a":"매우 차이 큽니다. 특히 1년·2년·3년 마일스톤 직후가 가장 유리: • 5월 30일 (재직 729일) → 6월 1일 (731일): 단 2일 차이 + 마일스톤 도달 시 퇴직금 약 2~5% 증가 가능 • 1년 미달 → 1년 이상: 0원 → 약 1개월치 (월급의 1배 이상) 발생 • 호봉·연차 인상 직전·직후: 평균임금 자체가 변해 퇴직금 영향 시뮬레이터 탭에서 ±90일 슬라이더로 정확히 비교하세요." },
