...
const FAQ_LD = [
  { "q":"퇴직금은 누구나 받을 수 있나요?","a":"두 가지 조건 모두 충족해야 법정 퇴직금이 발생합니다: 1. 계속근로기간 1년 이상 (수습·시용 기간 포함) 2. 4주 평균 1주 소정근로시간 15시간 이상 1년 미만이거나 주 15시간 미만이면 법정 퇴직금 의무 X (회사가 자율적으로 지급할 수는 있음). 정규직·계약직·파트타임 모두 위 조건만 충족하면 동일하게 적용됩니다." },
  { "q":"평균임금과 통상임금 차이는?","a":"• 평균임금: 퇴사 전 3개월 임금 총액 / 총일수. 상여금·연차수당까지 포함해 일반적으로 더 큼. • 통상임금: 정기·일률·고정 지급분. 기본급+고정수당만 (상여금 X). 근로기준법 §2 ②: 평균임금이 통상임금보다 적으면 통상임금을 평균임금으로 봄 — 근로자에게 유리한 큰 금액 적용. 본 도구는 두 임금을 자동 계산해 큰 쪽을 적용합니다." },
  { "q":"상여금·연차수당이 평균임금에 포함되나요?","a":"네, 다음 비율로 평균임금에 포함됩니다: • 최근 1년 상여금 총액 × 3/12 = 3개월분 상당 • 미사용 연차수당 × 3/12 = 3개월분 상당 예: 상여금 1년 600만원 → 평균임금 산정 시 150만원 가산 / 연차수당 100만원 → 25만원 가산. 단 일시적·우발적 수당(특별보너스·상여금 외 명목)은 제외될 수 있어요." },
  { "q":"1일 통상임금 계산은 왜 209시간으로 나누나요?","a":"월 평균 근무시간 = 209시간이라는 한국 노동법상 표준 때문입니다. • 주 40시간 + 주휴 8시간 = 주 48시간 • 월 4.345주 × 48시간 ≈ 209시간/월 • 1일 통상임금 = 월 통상임금 / 209 × 1일 소정시간 (8시간이면 ÷ 209 × 8) 시급제·일급제는 다른 공식 적용. 정확한 시급·연봉 환산은 연봉 실수령액 계산기 참고." },
  { "q":"퇴직소득세가 일반 소득세보다 적은 이유?","a":"여러 해 누적된 소득을 한 번에 받기 때문에 누진세 부담을 덜어주는 특별 계산법이 적용됩니다. • 근속연수공제: 1년당 100~300만원 공제 • 환산급여 ×12/N: 12배 환산 후 누진세율 적용 → 원금 ÷N 다시 분배 • 환산급여공제: 추가 공제 (35~100% 구간) 예: 5년 근속 5,000만원 퇴직금 → 퇴직소득세는 약 230만원(실효세율 약 4.7%) 수준으로, 같은 금액을 일반 소득으로 한 번에 과세하는 것보다 훨씬 적습니다." },
  { "q":"1년 미만 근무하면 퇴직금이 0인가요?","a":"네, 법정 퇴직금은 0입니다 (근로자퇴직급여보장법 §4). 단: • 회사 자율 지급: 일부 회사는 1년 미만에도 자체 규정으로 지급 • 중도 정산: 1년 직전에 무리하게 퇴사하면 퇴직금 0 위험 • 퇴직금 분쟁: 1년에 며칠 모자라면 입사·퇴사일 정확 확인 + 노무사 상담 (1년은 입사일 1년 뒤 같은 날짜의 전날까지 근무해야 채워지며, 2월 29일이 낀 해는 366일) 본 도구의 시뮬레이터 탭에서 1년 도달까지 며칠 남았는지 확인 가능." },
  { "q":"DB와 DC 퇴직연금 차이는?","a":"• DB형 (확정급여형): 법정 퇴직금과 동일 계산 (평균임금 × 30 × 근속/365). 회사가 적립·운용·결과 책임. → 안정적, 임금 인상 시 퇴직금 증가 • DC형 (확정기여형): 회사가 매년 임금총액의 1/12 이상을 근로자 IRP 계좌에 적립. 근로자가 운용. → 운용 잘하면 더 많이 받지만 손실 위험도 본인 부담 최근 신규 입사자는 DC형이 일반적. 본인이 어떤 제도인지는 회사 인사팀에서 확인." },
  { "q":"IRP 의무이전 기준은?","a":"근로자퇴직급여보장법(2022.4.14 시행): 퇴직급여가 300만원을 초과하고 55세 미만이면 IRP(개인형 퇴직연금) 계좌로 의무 이전. 300만원 이하·55세 이후 퇴직·사망·외국인 출국 등은 예외(현금 수령 가능). • IRP로 받으면 퇴직소득세 이연 (수령 시 과세) • 일시 인출 시 일반 퇴직소득세 즉시 부과 • 연금 수령 시 30~40% 추가 절세 (연금소득세 적용) IRP 계좌는 미리 개설 (은행·증권사·보험사). 퇴사 전 인사팀에 IRP 정보 제출." },
  { "q":"퇴사일을 며칠 늦추면 얼마나 차이?","a":"가장 큰 분기점은 '1년'입니다. • 1년 미달 → 1년 이상: 0원 → 약 1개월치(월급의 1배 이상) 발생 — 유일한 절벽 • 1년 이후: 퇴직금은 근속일수에 정확히 비례해 하루하루 조금씩 증가 (2·3·5년에 특별한 점프 없음 — 마일스톤은 참고 시점) • 호봉·연차 인상으로 평균임금이 오르는 직전·직후엔 퇴직금도 함께 변동 시뮬레이터 탭에서 ±90일 슬라이더로 일자별 변화를 비교하세요." },
  { "q":"분쟁 시 어디에 상담하나요?","a":"• 고용노동부 고객상담센터: ☎ 1350 (무료, 평일 9~18시) • 고용노동부 민원마당: minwon.moel.go.kr — 임금체불·퇴직금 미지급 신고 • 공인노무사: 평균임금·통상임금 다툼, 분쟁 시 위임 (수임료 협의) • 법률구조공단: ☎ 132 — 무료 법률 상담 • 회사가 퇴직금을 14일 내 지급하지 않으면 미지급 + 연 20% 지연이자 발생 (근퇴법 §9)." }
]
    ...
    <ToolPage width={880} slug="/tools/finance/severance">
      ...
      <div style={card}>
        ...
        <p style={{ marginTop: 12, fontSize: 12, color: 'var(--muted)', lineHeight: 1.7 }}>
          ...
          유일한 절벽은 <strong>1년</strong>(미만이면 0원)이고, 이후엔 근속일수에 비례해 꾸준히 증가합니다. 2·3·5년 마일스톤은 참고용 시점일 뿐 별도 점프는 없습니다.
        </p>
      </div>
      ...
      <div style={card}>
        ...
        <ul style={{ paddingLeft: 18, margin: '12px 0 0', fontSize: 13, color: 'var(--muted)', lineHeight: 1.95 }}>
          ...
          <li><strong style={{ color: 'var(--text)' }}>환산급여공제</strong>: 800만 이하 100% / 7,000만 이하 60% / 1억 이하 55% / 3억 이하 45% / 그 이상 35%</li>
          <li><strong style={{ color: 'var(--text)' }}>지방소득세</strong>: 퇴직소득세의 10% 자동 가산</li>
          <li>근속연수는 입사일~퇴사일의 만 연수로 세고, 1년 미만 남는 기간은 <strong>1년으로 절상</strong>해 세액 계산 (소득세법 §48·시행령 §105)</li>
        </ul>
      </div>
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          ...
          • <strong>환산급여공제</strong>: 추가 공제 (35~100% 구간)<br />
          예: 5년 근속 5,000만원 퇴직금 → 퇴직소득세는 <strong>약 230만원</strong>(실효세율 약 4.7%) 수준으로, 같은 금액을 일반 소득으로 한 번에 과세하는 것보다 훨씬 적습니다.
        </p>
      </details>
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          ...
          • <strong>퇴직금 분쟁</strong>: 1년에 며칠 모자라면 입사·퇴사일 정확 확인 + 노무사 상담 (2월 29일이 낀 해는 366일째에 1년 충족)<br />
      ...
      <details style={faqDetails}>
        <summary style={faqSummary}>Q8. IRP 의무이전 기준은?</summary>
        <p style={faqAnswer}>
          근로자퇴직급여보장법(2022.4.14 시행): <strong>퇴직급여가 300만원을 초과하고 55세 미만이면 IRP(개인형 퇴직연금) 계좌로 의무 이전</strong>.<br />
          • 300만원 이하·55세 이후 퇴직·사망·외국인 출국 등은 <strong>예외</strong>(현금 수령 가능)<br />
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          가장 큰 분기점은 <strong>1년</strong>입니다:<br />
          • <strong>1년 미달 → 1년 이상</strong>: 0원 → 약 1개월치(월급의 1배 이상) 발생 — <strong>유일한 절벽</strong><br />
          • <strong>1년 이후</strong>: 퇴직금은 근속일수에 정확히 비례해 하루하루 조금씩 증가 (2·3·5년에 특별한 점프 없음 — 마일스톤은 참고 시점)<br />
          • <strong>호봉·연차 인상</strong>으로 평균임금이 오르는 직전·직후엔 퇴직금도 함께 변동<br />
          시뮬레이터 탭에서 ±90일 슬라이더로 일자별 변화를 비교하세요.
        </p>
      </details>
