...
const FAQ_LD = [
  ...
  },
  {
    ...
    a: '3주택 이상은 종부세 과세표준 <strong>12억원 초과분</strong>에 중과세율이 적용됩니다. 12억까지는 일반세율(0.5~1.0%)과 같고, 초과 구간은 1.3%/1.5%/2.0%/2.7% 대신 <strong>2.0% → 3.0% → 4.0% → 5.0%</strong>로 올라갑니다. 2주택 이하는 일반세율(0.5~2.7%)입니다. 본 계산기는 입력한 단일 합산 공시가격을 기준으로 중과세율을 적용합니다.',
  },
  {
