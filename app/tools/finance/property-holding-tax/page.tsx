...
const FAQ_LD = [
  ...
  },
  {
    ...
    a: '이중과세를 막기 위해 종부세 산출세액에서 <strong>같은 과세대상에 이미 부과된 재산세 상당액을 공제</strong>합니다. 즉 종부세는 재산세를 차감한 차액만 부담하는 구조라 이중과세가 아닙니다. 본 계산기는 종부세법 시행령의 비율식(종부세 과세표준 × 재산세 공정시장가액비율 × 0.4%)으로 중복분을 계산하며, 세부담상한이 적용된 경우 실제 공제액은 홈택스 고지서와 다를 수 있습니다.',
  },
  {
    ...
    <div style={{ maxWidth: '880px', margin: '0 auto', padding: '60px 24px 80px' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '48px' }}>
        ...
        <div>
          ...
          <p style={{ ...para, marginBottom: 0 }}>
            <strong style={strong}>3주택 이상</strong>은 과세표준 12억원 초과분에 중과세율이 붙습니다. 12억까지는 일반세율(0.5~1.0%)과 같지만, 초과 구간은 <strong style={strong}>2.0% → 3.0% → 4.0% → 5.0%</strong>로 올라가 2주택 이하(0.5~2.7%)보다 부담이 큽니다. 재산세는 주택마다 따로 부과되므로, 본 계산기는 주택별 공시가격을 받아 재산세는 주택별로 계산해 더하고 종부세는 합계에 주택 수에 맞는 세율을 적용합니다.
          </p>
        </div>
