...
const FAQ_LD = [
              ...
              },
              {
                ...
                a: '복리 계산 주기가 짧을수록 유리합니다. 연 10% 기준으로 연 복리는 10%이지만, 월 복리의 실질 연수익률은 약 10.47%이고 일복리는 10.52%입니다. 30년이 누적되면 최종 금액 차이는 약 14%까지 벌어집니다(1,000만원 거치 시 연복리 1억 7,449만원, 월복리 1억 9,837만원으로 약 2,390만원 차이). 본 계산기의 「수익률」 입력 카드 안 복리 주기 선택지(일/월/분기/연)를 바꿔 비교해보세요.',
              },
              {
              ...
              },
              {
                ...
                a: '국내 금융소득(이자·배당)은 15.4%(소득세 14% + 지방소득세 1.4%)가 과세됩니다. 연간 금융소득이 2,000만 원을 초과하면 종합소득세 과세 대상이 됩니다. 절세를 원한다면 ISA(9.9% 분리과세 + 200~400만 비과세)·연금저축·IRP(5.5% + 16.5% 세액공제) 등 절세 계좌를 검토하세요. 본 페이지의 「계좌 유형별 세율 비교」 표에서 세율·한도·특징을 확인할 수 있습니다.',
              },
              {
    ...
    <ToolPage width={760} slug="/tools/finance/compound">
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '48px' }}>
        ...
        <div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            <div style={{ background: 'var(--bg2)', border: '1px solid rgba(14,165,233,0.2)', borderRadius: 'var(--radius-m)', padding: '18px 20px' }}>
              ...
              <p style={{ fontFamily: 'var(--font-mono)', fontSize: '15px', color: 'var(--text)', marginBottom: '8px', letterSpacing: '0.5px' }}>
                FV = PV × (1 + r)ⁿ
              </p>
            ...
            <div style={{ background: 'var(--bg2)', border: '1px solid rgba(8,145,178,0.2)', borderRadius: 'var(--radius-m)', padding: '18px 20px' }}>
            ...
            <div style={{ background: 'var(--bg2)', border: '1px solid rgba(155,89,182,0.20)', borderRadius: 'var(--radius-m)', padding: '18px 20px' }}>
            ...
            <div style={{ background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 'var(--radius-m)', padding: '14px 20px' }}>
        ...
        <div>
          ...
          <div style={{ background: 'var(--bg2)', border: '1px solid rgba(14,165,233,0.25)', borderRadius: 'var(--radius-m)', padding: '18px 20px', textAlign: 'center', marginBottom: '16px' }}>
            <p style={{ fontFamily: 'var(--font-sans)', fontSize: '22px', fontWeight: 800, color: 'var(--accent)', marginBottom: '6px', letterSpacing: '1px' }}>
              2배 기간 ≈ 72 ÷ 연 수익률(%)
            </p>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px' }}>
              <thead>
                <tr style={{ borderBottom: '1px solid var(--border)' }}>
                  <th scope="col" style={{ padding: '10px 12px', textAlign: 'center', color: 'var(--muted)', fontWeight: 500 }}>연 수익률</th>
                  <th scope="col" style={{ padding: '10px 12px', textAlign: 'center', color: 'var(--accent)', fontWeight: 700 }}>2배 기간</th>
                  <th scope="col" style={{ padding: '10px 12px', textAlign: 'center', color: 'var(--muted)', fontWeight: 500 }}>대표 투자처 예시</th>
                  <th scope="col" style={{ padding: '10px 12px', textAlign: 'right', color: 'var(--muted)', fontWeight: 500 }}>1,000만원 → 30년 후</th>
                </tr>
              </thead>
              <tbody>
                {[
                  ...
                  ['7%',  '10.3년', '주식·채권 분산투자 장기 가정', '7,612만원'],
                  ['10%', '7.2년', 'S&P500 (명목 장기 평균)',    '17,449만원'],
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px' }}>
              <thead>
                <tr style={{ borderBottom: '1px solid var(--border)' }}>
                  ...
                  <th scope="col" style={{ padding: '10px 12px', textAlign: 'center', color: 'var(--muted)', fontWeight: 500 }}>기간</th>
                  <th scope="col" style={{ padding: '10px 12px', textAlign: 'center', color: 'var(--muted)', fontWeight: 500 }}>수익률</th>
                  <th scope="col" style={{ padding: '10px 12px', textAlign: 'right', color: '#A16207', fontWeight: 700 }}>월 적립액 (초기 0)</th>
                </tr>
              </thead>
              <tbody>
                {[
                  ...
                  <tr key={i} style={{ borderBottom: '1px solid var(--border)', background: i % 2 === 0 ? 'transparent' : 'var(--bg2)' }}>
                    ...
                    <td style={{ padding: '10px 12px', textAlign: 'right', color: '#A16207', fontFamily: 'var(--font-sans)', fontWeight: 700 }}>{row[3]}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <div>
          ...
          <div style={{ overflowX: 'auto', marginBottom: 12 }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px', minWidth: 580 }}>
              <thead>
                <tr style={{ borderBottom: '1px solid var(--border)' }}>
                  <th scope="col" style={{ padding: '10px 12px', textAlign: 'left', color: 'var(--muted)', fontWeight: 500 }}>계좌</th>
                  <th scope="col" style={{ padding: '10px 12px', textAlign: 'center', color: 'var(--muted)', fontWeight: 500 }}>세율</th>
                  <th scope="col" style={{ padding: '10px 12px', textAlign: 'right', color: 'var(--muted)', fontWeight: 500 }}>연 한도</th>
              ...
              <tbody>
                {[
                  ...
                  <tr key={i} style={{ borderBottom: '1px solid var(--border)', background: i % 2 === 0 ? 'transparent' : 'var(--bg2)' }}>
                    <td style={{ padding: '10px 12px', color: 'var(--text)', fontWeight: 700 }}>{row[0]}</td>
                    <td style={{ padding: '10px 12px', textAlign: 'center', color: '#EA580C', fontWeight: 700, fontFamily: 'var(--font-sans)' }}>{row[1]}</td>
        ...
        <div>
          ...
          <div style={{ overflowX: 'auto', marginBottom: 12 }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px' }}>
              <thead>
                <tr style={{ borderBottom: '1px solid var(--border)' }}>
                  <th scope="col" style={{ padding: '10px 12px', textAlign: 'left', color: 'var(--muted)', fontWeight: 500 }}>30년 후 명목 자산</th>
                  <th scope="col" style={{ padding: '10px 12px', textAlign: 'center', color: 'var(--muted)', fontWeight: 500 }}>인플레이션</th>
                  <th scope="col" style={{ padding: '10px 12px', textAlign: 'right', color: '#0891B2', fontWeight: 700 }}>실질 가치 (오늘 구매력)</th>
                  <th scope="col" style={{ padding: '10px 12px', textAlign: 'right', color: 'var(--muted)', fontWeight: 500 }}>구매력 손실</th>
                </tr>
              </thead>
              <tbody>
                {[
                  ...
                  <tr key={i} style={{ borderBottom: '1px solid var(--border)', background: i % 2 === 0 ? 'transparent' : 'var(--bg2)' }}>
                    <td style={{ padding: '10px 12px', color: 'var(--text)', fontWeight: 700 }}>{row[0]}</td>
                    <td style={{ padding: '10px 12px', textAlign: 'center', color: '#0891B2', fontWeight: 700, fontFamily: 'var(--font-sans)' }}>{row[1]}</td>
                    <td style={{ padding: '10px 12px', textAlign: 'right', color: '#0891B2', fontFamily: 'var(--font-sans)', fontWeight: 700 }}>{row[2]}</td>
                    <td style={{ padding: '10px 12px', textAlign: 'right', color: '#DC2626', fontFamily: 'var(--font-sans)' }}>{row[3]}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 10 }}>
            {[
              ...
              { name: '기준 7%',    color: 'var(--accent)', desc: '주식·채권 분산투자 장기 가정 (명목 수익률)', warn: '연구용 표준' },
              { name: '낙관적 10%', color: '#A16207', desc: 'S&P500 명목 장기 평균', warn: '연 -30%~+40% 변동' },
              ...
              <div key={i} style={{ background: 'var(--bg2)', border: `1px solid ${s.color}55`, borderRadius: 'var(--radius-m)', padding: '14px 16px' }}>
                <p style={{ fontSize: 13, color: s.color, fontWeight: 700, fontFamily: 'var(--font-sans)', marginBottom: 6 }}>{s.name}</p>
        ...
        <div>
          ...
          <div className="tableScroll">
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px' }}>
              <thead>
                <tr style={{ borderBottom: '1px solid var(--border)' }}>
                  <th scope="col" style={{ padding: '10px 12px', textAlign: 'left', color: 'var(--muted)', fontWeight: 500 }}>복리 주기</th>
                  <th scope="col" style={{ padding: '10px 12px', textAlign: 'right', color: 'var(--accent)', fontWeight: 700 }}>실효 연수익률</th>
                  <th scope="col" style={{ padding: '10px 12px', textAlign: 'right', color: 'var(--muted)', fontWeight: 500 }}>1,000만원 → 1년 후</th>
                </tr>
              </thead>
              <tbody>
                {[
                  ...
                  <tr key={i} style={{ borderBottom: '1px solid var(--border)', background: i % 2 === 0 ? 'transparent' : 'var(--bg2)' }}>
                    ...
                    <td style={{ padding: '10px 12px', textAlign: 'right', color: 'var(--text)', fontFamily: 'var(--font-sans)' }}>{row[2]}원</td>
                  </tr>
                ))}
              </tbody>
            </table>
