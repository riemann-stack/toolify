...
const FAQ_LD = [
              {
                q: '12개월 할부면 월 얼마인가요?',
                a: '100만원을 12개월 할부로 결제할 경우 <strong>무이자: 월 약 83,333원</strong>(총 100만원), <strong>유이자(연 19.9%): 월 약 92,587원</strong>(총 약 111.1만원, 이자 약 11.1만원)입니다. 카드사·회원 등급에 따라 수수료율이 다르므로 정확한 금액은 카드사 확인이 필요합니다.',
              },
              {
                q: '무이자 할부가 진짜 이득인가요?',
              ...
              {
                q: '유이자 할부는 정말 손해인가요?',
                a: '네, <strong>일반적으로 손해</strong>입니다. 연 19.9% 수수료는 시중 대출 금리보다 훨씬 높습니다. 100만원을 12개월 유이자 할부 시 약 11.1만원의 이자가 추가되며, 24개월이면 약 22만원, 36개월이면 약 34만원이 추가됩니다. 가능한 한 일시불 또는 무이자 할부를 선택하고, 부득이한 경우 짧은 개월(6개월 이내)을 권장합니다.',
              },
              {
                q: '할부 개월이 길수록 좋은가요?',
                a: '월 부담은 줄지만 <strong>총 이자는 급증</strong>합니다. 100만원 기준: 12개월 이자 약 11.1만원, 24개월 이자 약 22만원(12개월의 약 2배), 36개월 이자 약 34만원(12개월의 약 3배). 가능한 짧은 개월(6~12개월)을 선택하고, 24개월 이상 할부는 신중히 결정하세요. 게다가 유이자 할부는 기간이 길수록 적용 수수료율 자체도 높아지는 경우가 많아 이자가 이중으로 늘어납니다.',
              },
              {
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '48px' }}>
        ...
        <div>
          ...
          <div style={{ background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 12, padding: '14px 18px', marginTop: 12, fontSize: 13, color: 'var(--muted)', lineHeight: 1.85 }}>
            ...
            • 월 납부액 ≈ <strong>92,587원</strong><br />
            • 총 납부액 = <strong>1,111,040원</strong><br />
            • 총 이자 = <strong style={{ color: '#DC2626' }}>111,040원</strong> (원금의 11.1%)
          </div>
        </div>
