  ...
  return (
    <div className={styles.wrap}>
      ...
      <Disclaimer
        variant="finance"
        related={[
          { href: '/tools/finance/year-end-tax', label: '연말정산' },
        ...
        <>
          ...
          <div className={styles.card}>
            ...
            <p style={{ fontSize: 12, color: 'var(--muted)', marginTop: 12, lineHeight: 1.7 }}>
              ⓘ 국세청 2024년 귀속 연말정산 기준 — 평균 총급여 4,475만원, 중위 약 3,400만원, 상위 10% 진입 약 8,800만원, 상위 5% 약 1.11억원.
              본 위치는 총급여 기준 근사값이며 업종·지역·연령에 따라 다릅니다.
            </p>
          </div>
