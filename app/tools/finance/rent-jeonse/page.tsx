...
const FAQ_LD = [
              {
                q: '월세가 항상 비싼가요?',
                a: '아닙니다. 다음 조건이 맞으면 월세가 더 유리할 수 있습니다. <strong>월세 세액공제 자격</strong>(무주택 + 총급여 8천 이하 → 연 최대 약 170만 절세), <strong>단기 거주</strong>(1~2년, 전세대출 수수료·이사비 회수 어려움), <strong>자기자본 운용 기회</strong>(보증금 묶지 않고 7%+ 수익 가능), <strong>전세대출 금리 &gt; 전월세 전환율</strong>일 때 — 본 도구의 누적 비용 차트로 즉시 판단 가능합니다.',
              },
              {
                q: '전세대출 vs 신용대출, 어느 쪽이 좋나요?',
                a: '전세대출이 압도적으로 유리합니다. <strong>시중은행 전세대출 금리 3.5~4.5%</strong> vs 신용대출 5~7%. 전세대출은 보증금 자체가 담보가 되어 금리가 낮고, 원리금의 40%(한도 400만)까지 소득공제도 가능. 정부 지원 버팀목 전세자금은 연 2%대(일반형 2.1~2.9%, 한도 수도권 1.2억·지방 0.8억)로 더 저렴하므로 요건이 맞는 무주택자라면 우선 검토.',
              },
              {
                q: '월세 세액공제 받는 조건은?',
                a: '4가지 모두 충족해야 합니다. <strong>무주택 세대주(또는 세대원)</strong>, <strong>총급여 8천만 이하</strong>(또는 종합소득금액 7천만 이하), <strong>국민주택규모 85㎡ 이하</strong>(또는 기준시가 4억 이하), <strong>본인 또는 배우자 명의 계약</strong>. 연 월세액 1,000만 한도 × 17%(총급여 5,500만 이하) / 15%(5,500만~8,000만) = 최대 약 170만 환급. 5월 종합소득세 신고 또는 연말정산 시 적용.',
              },
              {
                q: '전세사기 안 당하는 5가지 핵심 체크는?',
                a: '① <strong>등기부등본 확인</strong> — 근저당·신탁·압류 여부(대법원 인터넷등기소 700원). ② <strong>전세가율 80% 이하</strong> — 국토부 실거래가 대비. ③ <strong>HUG 전세보증보험 가입</strong>(보증료 약 0.1~0.2%, 보증금 반환 보증 — 한도·보증대상·제외사항 있음). ④ <strong>잔금일 당일 등기부 재확인 + 확정일자 + 전입신고</strong>. ⑤ <strong>임대인 신원 확인</strong> — 신분증 vs 등기부 명의 일치, 대리계약 시 위임장·인감증명서. 의심 시 국토부 안심전세 앱에서 임대인 사고이력 조회.',
              },
              {
                q: '반전세는 언제 유리한가요?',
              ...
              {
                q: '전월세 전환율이 뭔가요?',
                a: '같은 집의 전세 보증금 일부를 월세로 환산할 때 적용되는 비율. 예: 전세 1억을 월세 전환 시 5% 적용 → 월 (1억 × 5% ÷ 12) = 41.7만원. <strong>법정 한도</strong>는 한국은행 기준금리 + 2%(주택임대차보호법 시행령) — 초과 인상은 무효. 시장 평균 4~6%. <strong>본인의 전세대출 금리보다 전환율이 낮으면 월세가 수학적으로 유리</strong>합니다.',
              },
              {
              ...
              },
              {
                ...
                a: '필수는 아니지만 <strong>강력히 권장</strong>됩니다. 보증료는 보증금·주택유형·부채비율에 따라 약 0.1~0.2%(보증금 1억당 연 10~20만 수준)이며, 보증금 반환을 HUG가 보증합니다(보증대상·한도·제외사항 있음 — 약관 확인). 가입 조건은 전세가율 90% 이하, 시세 7억 이하 등 — 시세 대비 전세금이 높은 매물은 가입 자체가 불가하므로 매물 선택 단계부터 확인 필요. 신청기한은 전세계약기간의 1/2 경과 전 등 상품별로 다르니 가입 시점을 미루지 마세요.',
              },
            ]
...
export default function RentJeonsePage() {
  return (
    <div style={{ maxWidth: '880px', margin: '0 auto', padding: '60px 24px 80px' }}>
      ...
      <UpdatedMeta date="2026년 9월" basis="2026년 전월세·금리 참고 · 버팀목 대출은 주택도시기금 기준" sources={[{"label":"국토부 실거래가","href":"https://rt.molit.go.kr"},{"label":"한국부동산원","href":"https://www.reb.or.kr"},{"label":"주택도시기금","href":"https://nhuf.molit.go.kr"}]} />
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px' }}>
              ...
              <tbody>
                {[
                  ...
                  ['세제 혜택',         '대출이자 소득공제 40% (한도 400만)', '월세 세액공제 17% (한도 1,000만)', '둘 다 부분 적용'],
        ...
        <section>
          ...
          <div style={{ overflowX: 'auto' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px' }}>
              ...
              <tbody>
                {[
                  ['버팀목 전세자금 (일반)', '무주택 세대주 · 소득 요건', '수도권 1.2억 · 지방 0.8억', '연 2.1~2.9%',    '정부 지원 · 소득·보증금별 금리'],
                  ['청년 버팀목',          '만 19~34세 무주택', '1.5억 (만 25세 미만 단독세대주 1.2억)', '일반형보다 우대', '2025.6.27 이후 계약분 기준 한도'],
                  ['신혼부부 버팀목',       '혼인 7년 이내',    '기금e든든 공고 확인', '소득별 우대',   '신혼 우대 · 수도권 한도는 규제에 따라 변동'],
          ...
          <p style={{ ...faqAnswer, marginTop: '12px', fontSize: '12px' }}>
            ※ 버팀목 한도·금리는 주택도시기금(nhuf.molit.go.kr, 2026년 9월 확인) 기준 요약이며, 은행 상품 금리는 은행·시점별 차이가 큰 참고치입니다. 신청 전 기금e든든·한국주택금융공사(HF)·취급은행에서 최신 조건을 확인하세요.
          </p>
        </section>
