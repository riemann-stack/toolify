...
export const metadata = buildMetadata({
  ...
  description:
    '자동차 구매 시 취득세 + 공채 매입 + 등록비 + 매년 자동차세·지방교육세·환경부담금·유류세까지 한 화면에. 친환경차·다자녀·장애인 감면 자동 + 연납 9% 할인 + 5/10년 누적 시뮬레이션 (2026년 기준).',
  keywords: [
    ...
    <div style={{ maxWidth: '880px', margin: '0 auto', padding: '60px 24px 80px' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
        ...
        <section>
          ...
          <p style={{ fontSize: '13px', color: 'var(--muted)', marginTop: '12px', lineHeight: 1.7 }}>
            ※ 위 금액에 <strong>지방교육세 30% 가산</strong>됩니다. 연납(1월) 시 본세 9.15% 할인.
          </p>
        </section>
        ...
        <section>
          ...
          <details style={faqDetails}>
            ...
            <div style={faqAnswer}>
              <strong style={{ color: 'var(--text)' }}>1월에 일괄 납부 시 약 9.15% 할인</strong>됩니다 (2025년 기준).
          ...
          <details style={faqDetails}>
            ...
            <div style={faqAnswer}>
              ...
              <ul style={{ paddingLeft: 18, marginTop: 8 }}>
                ...
                <li>5년 합산: 140 + 27×5 + 112×5 = 약 <strong style={{ color: 'var(--accent)' }}>835만 원 절감</strong></li>
              </ul>
          ...
          <details style={faqDetails}>
            ...
            <div style={faqAnswer}>
              ...
              본 도구는 경유 차종 선택 시 자동 반영. 노후 경유차는 조기폐차 보조금(50~600만원) 활용 권장.
            </div>
          </details>
        </section>
