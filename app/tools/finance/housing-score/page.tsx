      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
        ...
        <section>
          ...
          <p style={{ fontSize: '12px', color: 'var(--muted)', marginTop: 10, lineHeight: 1.7 }}>
            ※ 한국부동산원 청약홈이 단지별 발표하는 당첨 가점 공개 자료를 바탕으로 한 대략적 참고 범위 (2023~2025년 관측, 단지·평형·시기별 편차 ±5~10점). <strong style={{ color: 'var(--text)' }}>최신 단지별 정확 가점</strong>은 한국부동산원 청약홈에서 분양 직후 발표하는 공식 통계 확인.
          </p>
        </section>
        ...
        <section>
          ...
          <details style={faqDetails}>
            ...
            <div style={faqAnswer}>
              일반적인 케이스는 청약홈 공식 계산과 같은 규칙(주택공급에 관한 규칙 별표1)으로 계산하지만, 다음 특수 케이스는 반드시 청약홈에서 재확인하세요:
              <ul style={{ paddingLeft: 18, marginTop: 8 }}>
                <li>이혼·재혼·사별</li>
