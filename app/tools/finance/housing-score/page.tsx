...
export const metadata = buildMetadata({
  ...
  description:
    '주택 청약 가점제 84점(무주택 32 + 부양가족 35 + 통장 17) 자동 계산. 생년월일·결혼일로 무주택 기간 자동 산정 + 최근 평균 당첨 가점 비교 + 가점 향상 시뮬 + 5가지 특별공급 자가진단 + 위장전입 등 함정 가이드 (2025년 기준).',
  keywords: [
  ...
  return (
    <div style={{ maxWidth: '880px', margin: '0 auto', padding: '60px 24px 80px' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
        ...
        {/* 1. 가점제 84점 구조 */}
        <section>
          <h2 style={sectionTitle}>청약 가점제 84점 구조 (2025 기준)</h2>
          <p style={{ fontSize: '14px', color: 'var(--muted)', lineHeight: 1.9, marginBottom: '12px' }}>
            주택법 시행규칙 별표1 기준 — 가점제는 <strong style={{ color: 'var(--text)' }}>3개 영역의 합계 84점</strong>입니다.
          </p>
        ...
        <section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '10px' }}>
            {[
              ...
              { name: '✅ 직계존속', desc: '만 60세 이상 + 동일 세대 3년 이상' },
              { name: '❌ 형제·자매', desc: '부양가족 X (절대 인정 X)' },
              { name: '❌ 조부모·외조부모', desc: '직계존속 아님 — 부양가족 X' },
        ...
        <section>
          ...
          <p style={{ fontSize: '14px', color: 'var(--muted)', lineHeight: 1.9, marginBottom: '12px' }}>
            가점이 부족해도 특별공급 자격이 있다면 당첨 확률이 크게 올라갑니다. 본 도구의 「특별공급 자가진단」에서 자격 체크.
          </p>
          <div style={{ ...card, padding: 0, overflow: 'hidden' }}>
        ...
        <section>
          ...
          <details style={faqDetails}>
            ...
            <div style={faqAnswer}>
              ...
              <ul style={{ paddingLeft: 18, marginTop: 8 }}>
                <li>월 10만 원: 1순위 빠른 충족 + 연말정산 240만 원 공제 (15만 원 환급)</li>
