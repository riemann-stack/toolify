/* ───────────────────────────────────────────────────────────
   주택 청약 가점제 — 84점 만점 (주택법 시행규칙 별표1)
   - 무주택 기간 (0~32점) + 부양가족 (5~35점) + 통장 (1~17점)
   - 2025년 기준 (최신 정보는 청약홈·LH·HUG 공식 사이트에서 확인)
   ─────────────────────────────────────────────────────────── */
...
export const GRADES: ScoreGrade[] = [
  { grade: 'S', color: '#FFD700', desc: '서울 인기 단지 당첨 가능권 (강남·송파·서초)', minScore: 70 },
  { grade: 'A', color: '#3EFF9B', desc: '서울 일반·수도권 인기 단지 당첨권',          minScore: 60 },
  { grade: 'B', color: '#3EC8FF', desc: '수도권 일반·지방 광역시 인기 단지권',          minScore: 50 },
  { grade: 'C', color: '#FFB83E', desc: '지방 광역시 일반·중소도시 당첨권',            minScore: 40 },
  { grade: 'D', color: '#FF8C3E', desc: '지방 중소도시 + 특별공급 검토 권장',         minScore: 25 },
  { grade: 'E', color: '#FF6B6B', desc: '가점 부족 — 특별공급·추첨제 우선 검토',      minScore: 0 },
]
...
export const PITFALLS: Pitfall[] = [
  ...
  },
  {
    title: '부양가족 인정 기준 오해',
    level: 'mid',
    desc: '형제·자매·조부모·외조부모 = 부양가족 X. 직계존속은 만 60세 이상 + 3년 이상 동일 세대 필수.',
  },
  {
