...
export const metadata = buildMetadata({
  ...
  description: '단기·불기·조선왕·간지·일본·중국 연호를 서기와 동시 변환. 단군~현재 통합 연표, 조선 27대 왕 재위·기년표, 한·중·일 연호 비교표까지 한 화면에.',
...
const FAQ_LD = [
              {
                q: '단기 4359년은 서기 몇 년인가요?',
                a: '단기에서 2333을 빼면 서기가 됩니다. 4359 − 2333 = 서기 2026년입니다. 반대로 서기에 2333을 더하면 단기가 됩니다 — 서기 2030년은 단기 2030 + 2333 = 4363년입니다.',
              },
              {
              ...
              {
                q: '불기 2570년은 서기 몇 년인가요?',
                a: '불기에서 544를 빼면 서기가 됩니다. 불기 2570 − 544 = 서기 2026년입니다. 한국 불교에서는 석가모니 열반을 기원전 544년으로 계산합니다.',
              },
              {
    ...
    <div style={{ maxWidth: '760px', margin: '0 auto', padding: '60px 24px 80px' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '48px' }}>
        ...
        <div>
          ...
          <div style={{ background: 'var(--bg2)', border: '1px solid rgba(219,39,119,0.2)', borderRadius: 'var(--radius-m)', padding: '16px 18px' }}>
