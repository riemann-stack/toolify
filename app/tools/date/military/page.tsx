...
const FAQ_LD = [
              ...
              {
                q: '2025년 7월 입영판정검사가 전역일에 영향을 주나요?',
                a: '<strong>아닙니다.</strong> 「병역법」 제18조제1항은 여전히 <strong>"현역은 입영한 날부터 복무한다"</strong>고 정하므로, 복무기간 기산점은 종전과 같은 <strong>입영일</strong>입니다. 입영판정검사는 <strong>입영 30일 전~전일</strong>에 지방병무청에서 미리 받는 것이라 복무기간에 산입되지 않아 전역일 계산이 달라지지 않습니다. (시행령상 "병역처분은 입영판정검사를 한 날에 한다"는 <strong>병역처분 시점</strong> 규정일 뿐 복무 기산일과 무관합니다.)<br/><br/>제도 자체는 「병역법」 제14조의3으로 <strong>2020년 12월 신설</strong>되어 2021년부터 육군에서 시범운영되었고, <strong>2025년 7월부터 육·해·공·해병대 전 입영부대로 전면 시행</strong>되어 종전 「부대 도착 후 입영신체검사」를 대체합니다. 다만 입영자 전원은 아니며, 다른 검사를 받은 지 6개월이 안 된 사람 등 예외군은 종전대로 부대에서 신체검사를 받습니다.',
              },
              {
