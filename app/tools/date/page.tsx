...
export const metadata: Metadata = {
  title: '날짜·시간 계산기 모음 | Youtil',
  description: '만 나이, D-day, 날짜 차이, 군 전역일·복무율 계산기 등 날짜·시간 관련 무료 도구 모음.',
}

const tools = [
  { href: '/tools/date/age',      icon: '🎂', name: '만 나이 계산기',          desc: '법 개정 기준 만 나이 즉시 계산' },
  { href: '/tools/date/dday',     icon: '📅', name: 'D-day 계산기',            desc: '목표까지 남은 일수 카운트다운' },
  { href: '/tools/date/diff',     icon: '📆', name: '날짜 차이 계산기',        desc: '두 날짜 사이의 기간 계산' },
  { href: '/tools/date/military', icon: '🎖️', name: '군 전역일·복무율 계산기', desc: '입대일로 전역일·복무율 계산' },
]
