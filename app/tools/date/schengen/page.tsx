...
const FAQ_LD = [
  ...
  { q: '90일을 초과하면 어떻게 되나요?', a: '초과 체류(오버스테이)는 <strong>벌금, 출국 명령, 향후 쉥겐 입국 금지(수개월~수년)</strong> 등의 불이익을 받을 수 있습니다. 적발은 출국 시 여권 스탬프나 EES(입·출국 시스템)로 이뤄집니다. 단 하루라도 넘기지 않도록 보수적으로 일정을 잡으세요.' },
]
...
export default function SchengenPage() {
  return (
    <div style={{ maxWidth: '760px', margin: '0 auto', padding: '60px 24px 80px' }}>
      ...
      <UpdatedMeta date="2026년 5월" basis="쉥겐 29개 회원국 기준" sources={[{ label: 'EU 공식 쉥겐 계산기', href: 'https://ec.europa.eu/assets/home/visa-calculator/calculator.htm' }]} />
