      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '44px', marginTop: '48px' }}>
        ...
        <div>
          ...
          <p style={{ fontSize: '13px', color: 'var(--muted)', lineHeight: 1.7, marginBottom: '14px' }}>
            불가리아·루마니아는 2025년 1월 육로까지 전면 가입해 현재 29개국입니다. <strong style={{ color: 'var(--text)' }}>아일랜드·키프로스는 쉥겐이 아니며</strong>(키프로스 가입은 2026년 하반기 EU 이사회 결정 예정), 영국은 브렉시트 후 별도 규정(보통 6개월·ETA 필요)을 적용합니다.
          </p>
        ...
        <div>
          ...
          <div style={{ ...card, fontSize: '13px', color: 'var(--muted)', lineHeight: 1.85 }}>
            ...
            <p style={{ margin: '0 0 8px', color: 'var(--text)' }}>
              <strong style={{ color: 'var(--accent)' }}>ETIAS(전자여행허가)</strong> — <strong>개시 시기 미정</strong>입니다. 당초 2026년 4분기 목표였으나 2026년 7월 EU 공식 사이트에서 목표 시점이 삭제됐고, 2027년 연기 가능성이 보도되고 있습니다(공식 확정 아님). EU는 정확한 개시일을 <strong>개시 수개월 전에 공지</strong>할 예정이며, 현재는 신청 접수 자체가 시작되지 않았습니다 — 지금 신청을 받는 사이트는 공식이 아닙니다.
            </p>
            <ul style={{ margin: 0, paddingLeft: '20px', lineHeight: 1.9 }}>
              <li>한국 등 무비자 여행자는 개시 후 출발 전 <strong style={{ color: 'var(--text)' }}>온라인 사전 신청</strong>이 필요합니다 (수수료 20유로, <strong style={{ color: 'var(--text)' }}>18세 미만·70세 초과는 면제</strong>)</li>
              <li>유효기간은 <strong style={{ color: 'var(--text)' }}>3년 또는 여권 만료일 중 빠른 쪽</strong>까지입니다</li>
              <li>개시 후 <strong style={{ color: 'var(--text)' }}>최소 6개월의 과도기</strong>(ETIAS 없어도 나머지 입국 요건 충족 시 입국 거부 안 됨)와 <strong style={{ color: 'var(--text)' }}>최소 6개월의 유예기간</strong>(과도기 종료 후 첫 입국자만 예외 허용)이 이어져 합계 최소 1년의 완충이 예정되어 있습니다</li>
            </ul>
        ...
        <div>
          ...
          <div style={{ ...card, fontSize: '13px', color: 'var(--muted)', lineHeight: 1.85 }}>
            ...
            <p style={{ margin: '0 0 6px', color: 'var(--text)', fontWeight: 600 }}>알려진 국가별 단서 (외교부 0404 알림 기준)</p>
            <ul style={{ margin: '0 0 10px', paddingLeft: '20px', lineHeight: 1.9 }}>
              <li><strong style={{ color: 'var(--text)' }}>벨기에</strong> — 90일은 <strong style={{ color: 'var(--text)' }}>네덜란드·룩셈부르크 체류와 합산</strong>(베네룩스 합산 90일)</li>
              <li><strong style={{ color: 'var(--text)' }}>오스트리아</strong> — 90일 체류 후 출국했다가 바로 재입국하는 것은 <strong style={{ color: 'var(--text)' }}>1회에 한해 허용</strong></li>
              <li>우선 적용 여부는 <strong style={{ color: 'var(--text)' }}>각국 고유 권한</strong>으로 수시로 변경될 수 있습니다 (외교부가 결정하는 사항이 아님)</li>
            </ul>
            <p style={{ margin: 0 }}>
