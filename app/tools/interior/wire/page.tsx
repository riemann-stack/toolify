...
const FAQ_LD = [
  { "q":"1.5sq 전선은 몇 A까지 가능한가요?","a":"HIV 동선·30°C·일반 부설 기준 19A가 KEC 2021 표준입니다. 단, 보정계수(주위온도·다회로 묶음·매설)에 따라 70~85% 수준으로 떨어집니다. 예: 40°C에서 1.5sq → 19 × 0.87 = 약 16.5A. 콘센트 회로(20A 차단기)에는 일반적으로 2.5sq 이상을 권장합니다." },
  ...
  { "q":"EV 완속 충전기 7kW는 전선 굵기와 차단기?","a":"단상 220V 7kW = 약 32A (역률 1.0). KEC 232.4의 1.25배 규칙으로 40A 차단기 + 6sq HIV/F-CV가 한국 표준 조합입니다. 매설 구간은 F-CV(가교폴리에틸렌, 90°C)를 사용하고, EV 콘센트는 단독 분기 + RCBO(누전·과전류 통합) 30mA가 의무. 한전 신청·전기안전공사 검사가 별도로 필요합니다. 22kW 급속은 삼상 380V로 가져가면 전선이 가늘어도 됩니다(4sq + 40A)." },
  ...
  { "q":"단상 220V와 삼상 380V 어느 게 유리한가요?","a":"같은 W면 삼상이 압도적으로 유리합니다. 전류 = P / (√3 × V) 공식에서 √3 × 380 ≈ 658 — 단상 220 대비 약 3배. 예: 10kW를 단상 220V로 흘리면 45.5A지만, 삼상 380V로는 15.2A에 불과해요. → 전선 가늘어도 됨, 차단기 작아도 됨, 변압기 효율 ↑. 산업·공장·시스템 에어컨·EV 급속·22kW 이상은 삼상이 표준이며, 가정도 시스템 에어컨이 들어가면 부분적으로 삼상을 끌어 쓰는 경우가 많아요." },
  { "q":"차단기 용량은 어떻게 정하나요?","a":"KEC 232.4: 차단기 = 부하전류 × 1.25 이상의 가장 작은 표준값. 예: 부하 32A → 32 × 1.25 = 40A → 40A 차단기 선택. 너무 크면 과부하·과열을 막지 못하고, 너무 작으면 정상 운전 시 트립이 자주 일어납니다. 모터 부하는 기동전류가 정격의 5~7배이므로 차단기를 한 단계 큰 것으로 또는 D-curve(모터용) 차단기를 선택하기도 합니다." },
  ...
  { "q":"옥외 매설용 전선은 무엇을 쓰나요?","a":"F-CV (가교폴리에틸렌, 90°C 내열)가 표준입니다. 기존 CV 케이블의 개량형으로, 자외선·습기·화학물질에 강하고 매설·옥외·노출 모두 가능해요. 공동주택 간선·EV 충전기 인입선·옥외 조명에 가장 흔합니다. 반면 옥내 일반 콘센트·조명은 HIV(60227 IEC 02)가 표준입니다. 소방·통신·아파트 간선처럼 화재 시 연소 확산이 우려되는 곳은 FR-CV(난연)를 씁니다." },
  ...
  return (
    <div style={{ maxWidth: '880px', margin: '0 auto', padding: '60px 24px 80px' }}>
      ...
      <div style={card}>
        ...
        <p style={{ marginTop: 12, fontSize: 12, color: 'var(--muted)', lineHeight: 1.7 }}>
          ※ 욕실·발코니 등 물기 있는 곳·EV 충전기·전기차 콘센트는 <strong>고감도 누전차단기(15mA)</strong>를 추가로 설치합니다.
          최근에는 두 기능을 통합한 <strong>RCBO(Residual Current Breaker with Overcurrent)</strong>가 표준화되고 있어요.
        </p>
      </div>
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          <strong>HIV 동선·30°C·일반 부설 기준 19A</strong>가 KEC 2021 표준입니다.
          단, 보정계수(주위온도·다회로 묶음·매설)에 따라 70~85% 수준으로 떨어집니다.
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          단상 220V 7kW = <strong>약 32A</strong> (역률 1.0). KEC 232.4의 1.25배 규칙으로
          <strong> 40A 차단기 + 6sq HIV/F-CV</strong>가 한국 표준 조합입니다.
          매설 구간은 F-CV(가교폴리에틸렌, 90°C)를 사용하고, EV 콘센트는 단독 분기 + RCBO(누전·과전류 통합) 30mA가 의무.
          한전 신청·전기안전공사 검사가 별도로 필요합니다. 22kW 급속은 삼상 380V로 가져가면
          전선이 가늘어도 됩니다(4sq + 40A).
        </p>
      </details>
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          ...
          <strong> 산업·공장·시스템 에어컨·EV 급속·22kW 이상은 삼상</strong>이 표준이며,
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          KEC 232.4: <strong>차단기 = 부하전류 × 1.25 이상의 가장 작은 표준값</strong>.
          예: 부하 32A → 32 × 1.25 = 40A → 40A 차단기 선택. 너무 크면 과부하·과열을 막지 못하고,
          너무 작으면 정상 운전 시 트립이 자주 일어납니다.
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          ...
          반면 옥내 일반 콘센트·조명은 <strong>HIV(60227 IEC 02)</strong>가 표준입니다.
