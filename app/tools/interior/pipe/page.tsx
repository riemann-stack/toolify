...
const FAQ_LD = [
  ...
  { "q":"A호칭과 인치는 어떻게 변환하나요?","a":"간단히 A 숫자에 1/25를 곱하면 인치 분수가 나옵니다. 15A ≈ 1/2\", 20A ≈ 3/4\", 25A ≈ 1\", 50A ≈ 2\", 100A ≈ 4\". 정확히 같진 않지만 호칭상 같은 사이즈입니다. 위 변환표를 참고하세요." },
  ...
  { "q":"동파 방지 단열재 두께는 얼마나?","a":"일반적으로 15·20A=10mm, 25·32A=15mm, 40A=20mm, 50A 이상=25~30mm가 권장입니다. 영하 10°C 이하 한랭지·옥외 노출 구간은 1.5~2배 두께를 추가하세요. 단열재는 아트론(폴리에틸렌 발포)이나 고무발포(아마플렉스 등)를 가장 많이 사용합니다. 중요한 것은 틈새·이음부 빈틈없이 감싸는 것이며, 동파 방지 열선과 병용하면 더 안전합니다." },
