...
const FAQ_LD = [
  ...
  { "q":"본 도구의 토크 안내는 정확한가요?","a":"일반 참고값이며 정확치는 아닙니다. 본 도구는 8.8 등급 강 볼트 기준 일반 범위만 표시합니다. 정확한 토크는 ① 제조사 사양서·기계 매뉴얼 확인 ② 토크 렌치 사용(특히 자동차·항공) ③ 나사 등급(4.6 / 8.8 / 10.9 / 12.9 등)별로 다름 ④ 스테인리스·티타늄·황동은 강 볼트와 다른 값 ⑤ 윤활·녹·이물질로 ±20~30% 변동." },
