...
const FAQ_LD = [
  ...
  { "q":"관통홀 직경은 어떻게 정하나요?","a":"용도에 따라 정밀/일반/헐거움 3종류: 정밀 (Tight): 외경 + 0.4mm. 정밀 끼워맞춤·정렬 중요 일반 (Normal): 외경 + 1.0mm. 대부분 케이스 — 표준 헐거움 (Loose): 외경 + 2.0mm. 조립 시 여유 필요·열팽창 고려 예: M6 → 6.4 / 6.6 / 7.0mm. 본 도구의 결과 카드에 모두 표시." },
  { "q":"목재피스 파일럿홀은 꼭 뚫어야 하나요?","a":"경질목·두께 얇은 합판은 필수, 연질목은 권장. 경질목(오크·메이플·티크): 파일럿 X → 균열·피스 부러짐 위험 ↑ 연질목(소나무·삼나무): 파일럿 권장 — 정확한 위치 + 균열 방지 얇은 합판·MDF: 파일럿 필수 — 두께 변형 방지 가장자리 가까이(엣지 근처): 파일럿 + 카운터싱크 필수 파일럿 직경 = 피스 직경의 65~70% (본 도구의 가이드 활용)." },
