...
export default function ScrewClient() {
  ...
  return (
    <div className={s.wrap}>
      ...
      >
        본 도구는 KS·DIN·ISO·JIS 표준 사이즈 기준의 일반 가이드이며, 실제 호환성은 ±0.1~0.5mm 차이가 날 수 있습니다. <strong>특정 브랜드·공구 추천, 정확한 토크값, 인장·전단강도는 보장하지 않으며 항공·자동차 등 정밀 산업에는 적용하지 마세요.</strong> ⚠️ 드릴 작업 시 보호 안경·장갑을 착용하고, 스테인리스·알루미늄은 절삭유를 사용하세요. 응급 시 119.
      </Disclaimer>
