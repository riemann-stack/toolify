  ...
  return (
    <div className={s.wrap}>
      ...
      <div className={s.disclaimer}>
        <strong>📌 사용 안내</strong>
        <ul>
          <li>표시 사이즈·토크는 KS·ISO·DIN <strong>표준 일반치 참고용</strong>입니다.</li>
          <li>고강도·안전부품·고급 차량은 반드시 <strong>제조사 매뉴얼·도면</strong>을 따르세요.</li>
          <li>옛 JIS 사이즈는 1990년대 이전 일본·한국 산 부품에 주로 잔존합니다.</li>
