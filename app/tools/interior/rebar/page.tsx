...
const FAQ_LD = [
  ...
  { "q":"6m 철근과 12m 철근 어느 게 유리?","a":"현장 규모에 따라 다릅니다. • 6m — 소형 현장·셀프 시공·자투리 활용에 좋음(1톤 트럭은 법정 적재길이가 약 5.6m라 허가 또는 절단 필요) • 12m — 이음(겹침) 횟수가 줄어 강도·시공성 우수, 자투리 적음. 단 5톤 카고 이상 차량 필요 → 운반비 ↑ 대형 현장이라면 12m가 종합적으로 유리한 경우가 많아요." },
  ...
  { "q":"옹벽·기초·계단 셀프 배근 가능한가요?","a":"소형·비구조물에 한정해 가능합니다. • 가능: 담장·울타리, 옹벽 1m 미만, 카포트 기초, 짧은 계단(5단 이하) • 불가: 주택 슬래브·지하실·옹벽 1.5m↑·차고 천장 — 구조기술사 도면 + 건설업 등록업체 권장(높이 2m를 넘는 옹벽은 건축법상 공작물 축조신고 대상). 신고 없이 축조하면 시정명령과 벌금 대상이 될 수 있고, 사고가 나면 형사 책임까지 질 수 있습니다. 배근 가이드 탭은 참고용이며 대형·구조 부재는 반드시 전문가에게 의뢰하세요." },
  ...
  { "q":"1톤 트럭에 D10 6m 몇 본 실릴까?","a":"D10 6m 1본 = 3.36kg. 1톤(1000kg) ÷ 3.36 ≈ 약 298본. 단, 화물 적재 길이는 차 길이의 110%까지라(도로교통법 시행령 제22조) 1톤 트럭(전장 약 5.1m)에 6m 철근을 실으려면 출발지 관할 경찰서장 허가를 받거나 잘라서 실어야 합니다. 더 굵은 철근(D25)은 6m 1본 23.9kg → 1톤이면 약 42본만 실립니다." },
  { "q":"고철 매도 시 중량 산정은?","a":"고철 매입은 실측 중량(저울)이 우선입니다. 본 도구로 추정한 중량은 본수·길이가 정확할 때만 일치하며, 부식·녹·절단 변형이 있으면 ±10% 오차가 있을 수 있어요. 철근 고철 시세가 kg당 200~400원(2026년 상반기 기준, 변동 큼)이면 1톤은 약 20~40만원입니다. 매입 업체별로 가격 차이가 크므로 2~3곳 견적을 받으세요." }
]
  ...
  return (
    <div style={{ maxWidth: '880px', margin: '0 auto', padding: '60px 24px 80px' }}>
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          현장 규모에 따라 다릅니다.<br />
          • <strong>6m</strong> — 소형 현장·셀프 시공·자투리 활용에 좋음 (1톤 트럭은 법정 적재길이가 약 5.6m라 허가 또는 절단 필요)<br />
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          ...
          • 불가: 주택 슬래브·지하실·옹벽 1.5m↑·차고 천장 — <strong>구조기술사 도면 + 건설업 등록업체</strong> 권장
          (높이 2m를 넘는 옹벽은 건축법상 공작물 축조신고 대상)<br />
          신고 없이 축조하면 시정명령과 벌금 대상이 될 수 있고, 사고가 나면 형사 책임까지 질 수 있습니다. 배근 가이드 탭은 <strong>참고용</strong>이며
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          ...
          단, 화물 적재 길이는 차 길이의 110%까지라(도로교통법 시행령 제22조) 1톤 트럭(전장 약 5.1m)에
          6m 철근을 실으려면 출발지 관할 경찰서장 허가를 받거나 잘라서 실어야 합니다.
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          ...
          철근 고철 시세가 <strong>kg당 200~400원</strong>(2026년 상반기 기준, 변동 큼)이면
          1톤은 <strong>약 20~40만원</strong>입니다. 매입 업체별로 가격 차이가 크므로 2~3곳 견적을 받으세요.
        </p>
      </details>
