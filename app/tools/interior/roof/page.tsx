...
const FAQ_LD = [
  { "q":"박공지붕과 맞배지붕 차이는?","a":"같은 형태입니다. 맞배지붕은 박공지붕(gable)을 부르는 우리말 이름으로, 두 사면이 용마루에서 만나 옆에서 보면 ㅅ자 단면이 됩니다. 처마 길이는 지붕 형태와 상관없이 집마다 정합니다. 한옥에는 맞배 외에도 팔작지붕과 우진각지붕(모임지붕)이 흔하며, 본 도구의 면적 계산은 경사형 지붕 모두 같은 공식(평면 × 경사 배율)이라 치수·물매·처마 입력이 결과를 좌우합니다." },
  ...
  return (
    <ToolPage width={880} slug="/tools/interior/roof">
      ...
      <details style={faqDetails}>
        ...
        <div style={faqAnswer}>
          <strong style={{ color: 'var(--text)' }}>같은 형태</strong>입니다. 맞배지붕은 박공지붕(gable)을 부르는 우리말 이름으로,
          두 사면이 용마루에서 만나 옆에서 보면 ㅅ자 단면이 됩니다. 처마 길이는 지붕 형태와 상관없이 집마다 정합니다.
          한옥에는 맞배 외에도 팔작지붕과 우진각지붕(모임지붕)이 흔하며, 본 도구의 면적 계산은 경사형 지붕 모두
          같은 공식(평면 × 경사 배율)이라 치수·물매·처마 입력이 결과를 좌우합니다.
        </div>
      </details>
