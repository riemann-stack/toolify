...
const FAQ_LD = [
  ...
  { "q":"로스율은 왜 포함해야 하나요?","a":"자재 시공 시 자투리·교체분·시공 손실이 발생. 일반적으로: 5~10%: 단순 형태(외쪽·박공)·숙련 시공 10~15%: 표준 (대부분 케이스) 15~20%: 모임지붕·복잡 형태·복잡한 경사 부족하면 추가 주문(배송비 ↑) 또는 색상 차이 발생 가능. 약간 여유 있게 권장." },
  ...
  { "q":"슁글 vs 기와 vs 금속 패널 — 어느 게 좋은가요?","a":"용도·예산·디자인 따라 다릅니다 (특정 추천 X — 본 도구는 일반 안내만): 아스팔트 슁글: 가장 흔함·저렴·시공 쉬움 (가성비) 시멘트/점토 기와: 무거움·내구성 ↑·전통 디자인 금속 패널: 경량·내구성 매우 ↑·모던 디자인·단열 약함 정확한 선택은 건축사·시공사와 상담. 본 도구는 면적 계산만." },
  { "q":"본 도구로 정확한 견적이 나오나요?","a":"일반 가이드 수준입니다. 실제 견적과 ±10~30% 차이 가능 — 이유: 도면 vs 실측 차이 (±5~10%) 자재 단가 ±30% (지역·시즌·구매처) 인건비·운반비·부속자재 (별도) 철거·기존 자재 처분 (별도) 복잡한 형태(천창·돌출) 추가 비용 정확한 견적은 시공사 실측 후 견적서 받으세요." },
  { "q":"본 도구의 자재 단가는 어디 기준인가요?","a":"2026년 한국 일반 가격 범위 — 특정 브랜드·매장 X · 일반 안내만. 광고법·정확성 회피. 정확한 가격은 단가 비교 계산기·실제 견적 확인." },
  { "q":"태양광 패널 설치 면적도 계산되나요?","a":"본 도구는 지붕 전체 면적만 계산. 태양광 패널 설치는: 남향 면적만 활용 (북향은 비효율) 경사·각도가 발전량에 영향 (별도 영역) 인버터·배선·구조 보강 필요 정확한 발전량·시공은 태양광 전문업체·한국에너지공단 상담." },
