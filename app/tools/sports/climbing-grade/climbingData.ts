...
export const ROUTE_ROWS: RouteRow[] = [
  ...
  { yds: '5.13a', french: '7c+/8a', uiaa: 'X-',   band: 4 },
  { yds: '5.13b', french: '8a',     uiaa: 'X-',   band: 4 },
  { yds: '5.13c', french: '8a+',    uiaa: 'X',    band: 4 },
  { yds: '5.13d', french: '8b',     uiaa: 'X+',   band: 4 },
