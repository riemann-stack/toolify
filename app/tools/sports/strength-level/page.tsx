...
const FAQ_LD = [
  ...
  { "q": "'3대 500'이면 어느 정도 수준인가요?", "a": "체중에 따라 다릅니다. 체중 70~80kg 남성 기준 3대 합 500kg은 체중의 6.25~7.1배로, 본 기준표(엘리트 = 6.0배 이상)로는 <strong>엘리트</strong> 구간입니다. 헬스 커뮤니티에서 흔히 '상급의 상징'처럼 불리지만, 체중 대비로 보면 그보다 높은 수준입니다. 반면 체중 100kg이라면 같은 500kg도 5.0배(상급 구간)로 상대 근력이 크게 달라집니다 — 그래서 Wilks·DOTS 점수를 함께 보는 것이 정확합니다." },
