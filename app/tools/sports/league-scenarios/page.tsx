...
export const metadata = buildMetadata({
  ...
  title: '축구 순위 경우의 수 계산기 — 32강 진출 조건·자력/타력',
  description: '월드컵·K리그·챔피언스리그 조별리그 잔여 경기 순위 경우의 수. 진출 확정·자력/타력 조건, 대회별 타이브레이커(골득실·승자승) 정확 반영. 베팅 아닌 순수 경우의 수 도구.',
  keywords: ['축구 경우의 수', '월드컵 32강 경우의 수', '월드컵 16강 경우의 수', '조별리그 순위', '진출 경우의 수', '자력 진출', '골득실 계산', 'K리그 순위 경우의 수', '챔피언스리그 진출', '승자승', '리그 순위 시나리오'],
})
