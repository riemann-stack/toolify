...
const FAQ_LD = [
  { "q":"1RM을 직접 측정해야 하나요?","a":"초·중급자는 추정치 사용을 권장합니다. 실제 1RM 시도는 부상 위험이 크고, 숙련된 스포터·올바른 폼이 필요합니다. 5회 수행 가능한 무게로 추정해도 오차는 2~5% 수준이라 충분히 신뢰할 만합니다." },
  { "q":"반복 수는 몇 회가 가장 정확한가요?","a":"3~6회 범위가 가장 정확합니다. 1~2회는 일시적 컨디션 영향이 크고, 10회 이상은 근지구력이 변수로 작용해 추정 오차가 커집니다. RPE 9~10 수준(AMRAP 또는 1회 여유)으로 수행해야 정확합니다." },
  { "q":"RPE를 매번 정확히 매기기 어려운데, 그냥 RPE 10으로 가정해도 될까요?","a":"RPE 10 기준이 본 도구의 기본값입니다. 정확히 RPE를 매길 자신이 없다면 RPE 보정을 끄고 그대로 입력하세요. 다만 &ldquo;끝나고 1~2회 더 가능했던 것 같다&rdquo;는 느낌이 들면 RPE 8~9로 보정해야 1RM이 과소 추정되지 않습니다." },
  { "q":"여성도 같은 공식을 써도 되나요?","a":"공식 자체는 성별과 무관하게 적용됩니다 (Epley·Brzycki 모두 마찬가지). 차이는 &ldquo;수준 평가&rdquo;에서만 나타나며, 본 도구는 성별을 선택하면 자동으로 여성 보정(체중 대비 약 70%)을 적용합니다. 또한 연령대를 함께 선택하면 더 정확합니다." },
  { "q":"40~50대인데 20대 기준으로 평가받으니 의욕이 떨어져요.","a":"매우 자연스러운 반응입니다. 본 도구는 연령 보정을 적용해 40대는 20대 대비 85%, 50대는 75%, 60대+는 65% 기준으로 평가합니다. 연령대를 정확히 선택하면 같은 무게가 한 단계 위 수준으로 평가될 수 있어요. 절대 무게보다 지난 분기 대비 본인의 변화를 보는 것이 더 중요합니다." },
    ...
    <ToolPage width={880} slug="/tools/sports/one-rm">
      ...
      <div style={{ ...card, padding: 0, overflowX: 'auto' }}>
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          ...
          <tbody>
            ...
            <tr><td style={cell}><strong style={{ color: 'var(--sky-500)' }}>75%</strong></td><td style={cell}>8~10회</td><td style={cell}>근비대</td><td style={cell}>90초</td></tr>
      ...
      <div style={{
        ...
        <ul style={{ paddingLeft: '20px', margin: 0 }}>
          <li><strong style={{ color: 'var(--red-600)' }}>워밍업 필수</strong> — 점진적으로 중량을 올려 5~6세트 워밍업 후 본 세트 진입.</li>
          <li><strong style={{ color: 'var(--red-600)' }}>스쿼트·벤치는 스포터·세이프티 필수</strong> — 90% 이상 시도 시 혼자 하지 마세요.</li>
          <li><strong style={{ color: 'var(--red-600)' }}>폼 붕괴 = 실패</strong> — 반복수보다 동작의 일관성이 중요합니다. 폼이 무너진 반복은 카운트에서 제외하세요.</li>
          <li><strong style={{ color: 'var(--red-600)' }}>통증은 즉시 중단</strong> — 관절·허리 통증은 부상 신호입니다. 운동 후 지속되면 전문의 상담.</li>
          <li><strong style={{ color: 'var(--red-600)' }}>초보자는 고반복 권장</strong> — 운동 경력 6개월 미만은 1RM 추정보다 8~12회 폼 익히기가 우선입니다.</li>
        </ul>
