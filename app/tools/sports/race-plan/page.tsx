...
const FAQ_LD = [
  ...
  { q: '왜 네거티브 스플릿을 권장하나요?',
    a: '대부분의 개인 최고기록이 후반을 더 빠르게 뛴 네거티브 스플릿에서 나옵니다. 초반 과속은 글리코겐 조기 고갈·후반 급감속(벽)의 가장 흔한 원인입니다. 본 도구의 네거티브 전략은 기준 페이스보다 앞을 살짝 느리게(약 +3%), 뒤를 빠르게(약 −3%) 나누고, 완주 시간은 기준 페이스로 고르게 달렸을 때와 같아지도록 맞춥니다.' },
