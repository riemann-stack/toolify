...
const FAQ_LD = [
  ...
  { "q":"VO₂max가 낮으면 무엇이 문제인가요?","a":"심혈관 사망률·전체 사망률의 가장 강력한 단일 예측 인자입니다. Mandsager 2018 (JAMA Network Open) 12만 명 연구: 심폐체력 하위 25%는 최상위(엘리트, 상위 약 2%)군보다 사망 위험이 약 5배(HR 5.04) 높았고, 이 차이는 흡연·당뇨·고혈압 같은 전통적 위험 인자와 비슷하거나 더 컸습니다. Kodama 2009 메타분석: 심폐체력 1 MET(3.5 mL/kg/min)가 높을수록 전체 사망 위험 약 13% ↓ VO₂max가 「매우 미흡」 단계라면 의사 상담 후 점진적 유산소 운동 시작 권장." },
  ...
  { "q":"마라톤 예상 시간은 어떻게 계산되나요?","a":"본 도구는 VO₂max ≈ Daniels VDOT로 보고 Daniels 공식으로 5km·10km·하프·풀코스 예상 기록을 간단 추정합니다 (예: VO₂max 50 → 5km 약 20분 / 풀 약 3시간 11분). 걷기 테스트(락포트)나 VO₂max 25 미만이면 오차가 커서 예측을 표시하지 않습니다. 실제 기록은 젖산 역치·러닝 이코노미·글리코겐 저장량·멘탈의 영향으로 ±10~15% 변동 가능한 참고용입니다. 실제 레이스 기록 기반의 정밀 예측(3공식 평균·환경/연령 보정·목표 역산)은 마라톤 기록 계산기를 이용하세요." }
]
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
        ...
        <section>
          ...
          <details style={faqDetails}>
            ...
            <div style={faqAnswer}>
              ...
              <ul style={{ paddingLeft: 18, marginTop: 8 }}>
                ...
                <li>이 차이는 흡연·당뇨·고혈압 같은 전통적 위험 인자와 비슷하거나 더 큼</li>
                <li>Kodama 2009 메타분석: 심폐체력 1 MET(3.5 mL/kg/min)가 높을수록 전체 사망 위험 약 13% ↓</li>
              </ul>
          ...
          <details style={faqDetails}>
            ...
            <div style={faqAnswer}>
              본 도구는 <strong style={{ color: 'var(--text)' }}>VO₂max ≈ Daniels VDOT</strong>로 보고 Daniels 공식으로 5km·10km·하프·풀코스 예상 기록을 간단 추정합니다 (예: VO₂max 50 → 5km 약 20분 / 풀 약 3시간 11분). 걷기 테스트(락포트)나 VO₂max 25 미만이면 오차가 커서 예측을 표시하지 않습니다.
