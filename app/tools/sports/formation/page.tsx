        ...
        <section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, minmax(0, 1fr))', gap: 8 }}>
            {[
              ...
              { name: '4-2-3-1', color: '#FFD93E', tag: '현대 표준', desc: '더블 볼란치 + 톱2.5. 2022 카타르 월드컵에서 가장 흔한 포메이션' },
          ...
          <div style={{ ...card, padding: 0, overflow: 'hidden' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              ...
              <tbody>
                ...
                <tr><td style={cell}><strong>9</strong></td><td style={cell}>중앙 공격수 (스트라이커)</td><td style={cell}>홀란드·음바페·조규성</td></tr>
