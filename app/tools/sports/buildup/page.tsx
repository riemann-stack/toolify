...
const FAQ_LD = [
  ...
  { "q":"본 도구와 인터벌 훈련 계산기 차이는?","a":"영역이 다릅니다. 📈 본 도구(빌드업): 오늘 한 번의 빌드업 세션 설계(거리·프로파일·페이스 곡선) · 🏃 인터벌 훈련 계산기: 인터벌 페이스·400m 랩·4~16주 풀 훈련 스케줄·한국 대회 매칭 · 🏅 마라톤 기록 예측: VDOT·기록 예측·환경 보정·목표 역산 · 🏃 러닝 페이스 계산기: 페이스↔시간 단순 변환" },
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '10px' }}>
        {[
          ...
          <div key={i} style={{ background: 'var(--bg2)', border: `1px solid ${p.color}44`, borderRadius: 'var(--radius-m)', padding: '14px 16px' }}>
            ...
            <p style={{ fontSize: '12px', fontFamily: 'var(--font-sans)', color: 'var(--text)', marginBottom: '8px' }}>{p.curve}</p>
