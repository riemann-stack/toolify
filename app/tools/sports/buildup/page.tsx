...
export const metadata = buildMetadata({
  ...
  description: '거리·페이스·구간·프로파일 → 구간별 페이스표 + 시각화·안전성 체크·워치 포맷·12개 프리셋.',
...
const FAQ_LD = [
  ...
  { "q":"5km 빌드업은 어떻게 짜야 하나요?","a":"짧은 거리는 적응 시간 부족 → 마지막 자극(sprint finish) 프로파일 추천. 1~4km: E 페이스 (편안) 마지막 1km: M 또는 T 페이스 본 도구의 🌱 회복 후 5km 가벼운 자극 프리셋 활용." },
  ...
  { "q":"안전성 체크가 빨강(🔴)이면 절대 하면 안 되나요?","a":"절대 금지가 아니라 강력 보류 권장. 본 도구는 일반 가이드 — 본인 한계 보장 X. 🔴가 나오면: 설계를 조정 (페이스·거리·구간) 프리셋(📋 탭)에서 본인 수준에 맞는 거 선택 VDOT(레이스 기록) 입력으로 정확도 ↑ 그래도 진행한다면 본인 책임. 통증·이상 시 즉시 중단." },
  { "q":"본 도구와 인터벌 훈련 계산기 차이는?","a":"영역이 다릅니다. 📈 본 도구 (빌드업): 오늘 한 번의 빌드업 세션 설계 (거리·프로파일·페이스 곡선) 🏃 인터벌 훈련 계산기: 인터벌 페이스 정확·400m 랩·4~16주 풀 훈련 스케줄·한국 대회 매칭 🏅 마라톤 기록 예측: VDOT·기록 예측·환경 보정·목표 역산 🏃 러닝 페이스 계산기: 페이스↔시간 단순 변환" },
  { "q":"자주 쓰는 빌드업 루틴은 어디 저장되나요?","a":"본인 브라우저(localStorage)에만 저장 — 서버 전송 X. 다른 기기 자동 동기화 X. 백업: 💾 내 루틴 탭 → 📊 CSV 다운로드 → Notion·Google Drive 등에 보관. 정기 백업(월 1회) 권장." }
]
