...
/* ACSM/AND/DC 2016 공동 성명 Table 2 기준: 90분 초과 경기 10~12 g/kg/24h(36~48시간),
   ...
   분기 기준은 종목이 아니라 '예상 경기 시간' — 아마추어 하프는 대부분 90분을 넘으므로 long에 해당한다. */
export const RACE_TYPES: RaceType[] = [
  {
    id: 'long', name: '90분 넘게 걸리는 경기',
    perKg: [10, 12], days: 2,
    desc: '풀코스·울트라, 완주에 90분 넘게 걸리는 하프 — 대회 전 36~48시간 집중 로딩',
  },
  {
    id: 'mid', name: '60~90분 경기',
    perKg: [8, 10], days: 1,
    desc: '90분 안에 끝내는 하프·15km 안팎 — 하루 전 충전',
  },
  {
    id: 'short', name: '60분 이내 경기',
    perKg: [7, 8], days: 1,
    desc: '10km·5km 등 — 풀 로딩 불필요, 전날 일반 충전이면 충분',
  },
]
