...
const FAQ_LD = [
              ...
              },
              {
                ...
                a: '본 도구의 [🏆 회원권 손익] 탭 활용. 일반 가이드:<br/>• <strong>연 24회+ 꾸준히</strong> 라운딩 → 회원 권장<br/>• <strong>연 12회 이하</strong> → 비회원 권장<br/>• 연 12~24회 → 회원권 시세·재무 안정성에 따라<br/>⚠️ 리스크: 골프장 부도(회원권 보호 X) / 시세 하락(-30~50%) / 매각 어려움(유동성 ↓) / 본인 라운딩 빈도 변화. 투자 결정 전 회원권 시세(에이스회원권·동아회원권 등 회원권 거래소 시세)와 골프장 재무 상태 확인 + 변호사·회계사 상담 권장.',
              },
              {
