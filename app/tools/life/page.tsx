...
export const metadata: Metadata = {
  title: '생활·재미 도구 모음 | Youtil',
  description: '로또 번호 생성기, 랜덤 추첨기, 사다리타기, 더치페이 계산기 등 생활에서 바로 쓰는 무료 도구 모음.',
}
...
const tools = [
  ...
  { href: '/tools/life/dutch',  icon: '🍻', name: '더치페이(N빵) 계산기',   desc: '술값 따로, 단위 올림 옵션 지원' },
]
