...
const FAQ_LD = [
  ...
  { "q":"명품 가방 직구 vs 한국 면세점?","a":"유럽 명품 가방 €1,500 (€1=1,500원 가정 시 약 225만원) 기준: • 직구 (Matchesfashion): 225만 + 관세 8% (약 18만) + 개소세·교육세 (약 11만, 200만 초과분 20% + 교육세 30%) + 부가세 (약 25만) = 약 280만원 • 한국 백화점: 약 350~400만원 • 한국 면세점: 약 240~280만원 → 직구가 백화점 대비 약 25~30% 절감, 면세점과 비슷. 단 A/S·정품 인증은 백화점이 우월. 명품 직구는 정식 매장 영수증 보관 필수." },
    ...
    <div style={{ maxWidth: '880px', margin: '0 auto', padding: '60px 24px 80px' }}>
      ...
      <div style={{ background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 14, padding: '16px 20px', marginTop: 28, fontSize: 13, color: 'var(--muted)', lineHeight: 1.8 }}>
        ...
        <p style={{ margin: '8px 0 0', fontSize: 12 }}>
          기준일: <strong style={{ color: 'var(--text)' }}>2026년 9월</strong> · 마지막 검토: <strong style={{ color: 'var(--text)' }}>2026-09-26</strong> · 관세·면세·합산 제도는 수시로 바뀌므로 통관 전 공식 출처를 확인하세요.
        </p>
      </div>
      ...
      <div style={card}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
          ...
          <div style={{ background: 'var(--bg3)', borderTop: '3px solid #DB2777', borderRadius: 10, padding: '14px 16px' }}>
            ...
            <p style={{ fontSize: 12, color: 'var(--muted)', lineHeight: 1.8, margin: 0 }}>
              ...
              • 단, 배제대상도 물품가격 $150 이하·자가사용이면 관·부가세 면제 가능 (주류·담배 제외, 미국발도 $150)
            </p>
          </div>
        </div>
        <p style={{ marginTop: 12, fontSize: 12, color: 'var(--muted)', lineHeight: 1.7 }}>
        ...
        <p style={{ marginTop: 8, fontSize: 12, color: 'var(--muted)', lineHeight: 1.7 }}>
          ※ <strong style={{ color: 'var(--text)' }}>소액면세는 통관 절차와 별개</strong>입니다. 배제대상 품목(건강기능식품·식품 등)도 자가사용·물품가격 $150 이하면 관·부가세는 면제될 수 있고, 단지 <strong>일반(간이)신고</strong> 절차를 거칩니다. 다만 <strong>미국 $200 한도는 목록통관 물품에만</strong> 적용되므로, 수입신고 대상인 영양제·식품은 미국발이라도 $150을 넘으면 과세됩니다. <strong>주류·담배 등은 한도와 무관하게 과세</strong>됩니다. 면세 한도는 운임·보험료를 <strong>제외한 물품가격</strong> 기준입니다.
        </p>
      </div>
      ...
      <div style={card}>
        <p style={{ fontSize: 14, color: 'var(--text)', lineHeight: 1.85, marginTop: 0 }}>
          ...
          이 차이는 미국 직구의 가장 큰 장점입니다. 단 $200 한도는 목록통관 물품에 적용되고, 건강기능식품·식품처럼 수입신고하는 물품은 미국발도 $150입니다.
        </p>
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          유럽 명품 가방 €1,500 (€1=1,500원 가정 시 약 225만원) 기준:<br />
