...
const FAQ_LD = [
  ...
  { "q":"알리·테무는 왜 거의 무세금?","a":"중국 직구 면세 한도 $150 = 약 21만원. 알리·테무 대부분 상품이 저가($5~30)라 한 건당 면세 한도에 한참 못 미칩니다. • 1건 주문 = 보통 $20~50 = 면세 • 단 같은 날 같은 쇼핑몰에서 여러 건 구매 시 합산되어 과세될 수 있음 • 가구·가전 등 고가는 과세 (예: 청소기 $200 → 과세) ⚠️ 최근 알리·테무 직구 폭증으로 관세청이 통관·검사를 강화하는 추세." },
