...
const FAQ_LD = [
  ...
  { "q":"항공권은 언제 사야 가장 싼가?","a":"일반적인 가이드: • 일본·동남아: 출발 2~3개월 전 • 미국·유럽: 출발 3~5개월 전 • 오세아니아: 출발 4~6개월 전 • 비수기: 4·5·9·10·11월 (한국 명절·연휴 외) • 요일: 화·수요일 새벽 출발이 가장 저렴 • 비교 사이트: 스카이스캐너·구글 플라이트·카약·트립닷컴 ⚠️ 여름 휴가·설·추석은 무조건 비싸므로 6개월 전 예매 권장." },
  ...
  { "q":"환전 vs 카드 vs 트래블월렛 어느 게 유리?","a":"용도별 다름: • 현금 환전: 약 1~3% 수수료. 시장·소액·팁용. 한국 시중은행·환전소 비교 (서울역 외환·인천공항 환전소). • 해외 신용카드 (마스터·비자): 약 1.5~2% 수수료 + 1.1% 해외이용. 큰 결제·식당·호텔. • 트래블월렛·트래블로그·SOL트래블 ⭐ 수수료 0% 환전, 체크카드처럼 사용. 최근 가장 인기. • 현지 ATM 출금: 일 수수료 + 환전 손실 — 비추. 추천 조합: 트래블월렛·트래블로그 + 일부 현금 + 해외 신용카드 1장." },
...
export default function TravelBudgetPage() {
  return (
    <div style={{ maxWidth: '880px', margin: '0 auto', padding: '60px 24px 80px' }}>
      ...
      {/* 2. 도시별 1박 평균 */}
      <h2 style={sectionTitle}>🌆 도시별 1박 평균 비용 (한국 인기 18 도시)</h2>
      <div style={{ ...card, padding: 0, overflow: 'hidden' }}>
        ...
        <div style={{ padding: '12px 14px', borderTop: '1px solid var(--border)', fontSize: 12, color: 'var(--muted)', lineHeight: 1.7, background: 'var(--bg3)' }}>
          ※ <strong style={{ color: 'var(--text)' }}>1박 1인 기준</strong>, 숙박+식비+교통/투어 합계. 항공권은 별도.
        </div>
      </div>
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          ...
          • <strong>요일</strong>: 화·수요일 새벽 출발이 가장 저렴<br />
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          ...
          • <strong>트래블월렛·트래블로그·SOL트래블</strong> ⭐ <strong>수수료 0%</strong> 환전, 체크카드처럼 사용. 최근 가장 인기.<br />
