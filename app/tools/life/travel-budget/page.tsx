...
const FAQ_LD = [
  { "q":"일본 5박 6일 여행 비용 평균은?","a":"도쿄·오사카 6일(5박), 1인·비수기·LCC 기준으로 이 계산기의 자동 채우기 값입니다(쇼핑·입장권·통신·보험 포함, 예비비 제외). • 🎒 배낭: 항공 25만 + 숙박·식비·교통 142만 + 쇼핑 등 43만 = 약 210만원 • 🧳 중간: 항공 25만 + 216만 + 85만 = 약 326만원 • 🥂 럭셔리: 항공 25만 + 425만 + 209만 = 약 659만원. 풀서비스 항공이면 15만원가량 늘고, 성수기엔 항공권과 숙박비가 올라 중간 스타일이 약 370만원이 됩니다. 후쿠오카·삿포로는 약 10% 저렴합니다. 쇼핑 비중이 커서 본인 계획에 맞게 항목을 고쳐 계산하세요." },
  { "q":"동남아 1주일 예산은 얼마면 충분?","a":"8일(7박), 1인·중간 스타일·비수기·LCC 기준 자동 채우기 값입니다(쇼핑·입장권·통신·보험 포함, 예비비 제외). • 🇹🇭 방콕·푸켓: 약 313만원 • 🇻🇳 다낭·하노이: 약 297만원 • 🇵🇭 세부·보라카이: 약 351만원 • 🇮🇩 발리: 약 320만원. 배낭 스타일은 중간의 60% 안팎, 럭셔리는 2배 수준입니다. 성수기에 풀서비스 항공을 타면 같은 일정이 30% 넘게 비싸집니다." },
  { "q":"유럽 자유여행 보통 얼마?","a":"1인·중간 스타일·비수기·풀서비스 항공(왕복 120만원) 기준 자동 채우기 값입니다(쇼핑·입장권·통신·보험 포함, 예비비 제외). • 🇫🇷 파리 7일(6박): 약 751만원 • 🇮🇹 이탈리아 10일(9박): 약 929만원 • 🇪🇸 스페인 7일(6박): 약 625만원 • 🇬🇧 영국 7일(6박): 약 891만원. 유럽은 숙박·교통비가 커서 현지 체류비 비중이 높습니다. LCC·경유편을 쓰면 항공권에서 30만원가량 줄고, 성수기엔 20% 안팎 더 듭니다. 다국가 일정은 유레일·LCC를 활용해 보세요." },
  ...
  return (
    <div style={{ maxWidth: '880px', margin: '0 auto', padding: '60px 24px 80px' }}>
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          도쿄·오사카 6일(5박), 1인·비수기·LCC 기준으로 이 계산기의 자동 채우기 값입니다 (쇼핑·입장권·통신·보험 포함, 예비비 제외).<br />
          • <strong>🎒 배낭</strong>: 항공 25만 + 숙박·식비·교통 142만 + 쇼핑 등 43만 = 약 <strong>210만원</strong><br />
          • <strong>🧳 중간</strong>: 항공 25만 + 216만 + 85만 = 약 <strong>326만원</strong><br />
          • <strong>🥂 럭셔리</strong>: 항공 25만 + 425만 + 209만 = 약 <strong>659만원</strong><br />
          풀서비스 항공이면 15만원가량 늘고, 성수기엔 항공권과 숙박비가 올라 중간 스타일이 약 370만원이 됩니다. 후쿠오카·삿포로는 약 10% 저렴합니다.
          쇼핑 비중이 커서 본인 계획에 맞게 항목을 고쳐 계산하세요.
        </p>
      </details>
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          8일(7박), 1인·중간 스타일·비수기·LCC 기준 자동 채우기 값입니다 (쇼핑·입장권·통신·보험 포함, 예비비 제외).<br />
          • <strong>🇹🇭 방콕·푸켓</strong>: 약 <strong>313만원</strong><br />
          ...
          배낭 스타일은 중간의 60% 안팎, 럭셔리는 2배 수준입니다. 성수기에 풀서비스 항공을 타면 같은 일정이 30% 넘게 비싸집니다.
        </p>
      </details>
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          1인·중간 스타일·비수기·풀서비스 항공(왕복 120만원) 기준 자동 채우기 값입니다 (쇼핑·입장권·통신·보험 포함, 예비비 제외).<br />
          • <strong>🇫🇷 파리 7일(6박)</strong>: 약 <strong>751만원</strong><br />
          • <strong>🇮🇹 이탈리아 10일(9박)</strong>: 약 <strong>929만원</strong><br />
          • <strong>🇪🇸 스페인 7일(6박)</strong>: 약 <strong>625만원</strong><br />
          • <strong>🇬🇧 영국 7일(6박)</strong>: 약 <strong>891만원</strong><br />
          유럽은 숙박·교통비가 커서 현지 체류비 비중이 높습니다. LCC·경유편을 쓰면 항공권에서 30만원가량 줄고, 성수기엔 20% 안팎 더 듭니다. 다국가 일정은 유레일·LCC를 활용해 보세요.
        </p>
      </details>
