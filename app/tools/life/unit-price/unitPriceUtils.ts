...
export const CONSUMPTION_OPTIONS = [
  { value: 100, label: '100% (다 씀)',     desc: '매일 사용 — 생수·우유·티슈' },
  { value: 75,  label: '75% (자주 씀)',    desc: '자주 사용 — 샴푸·세제·화장품' },
  { value: 50,  label: '50% (가끔 씀)',    desc: '가끔 사용 — 소스·조미료' },
  { value: 25,  label: '25% (별로 안 씀)', desc: '시즌·이벤트용 — 거의 안 씀' },
]
