...
const FAQ_LD = [
  ...
  { "q":"세탁 가능하면 옷을 얼마나 줄일 수 있나요?","a":"• 매일 세탁: 옷 1/3 가능 (5박 → 2~3벌) • 3~4일에 1회 세탁: 옷 절반 가능 (5박 → 3벌) • 세탁 불가: 일수만큼 (5박 → 5벌) 호텔·에어비앤비 예약 시 세탁기 유무 확인이 짐 무게에 큰 영향. 동남아 호텔 세탁은 1벌 1~3천원으로 매우 저렴해 자주 활용 가능. 유럽은 1벌 5~10천원으로 비싸므로 코인세탁소(Laundromat) 활용 추천." },
