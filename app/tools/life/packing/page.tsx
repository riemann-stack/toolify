...
const FAQ_LD = [
  ...
  { "q":"캐리어 기내 vs 위탁 어떻게 결정?","a":"• 3박 이하 + 7kg 미만: 기내 휴대 (시간 절약·분실 0) • 4~7박: 24인치 위탁 (일반) • 7박+ 또는 가족: 28인치 위탁 기내 장점: • 공항 대기 시간 0 • 분실·지연 위험 0 • 추가 요금 X (일부 LCC 제외) 위탁 장점: • 액체·기내 금지품 자유 (액체 100ml 룰 X) • 무게 한도 큼 (15~23kg) • 짐 무게 어깨 부담 X 출장·짧은 여행은 기내, 가족·휴양은 위탁 권장." },
  ...
  { "q":"가족 여행 짐 어떻게 분배?","a":"4인 가족 7박 기준: • 부부 28인치 캐리어 1개 (위탁 23kg) — 부모 옷·공동 짐 • 큰아이 24인치 — 본인 옷 + 학용품 • 작은아이 기내 캐리어 — 본인 옷·장난감 • 공동 백팩 1개 — 카메라·태블릿·여권·비상약 전략: • 옷은 1캐리어에 모음 (분실 시 분산 위험) • 아기 동반 시 추가 가방 (기저귀·이유식·아기띠) • 공항에서 가족 4인이면 카트 + 짐 분산 (한 사람에게 몰리지 않게)" },
  { "q":"골프·등산 패킹 차이?","a":"⛳ 골프투어 (4박): • 골프복 4세트 (라운드별) • 골프 장갑 2~3개 (땀에 젖음) • 골프화 + 일반화 • 골프공·티 (현지 비싸요) • 비옷·우산 (스콜 대비) • 골프백 별도 위탁 (23kg) 🎒 등산·캠핑 (3박): • 등산복 2세트 (땀) • 등산화·트래킹화 • 방수 자켓·바람막이 • 모기·벌레 퇴치제 • 헤드랜턴 • 응급 키트 (찰과상·뱀·벌) 공통: 운동복 + 운동화 + 비상약 필수. 시나리오 탭에서 자동 입력 가능." },
