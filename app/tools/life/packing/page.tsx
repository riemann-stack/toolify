...
const FAQ_LD = [
  { "q":"5박 6일 여행에 옷 몇 벌이 적당한가요?","a":"중간 활동·환절기 기준 1인: • 👕 상의: 4~6벌 (세탁 가능 시 3~4벌) • 👖 하의: 2~3벌 (3일에 1벌) • 🩲 속옷·양말: 6세트 (일수+1) • 🧥 아우터: 1~2벌 (날씨에 따라) • 👟 신발: 1~2족 여름은 -1벌, 겨울은 +1벌, 격식·운동복 추가 시 +1세트씩. 본 도구의 옷 계산 탭에서 본인 조건으로 정확히 계산." },
    ...
    <div style={{ maxWidth: '880px', margin: '0 auto', padding: '60px 24px 80px' }}>
      ...
      <div style={{ ...card, padding: 0, overflow: 'hidden' }}>
        ...
        <div style={{ padding: '12px 14px', borderTop: '1px solid var(--border)', fontSize: 12, color: 'var(--muted)', lineHeight: 1.7, background: 'var(--bg3)' }}>
          ※ <strong style={{ color: 'var(--text)' }}>중간 활동·환절기 1인 기준</strong>. 세탁 가능하면 -30~50%, 한여름·운동·격식 일정은 +20~30%. 표의 총 무게는 의류·세면 등 <strong>내용물</strong> 기준이며, 위 계산기의 <strong>‘1인 총 무게’</strong>는 캐리어 자체(2.5~4.5kg)까지 포함합니다.
        </div>
      </div>
