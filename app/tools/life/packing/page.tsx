...
const FAQ_LD = [
  { "q":"5박 6일 여행에 옷 몇 벌이 적당한가요?","a":"도시 관광·환절기, 세탁 없이 1인 기준(계산기 최소~넉넉 버전): • 👕 상의: 6~7벌 (코인·호텔 세탁 시 3~4벌) • 👖 하의: 2~3벌 (3일에 1벌) • 🩲 속옷·양말: 7~8세트 • 🧥 아우터: 1~2벌 (날씨에 따라) • 👟 신발: 1~2족. 여름엔 땀 때문에 상의·속옷이 30%쯤 늘고, 겨울엔 아우터가 늘어납니다. 격식·운동복이 필요하면 따로 더하세요. 옷 계산 탭에서 본인 조건으로 계산할 수 있습니다." },
  { "q":"한 달 살기는 몇 벌 가져가야?","a":"매일 세탁이 가능하다면 옷은 7~10벌이면 충분합니다. 핵심은 세탁: • 상의 7~10벌, 하의 4~5벌, 속옷·양말 7~10세트 • 빨래비누·세제 1~2개 + 빨랫줄 (호스텔) • 코인세탁기·에어비앤비 세탁기 활용 (3~4일에 1회) • 현지에서 옷 구입도 좋은 옵션 (동남아·유럽 가성비) 한 달 살기는 옷보다 필수품(약·전자기기·서류)가 더 중요. 가벼운 캐리어 + 큰 보조가방 권장." },
  { "q":"세탁 가능하면 옷을 얼마나 줄일 수 있나요?","a":"• 매일 세탁: 옷 1/3 가능 (5박 → 2~3벌) • 3~4일에 1회 세탁: 옷 절반 가능 (5박 → 3벌) • 세탁 불가: 일수만큼 (5박 → 5벌) 호텔·에어비앤비 예약 시 세탁기 유무 확인이 짐 무게에 큰 영향. 동남아 호텔 세탁은 1벌 1~3천원으로 매우 저렴해 자주 활용 가능. 유럽은 1벌 5천~1만원으로 비싸므로 코인세탁소(Laundromat) 활용 추천." },
  { "q":"여름 vs 겨울 패킹 차이는?","a":"• 여름: 옷이 가벼움 → 캐리어 작게 가능. 단 땀으로 자주 갈아입어 옷 수는 +30%. 수영복·모자·선크림 필수 • 겨울: 옷이 무겁고 부피 큼 → 캐리어 1단계 큼. 패딩·니트·내복으로 압축팩 효과 큼 • 아우터 차이: 여름 1벌(가벼움) vs 겨울 2~3벌(부피 大) • 신발 차이: 여름 슬리퍼·운동화, 겨울 부츠 (무거움) 겨울 여행은 입고 출국 + 위탁 조합으로 무게 분산. 패딩·코트는 입고 비행기 탑승." },
  { "q":"캐리어 기내 vs 위탁 어떻게 결정?","a":"• 캐리어 포함 10kg 이하: 기내 휴대 (세탁 없이 대략 5박까지, 입고 타는 아우터·신발 제외). 기내 한도가 7kg인 해외 LCC는 미리 확인 • 10~15kg: 24인치 위탁 (1~2주) • 그 이상 또는 가족 짐 합치기: 28인치 위탁 기내 장점: • 공항 대기 시간 0 • 분실·지연 위험 0 • 추가 요금 X (일부 LCC 제외) 위탁 장점: • 액체 100ml 룰 미적용 (큰 화장품·주류 가능) • 무게 한도 큼 (15~23kg) • 어깨 부담 X ⚠️ 위탁 금지품 주의: 보조배터리·여분 리튬배터리·전자담배·라이터는 기내 휴대만 가능하고 위탁이 금지됩니다. 2026년 4월부터 보조배터리 규정이 강화돼 단자 절연·100Wh 초과 제한·좌석 보관/기내 사용 제한 등이 적용됩니다 (항공사·국가별 상이, 탑승 전 확인). 출장·짧은 여행은 기내, 가족·휴양은 위탁 권장." },
  { "q":"압축팩 효과는?","a":"부피 -30~50% 가능 (무게는 동일). 특히 효과적인 항목: • 패딩·플리스: -50% (가장 큼) • 니트·이불: -40% • 일반 의류: -20~30% • 속옷·양말: -30% 종류: • 롤업 압축팩 (진공 X, 손으로 말기): 다이소 1~3천원, 가성비 ⭐ • 진공 압축팩 + 펌프: 더 강력하지만 부피 큰 펌프 필요 ⚠️ 단점: 옷이 구겨짐 (도착 후 다림질 필요), 캐리어가 작아져도 무게 한도 초과 가능." },
  { "q":"신발 몇 켤레 가져가야?","a":"최소 1족 + 추가 1~2족 (활동 따라): • 도시 관광: 편한 운동화 1족 (매일 1만보+) • 휴양: 운동화 + 슬리퍼·아쿠아슈즈 • 비치: 슬리퍼·샌들 + 아쿠아슈즈 • 등산: 트레킹화 + 운동화 • 격식·디너: + 구두·드레스슈즈 • 골프: 골프화 + 일반화 신발은 부피·무게 큼 → 가능하면 입고 출국 + 1족만 추가가 최선. 캐리어 바닥에 신발 → 공간 비우는 핵심." },
  { "q":"가족 여행 짐 어떻게 분배?","a":"4인 가족 7박 기준: • 부부 28인치 캐리어 1개 (위탁 23kg) — 부모 옷·공동 짐 • 큰아이 24인치 — 본인 옷 + 학용품 • 작은아이 기내 캐리어 — 본인 옷·장난감 • 공동 백팩 1개 — 카메라·태블릿·여권·비상약 전략: • 각자 1~2일치 옷·필수품은 서로 다른 가방에 나눠 담기 — 위탁 1개를 분실·지연당해도 온 가족이 버틸 수 있습니다 (한 캐리어에 몰면 단일 실패점) • 귀중품·약·서류·전자기기는 기내 휴대 • 아기 동반 시 추가 가방 (기저귀·이유식·아기띠) • 공항에서 가족 4인이면 카트 + 짐 분산 (한 사람에게 몰리지 않게)" },
  { "q":"골프·등산 패킹 차이?","a":"⛳ 골프투어 (3박 4일): • 골프복 4세트 (라운드별) • 골프 장갑 2~3개 (땀에 젖음) • 골프화 + 일반화 • 골프공·티 (현지 비싸요) • 비옷·우산 (스콜 대비) • 골프백 별도 위탁 (23kg) 🎒 등산·캠핑 (2박 3일): • 등산복 2세트 (땀) • 등산화·트래킹화 • 방수 자켓·바람막이 • 모기·벌레 퇴치제 • 헤드랜턴 • 응급 키트 (찰과상·뱀·벌) 공통: 운동복 + 운동화 + 비상약 필수. 시나리오 탭에서 자동 입력 가능." },
  { "q":"아기 동반 여행 추가 항목?","a":"아기 짐만 별도 캐리어가 필요할 정도입니다: • 기저귀: 1일 5~7장 × 일수 + 여유분 (현지 가격·브랜드 다름) • 물티슈: 충분히 • 분유·이유식: 현지 어려움 — 충분히 • 젖병·이유식 도구 + 보온병 • 아기띠 + 휴대용 유모차 (기내 무료) • 담요·블랭킷·인형 • 아기 옷: 1일 2~3벌 (음식 흘림·기저귀 누수) • 아기 약·체온계·해열제 • 장난감·이어폰 (기내 칭얼이 대비) • 카시트: 렌터카 시 (동남아 X 多) 시나리오 탭의 아기 동반 가족여행 자동 입력 활용." }
]
    ...
    <ToolPage width={880} slug="/tools/life/packing">
      ...
      <div style={{ ...card, padding: 0, overflow: 'hidden' }}>
        <div className="tableScroll">
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13, minWidth: 480 }}>
            ...
            <tbody>
              {[
                ['3박',  '4~5벌', '2~3벌', '5~6세트', '~6kg'],
                ['5박',  '6~7벌', '2~3벌', '7~8세트', '~6.5kg'],
                ['7박',  '8~9벌', '3~4벌', '9~10세트', '~7.5kg'],
                ['10박', '11~12벌', '4~5벌', '12~13세트', '~9kg'],
                ['14박 (2주)', '8~9벌 (3~4일마다 세탁)', '3~4벌', '9~10세트', '~7.5kg'],
                ['30박 (한 달)', '11~12벌 (매일 세탁)', '4~5벌', '12~13세트', '~9kg'],
              ].map((row, i) => (
        ...
        <div style={{ padding: '12px 14px', borderTop: '1px solid var(--border)', fontSize: 12, color: 'var(--muted)', lineHeight: 1.7, background: 'var(--bg3)' }}>
          ※ <strong style={{ color: 'var(--text)' }}>도시 관광·환절기 1인, 위 계산기의 최소~넉넉 버전</strong> 결과입니다 (3~10박은 세탁 없음). 한여름·운동·격식 일정은 더 늘어납니다. 총 무게는 넉넉한 버전의 <strong>내용물</strong>(세면·전자 등 2.5kg 포함, 입고 타는 아우터 1벌·신발 1켤레 제외) 기준이며, 계산기의 <strong>‘1인 총 무게’</strong>는 캐리어 자체(2.5~4.5kg)까지 더한 값입니다.
        </div>
      </div>
      ...
      <div style={card}>
        <ul style={{ paddingLeft: 18, margin: 0, fontSize: 13, color: 'var(--muted)', lineHeight: 1.95 }}>
          ...
          <li><strong style={{ color: 'var(--text)' }}>💡 호텔 세탁 가격</strong>: 동남아 1벌 1~3천원, 유럽·미국 1벌 5천~1만원 (코인세탁기가 가성비)</li>
        </ul>
      </div>
      ...
      <div style={{ ...card, padding: 0, overflow: 'hidden' }}>
        <div className="tableScroll">
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13, minWidth: 480 }}>
            ...
            <tbody>
              {[
                ['🎒 백팩·기내 휴대 (20인치)', '~ 55cm', '~ 7~10kg', '1~5박 / 출장·짐 적은 여행'],
                ['🧳 24인치 (중형)',           '~ 65cm', '~ 15kg', '5~14박 / 일반 자유여행'],
                ['🧳 28인치 (대형)',           '~ 75cm', '~ 23kg', '2주~ / 가족·장기 여행'],
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          도시 관광·환절기, 세탁 없이 1인 기준 (계산기 최소~넉넉 버전):<br />
          • <strong>👕 상의</strong>: 6~7벌 (코인·호텔 세탁 시 3~4벌)<br />
          • <strong>👖 하의</strong>: 2~3벌 (3일에 1벌)<br />
          • <strong>🩲 속옷·양말</strong>: 7~8세트<br />
          • <strong>🧥 아우터</strong>: 1~2벌 (날씨에 따라)<br />
          • <strong>👟 신발</strong>: 1~2족<br />
          여름엔 땀 때문에 상의·속옷이 30%쯤 늘고, 겨울엔 아우터가 늘어납니다. 격식·운동복이 필요하면 따로 더하세요.
          <strong>옷 계산 탭</strong>에서 본인 조건으로 계산할 수 있습니다.
        </p>
      </details>
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          ...
          유럽은 1벌 5천~1만원으로 비싸므로 <strong>코인세탁소(Laundromat)</strong> 활용 추천.
        </p>
      </details>
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          • <strong>캐리어 포함 10kg 이하</strong>: 기내 휴대 (세탁 없이 대략 5박까지, 입고 타는 아우터·신발 제외). 기내 한도가 7kg인 해외 LCC는 미리 확인<br />
          • <strong>10~15kg</strong>: 24인치 위탁 (1~2주)<br />
          • <strong>그 이상 또는 가족 짐 합치기</strong>: 28인치 위탁<br />
          기내 장점:<br />
          • 공항 대기 시간 0<br />
          • 분실·지연 위험 0<br />
          • 추가 요금 X (일부 LCC 제외)<br />
          위탁 장점:<br />
          • <strong>액체 100ml 룰 미적용</strong> (큰 화장품·주류 가능)<br />
          • 무게 한도 큼 (15~23kg)<br />
          • 어깨 부담 X<br />
          ⚠️ <strong style={{ color: 'var(--text)' }}>위탁 금지품 주의</strong>: 보조배터리·여분 리튬배터리·전자담배·라이터는 <strong>기내 휴대만</strong> 가능하고 위탁이 금지됩니다.
          2026년 4월부터 <strong>보조배터리 규정이 강화</strong>돼 단자 절연·100Wh 초과 제한·좌석 보관/기내 사용 제한 등이 적용됩니다 (항공사·국가별 상이, 탑승 전 확인).<br />
      ...
      <details style={faqDetails}>
        ...
        <p style={faqAnswer}>
          ...
          전략:<br />
          • <strong>각자 1~2일치 옷·필수품은 서로 다른 가방에 분산</strong> — 위탁 1개를 분실·지연당해도 온 가족이 버틸 수 있어요 (한 캐리어에 다 몰면 단일 실패점)<br />
          • <strong>귀중품·약·서류·전자기기</strong>는 기내 휴대<br />
