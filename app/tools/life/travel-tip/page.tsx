...
const FAQ_LD = [
  ...
  { "q":"우버·택시는 팁 필수인가?","a":"• 🇺🇸 미국·🇨🇦 캐나다: 15~20% 필수. 우버 앱에서 도착 후 입력 가능 (잊지 말 것) • 🇪🇺 유럽: 잔돈 반올림 (€10.50 → €11 등) 또는 5% • 🇯🇵 일본: X (오히려 거절) • 🇸🇬 싱가포르·🇭🇰 홍콩: X 또는 잔돈 • 🇹🇭 태국·🇻🇳 베트남: 미터 사용 시 잔돈만, 흥정 가격엔 별도 X 짐을 트렁크에 실어주거나 특별 도움 시 추가 $1~5." },
  ...
  { "q":"팁을 안 주면 어떻게 되나요?","a":"국가별로 결과가 매우 다릅니다: • 🇺🇸 미국: 큰 결례. 직원이 따라 나와 항의할 수도 (인종차별로 오해될 위험). 다음 방문 시 서비스 X • 🇪🇺 유럽: 무례하게 보이지만 큰 문제 X • 🇯🇵 일본·🇨🇳 중국: 오히려 안 주는 게 정상 • 🇹🇭 동남아: 서운해 하지만 강제 X 미국은 직원 시급이 매우 낮고 (팁 포함 시급) 팁이 생계 — 안 주면 직원 임금이 깎이는 구조. 그래서 미국·캐나다 식당·우버는 예산에 팁을 미리 포함해 계산하는 것이 마음 편합니다." }
]
