      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
        ...
        <section>
          ...
          <p style={{ fontSize: '13px', color: 'var(--muted)', lineHeight: 1.85, marginTop: '8px' }}>
            정리하면 사다리의 공정성은 <strong style={{ color: 'var(--text)' }}>가로줄 수에 따라 달라집니다</strong> — 가로줄이 충분히 많아지면 균등에 접근하지만 수렴이 느립니다. 사다리를 쓴다면 가로줄을 넉넉히 추가하고 당첨 위치를 아무도 모르는 상태로 정하는 것이 좋습니다. 반면 본 도구의 순서·팀 추첨은 사다리 구조를 거치지 않고 균등 셔플로 직접 뽑고, 룰렛은 가중치에 비례한 확률로 직접 추첨하기 때문에 구조적 편향이 없습니다. youtil 사다리타기 도구도 도착 순열을 먼저 균등하게 뽑은 뒤 그에 맞춰 가로줄을 배치하므로 이 편향이 없습니다.
          </p>
        </section>
