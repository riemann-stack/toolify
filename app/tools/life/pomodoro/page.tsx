              ...
              <tbody>
                {[
                  ...
                  <tr key={i} style={{ borderBottom: '1px solid var(--border)', background: i % 2 === 0 ? 'transparent' : 'var(--bg2)' }}>
                    ...
                    <td style={{ padding: '10px 12px', textAlign: 'right', color: 'var(--sky-500)', fontFamily: 'var(--font-sans)' }}>{r.f}분</td>
                    <td style={{ padding: '10px 12px', textAlign: 'right', color: 'var(--cyan-600)', fontFamily: 'var(--font-sans)' }}>{r.s}분</td>
                    <td style={{ padding: '10px 12px', textAlign: 'right', color: 'var(--orange-600)', fontFamily: 'var(--font-sans)' }}>{r.l}분</td>
