...
const FAQ_LD = [
              ...
              { q: '진행자가 아무 문이나 무작위로 열면 어떻게 되나요?',
                a: '그 경우 바꾸나 유지나 50:50이 됩니다. 몬티홀 문제의 핵심은 &ldquo;진행자가 자동차 위치를 알고 의도적으로 염소 문을 연다&rdquo;는 조건입니다. 진행자가 실수로 자동차를 열어버릴 수 있다면 확률 구조가 완전히 달라집니다. 본 도구의 [자동 시뮬레이션] 탭에서 [🟡 무작위 공개] 변형으로 직접 확인 가능.' },
        ...
        <div>
          ...
          <div style={{ overflowX: 'auto' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px' }}>
              <thead>
                <tr style={{ borderBottom: '1px solid var(--border)' }}>
                  <th scope="col" style={{ padding: '10px 12px', textAlign: 'left',  color: 'var(--muted)', fontWeight: 500 }}>문 갯수</th>
        ...
        <div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            {[
              ...
              { color: '#FFD93E', emoji: '🟡', name: '무작위 공개 (= 몬티 폴)',
