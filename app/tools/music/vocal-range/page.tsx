  ...
  return (
    <div style={{ maxWidth: '760px', margin: '0 auto', padding: '60px 24px 80px' }}>
      ...
      <div style={{ marginTop: '64px', borderTop: '1px solid var(--border)', paddingTop: '40px', display: 'flex', flexDirection: 'column', gap: '40px' }}>
        ...
        {/* 1. 보컬 음역대란 */}
        <section>
          <h2 style={{ fontFamily: 'Syne, sans-serif', fontSize: '20px', fontWeight: 700, marginBottom: '12px' }}>보컬 음역대란?</h2>
        ...
        {/* 2. 음역대 분류 */}
        <section>
          <h2 style={{ fontFamily: 'Syne, sans-serif', fontSize: '20px', fontWeight: 700, marginBottom: '12px' }}>음역대 8단계 분류</h2>
              ...
              <tbody>
                {[
                  ...
                  <tr key={i} style={{ borderBottom: '1px solid var(--border)', background: i % 2 === 0 ? 'transparent' : 'var(--bg2)' }}>
                    ...
                    <td style={{ padding: '10px 12px', textAlign: 'center', color: '#C485E0', fontFamily: 'Syne, sans-serif', fontWeight: 800 }}>{row[1]}</td>
        ...
        {/* 3. 작동 원리 */}
        <section>
          <h2 style={{ fontFamily: 'Syne, sans-serif', fontSize: '20px', fontWeight: 700, marginBottom: '12px' }}>본 도구의 작동 원리</h2>
        ...
        {/* 4. 정확도 한계 */}
        <section>
          <h2 style={{ fontFamily: 'Syne, sans-serif', fontSize: '20px', fontWeight: 700, marginBottom: '12px' }}>측정 정확도 한계 (중요)</h2>
        ...
        {/* 5. 한국 노래 키 매칭 */}
        <section>
          <h2 style={{ fontFamily: 'Syne, sans-serif', fontSize: '20px', fontWeight: 700, marginBottom: '12px' }}>한국 노래 키 매칭</h2>
          <p style={{ fontSize: '14px', color: 'var(--muted)', lineHeight: 1.85, marginBottom: '12px' }}>
        ...
        {/* 6. 보컬 트레이닝 효과 추적 */}
        <section>
          <h2 style={{ fontFamily: 'Syne, sans-serif', fontSize: '20px', fontWeight: 700, marginBottom: '12px' }}>보컬 트레이닝 효과 추적</h2>
          <p style={{ fontSize: '14px', color: 'var(--muted)', lineHeight: 1.85, marginBottom: '12px' }}>
        ...
        {/* 7. 음역대 늘리기 일반 정보 */}
        <section>
          <h2 style={{ fontFamily: 'Syne, sans-serif', fontSize: '20px', fontWeight: 700, marginBottom: '12px' }}>음역대 늘리기 — 일반 정보</h2>
        ...
        <section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '10px' }}>
            {[
              { href: '/tools/music/frequency', icon: '🎵', name: '주파수 음정 변환기',  desc: 'Hz ↔ 음정·MIDI 번호' },
              { href: '/tools/music/capo',      icon: '🎸', name: '기타 카포 계산기',     desc: '카포 위치·키 변경' },
              { href: '/tools/music/chord',     icon: '🎼', name: '코드 구성음',         desc: '코드별 음정 표시' },
              { href: '/tools/music/bpm',       icon: '🎛️', name: 'BPM 딜레이 계산기',   desc: '딜레이·리버브 ms' },
              { href: '/tools/music/tap-tempo', icon: '🥁', name: '탭 템포',             desc: 'BPM 즉시 측정' },
            ].map(t => (
