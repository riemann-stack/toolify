...
export const VOCAL_RANGES: VocalRange[] = [
  mk('bass',         '베이스',     'Bass',   'E2', 'E4', '남성 가장 낮은 음역',   '이정·김광진',   '#3EC8FF', 'male'),
  mk('baritone',     '바리톤',     'Baritone', 'G2', 'G4', '남성 중간 음역',         '성시경·박효신', '#3EFF9B', 'male'),
  mk('tenor',        '테너',       'Tenor',   'C3', 'C5', '남성 높은 음역',          '이수·휘성',     '#FFD700', 'male'),
  mk('countertenor', '카운터테너', 'Countertenor', 'E3', 'E5', '남성 매우 높은 음역', '폴 포츠',        '#FF8C3E', 'male'),
  mk('contralto',    '콘트랄토',   'Contralto', 'F3', 'F5', '여성 가장 낮은 음역',   '이은미',         '#C485E0', 'female'),
  mk('alto',         '알토',       'Alto',     'G3', 'G5', '여성 중간 음역',         '아이유 (저음)',   '#FF6BD9', 'female'),
  mk('mezzo',        '메조소프라노', 'Mezzo',   'A3', 'A5', '여성 중상 음역',         '백지영·태연',     '#FF6B6B', 'female'),
