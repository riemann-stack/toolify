...
const FAQ_LD = [
  { "q":"측정값이 speedtest.net과 다릅니다. 왜인가요?","a":"speedtest.net 등 일반 속도 측정 사이트는 가장 가까운 자체 서버로 측정합니다 (광케이블 거리 최소화). 본 도구는 실제 티켓팅 경로에 가까운 환경(Vercel KR Edge)으로 측정하므로 실용적 결과가 나옵니다. 핑은 서로 비슷하게 나오고, 다운로드 속도는 본 도구가 더 보수적일 수 있습니다." },
  ...
  { "q":"지터가 큰데 핑은 낮습니다. 사용해도 되나요?","a":"티켓팅에는 적합하지 않습니다. 평균 핑 30ms·지터 50ms = 어떤 요청은 90ms+ — 운 나쁘면 매진. 원인 점검 — ① Wi-Fi 2.4GHz→5GHz 전환, ② 라우터 근처 전자레인지·블루투스 끄기(2.4GHz 간섭), ③ 같은 Wi-Fi의 다른 기기 트래픽 줄이기, ④ 가능하면 유선 LAN 연결." },
  { "q":"5G인데 핑이 100ms 넘게 나옵니다.","a":"5G도 기지국 거리·시간대·5G 모드로 큰 차이가 납니다. ① 5G NSA(Non-Standalone)보다 SA(Standalone)가 핑이 더 낮고, ② 실내 5G는 신호가 약하며(특히 지하·고층), ③ 혼잡한 시간대(저녁 8~11시)는 LTE보다 느려질 수 있습니다. 실내에서 5G 핑이 LTE보다 나쁘면 일시적으로 4G/LTE 우선 모드로 전환을 검토하세요." },
        ...
        <section>
          ...
          <details style={faqDetails}>
            ...
            <div style={faqAnswer}>
              ...
              핑은 서로 비슷하게 나오고, 다운로드 속도는 본 도구가 더 보수적일 수 있습니다.
            </div>
          </details>
