...
export default function ContactPage() {
  ...
  return (
    <div style={{ maxWidth: '720px', margin: '0 auto', padding: '60px 24px 80px' }}>
      ...
      <h1 style={{ fontFamily: 'Inter, "Noto Sans KR", system-ui, sans-serif', fontSize: 'clamp(28px, 5vw, 42px)', fontWeight: 800, letterSpacing: '-1px', marginBottom: '14px' }}>
        문의하기
      </h1>
      ...
      {/* 카테고리 안내 */}
      <h2 style={{ fontFamily: 'Inter, "Noto Sans KR", system-ui, sans-serif', fontSize: '20px', fontWeight: 700, marginBottom: '14px' }}>
        문의 카테고리 안내
      </h2>
      ...
      <div style={{ background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: '12px', padding: '16px 18px', marginBottom: '40px' }}>
        <dl style={{ display: 'grid', gridTemplateColumns: '90px 1fr', rowGap: '10px', columnGap: '14px', fontSize: '13px' }}>
          ...
          <dd style={{ color: 'var(--text)', fontFamily: 'Inter, "Noto Sans KR", system-ui, sans-serif', fontWeight: 600 }}>youtil.kr</dd>
