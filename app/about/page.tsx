...
export const metadata: Metadata = {
  title: 'Youtil 소개 — 무료 온라인 도구 모음',
  description: 'Youtil은 연봉 계산기, BMI, 로또 번호 생성기 등 일상에서 자주 쓰는 도구를 무료로 제공하는 서비스입니다.',
}

const categories = [
  { icon: '💰', name: '금융·재테크',   tools: ['연봉 실수령액 계산기', '대출이자 계산기', '복리 계산기'] },
  { icon: '🏃', name: '건강·피트니스', tools: ['BMI 계산기', '기초대사량 계산기', '러닝 페이스 계산기'] },
  { icon: '🎲', name: '생활·재미',     tools: ['로또 번호 생성기', '랜덤 추첨기', '사다리타기'] },
  ...
  return (
    <div style={{ maxWidth: '720px', margin: '0 auto', padding: '60px 24px 80px' }}>
      ...
      <p style={{ fontSize: '16px', color: 'var(--muted)', lineHeight: 1.8, marginBottom: '48px', maxWidth: '560px' }}>
        Youtil은 일상에서 자주 필요한 계산기와 유틸리티 도구를 한 곳에 모아둔 무료 서비스입니다.
