...
export const categories: Category[] = [
  ...
  },
  {
    ...
    tools: [
      ...
      { href: '/tools/health/blood-alcohol', icon: '🍺', name: '혈중알코올 소멸 계산기',     desc: 'BAC 추정·운전 가능 시각·다음날 아침 숙취 운전 체크·1차·2차·3차 누적·ALDH2 분해 속도' },
      { href: '/tools/health/supplement',    icon: '💊', name: '영양제 성분 체크 계산기',   desc: '50종 영양소 합산·오메가3 EPA+DHA·약물 상호작용·임산부·고령자 안전 체크' },
      { href: '/tools/health/uv-protection', icon: '☀️', name: '자외선 노출 가이드 계산기', desc: 'UV 지수·피부 타입·SPF 기준 일광화상 위험 시간과 자외선 차단 가이드' },
      { href: '/tools/health/cycle',           icon: '🌙', name: '생리주기·배란일 캘린더 계산기', desc: '마지막 생리일·평균 주기 → 다음 생리·배란일·가임기·PMS 원형 시각화 + 월간 캘린더 + phase별 컨디션 가이드 + localStorage 자가체크 (서버 X)', badge: 'hot' },
    ],
  },
  {
    ...
    tools: [
      ...
      { href: '/tools/cooking/microwave', icon: '🔥', name: '전자레인지 출력·시간 환산', desc: '600~1200W 양방향 환산 + 한국 시장 12 식품 프리셋(햇반·만두·즉석국 등) + 양·온도 보정 + 카운트다운 타이머·알림음 + 안전 가이드', badge: 'hot' },
  ...
  },
  {
    ...
    tools: [
      ...
      { href: '/tools/life/packing',       icon: '🧳', name: '여행 옷·짐 계산기',     desc: '일수·기온·세탁 가능·활동량·사진 중요도 → 카테고리별 옷 개수 + 최소/넉넉 2 버전 + 체크리스트(잡화·세면·서류) + 캐리어 추천', badge: 'new' },
      { href: '/tools/life/customs',       icon: '📦', name: '해외직구 관부가세 계산기', desc: '미국·중국·유럽·일본 면세 한도 자동 + 30+ 품목 관세율 + 목록통관/일반통관 자동 + 부가세·개소세 + 한국 백화점 비교', badge: 'new' },
  ...
  },
  {
    ...
    tools: [
      ...
      { href: '/tools/sports/golf-distance',     icon: '🎯', name: '골프 클럽 비거리 계산기', desc: 'DR·7I 입력 → 전체 클럽 비거리 자동 추정 + 환경 보정(바람·고도·기온) + Gap 자동 분석 + 내 기록', badge: 'hot' },
    ],
  },
  {
    ...
    tools: [
      ...
      { href: '/tools/interior/screw',         icon: '🔩', name: '나사 규격·탭드릴 계산기',     desc: 'M·UNC·UNF·PT·목재·석고 7종 → 탭드릴·관통홀·파일럿홀·육각/스패너 사이즈 + 인치↔mm + 자주 쓰는 사이즈 표', badge: 'new' },
      { href: '/tools/interior/bolt-wrench',   icon: '🔧', name: '볼트·너트 스패너 사이즈 계산기', desc: 'M3~M24 + ISO/DIN/KS vs 옛 JIS 비교 + 알렌렌치·와셔·너트·토크등급 + 공구 세트 추천 4프리셋', badge: 'new' },
      ...
      { href: '/tools/interior/wire',          icon: '⚡', name: '전선 굵기·허용전류 계산기',     desc: 'KEC 2021 기반 + W↔A↔sq 양방향 + 전압강하·차단기 자동 + 한국 가전 12프리셋 (에어컨·EV충전기·인덕션)', badge: 'new' },
  ...
  },
  {
    ...
    tools: [
      { href: '/tools/unit/converter',     icon: '📐', name: '통합 단위 변환기',         desc: '길이·면적·무게·부피·온도·시간·속도·압력·토크·에너지·데이터 11개 + kgf/cm²·N·m·kgf·m·lbf·ft·kWh·kcal·BTU + 한국 전통 단위(자·근·돈·평·홉·되)', badge: 'hot' },
      { href: '/tools/unit/area',          icon: '🏠', name: '평수 ↔ ㎡ 변환기',          desc: '아파트 평형 환산, 전용·공급·계약면적, 평형별 방 크기 가이드' },
      { href: '/tools/unit/size',          icon: '🛍️', name: '해외 직구 사이즈 변환기',    desc: 'US·EU·UK → 한국 의류·신발·속옷·반지 사이즈, 브랜드별 차이 가이드', badge: 'hot' },
  ...
  },
  {
    ...
    tools: [
      { href: '/tools/date/age',         icon: '🎂', name: '만 나이·생일·인생 통계 계산기', desc: '만 나이부터 D-day, 1만일 기념, 인생 시간 통계, 띠·별자리·생일 카운트다운까지' },
  ...
  },
  {
    ...
    tools: [
      /* 🎵 음악 */
      { href: '/tools/art/vocal-range', icon: '🎤', name: '보컬 음역대 측정기', desc: '마이크로 실시간 음정 감지, 최저음·최고음 자동 측정, 한국 노래 30+ 곡 키 매칭', badge: 'new' },
      ...
      { href: '/tools/art/capo',      icon: '🎸', name: '기타 카포·전조 계산기', desc: '카포 위치별 코드 변환·쉬운 코드 추천' },
      ...
      { href: '/tools/art/fov',       icon: '📷', name: '카메라 화각 (35mm 환산)', desc: '풀프레임·APS-C·M4/3·1인치·스마트폰 7종 센서 × 4-800mm 35mm 환산 + 수평/수직/대각 화각 + 시야 너비 + 등가 조리개 + 인기 8개 초점거리 SVG 비교 + 10 용도별 추천 렌즈', badge: 'new' },
      /* ✍️ 글쓰기·콘텐츠 */
      { href: '/tools/art/charcount', icon: '🔡', name: '글자수 세기',          desc: '공백 포함·제외 실시간 카운트', badge: 'hot' },
      { href: '/tools/art/lorem',     icon: '📝', name: '더미 텍스트·UI 콘텐츠 생성기', desc: '문단·버튼·카드·리뷰·JSON 더미 데이터까지 UI 목업에 바로 쓸 수 있는 종합 더미 콘텐츠 생성기' },
    ],
  },
  {
    id: 'edu', icon: '🔬', name: '교육·학습', color: '#3EFFD0',
    tools: [
      { href: '/tools/edu/planet-comparison', icon: '🪐', name: '행성 비교 시각화', desc: '8개 행성에서 내 몸무게·나이·하루 길이가 어떻게 다른지 시각화', badge: 'hot' },
  ...
  },
  {
    ...
    tools: [
      ...
      { href: '/tools/dev/hash', icon: '🔒', name: '해시 생성기 (MD5·SHA·HMAC)', desc: 'MD5·SHA-1·SHA-256·SHA-512 동시 생성 + HMAC 서명(GitHub/Slack/AWS/JWT) + 파일 무결성 검증 + SRI 해시. 안전성 등급 + 보안 경고. 모든 계산 브라우저 측', badge: 'new' },
