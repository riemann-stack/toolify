...
export const categories: Category[] = [
  ...
  },
  {
    ...
    tools: [
      ...
      { href: '/tools/life/golf-handicap',     icon: '⛳', name: '골프 핸디캡 계산기',     desc: 'WHS 핸디캡 지수·코스 핸디캡·네트·스태블포드 + 라운드 자동 저장 + 발전 추이 + 자주 가는 골프장' },
      { href: '/tools/life/golf-cost',         icon: '🏌️', name: '골프 라운딩 비용 계산기', desc: '그린피·카트·캐디·식사·교통 1인당 정산 + 회원권 손익 + 자주 가는 골프장 저장' },
      { href: '/tools/life/golf-distance',     icon: '🎯', name: '골프 클럽 비거리 계산기', desc: 'DR·7I 입력 → 전체 클럽 비거리 자동 추정 + 환경 보정(바람·고도·기온) + Gap 자동 분석 + 내 기록' },
    ],
  },
  {
