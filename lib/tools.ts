...
export const categories: Category[] = [
  {
    id: 'finance', icon: '💰', name: '금융·재테크', color: 'var(--cat-finance)', tagline: '연봉 · 대출 · 연말정산 · 배당',
    tools: [
  ...
  {
    id: 'health', icon: '🏃', name: '건강·웰빙', color: 'var(--cat-health)', tagline: 'BMI · 칼로리 · 임신 주수',
    tools: [
  ...
  {
    id: 'cooking', icon: '🍳', name: '요리·식품', color: 'var(--cat-cooking)', tagline: '레시피 · 베이킹 · 커피',
    tools: [
  ...
  {
    id: 'life', icon: '🎲', name: '생활·재미', color: 'var(--cat-life)', tagline: '로또 · 더치페이 · 사다리',
    tools: [
  ...
  {
    id: 'sports', icon: '⛳', name: '스포츠', color: 'var(--cat-sports)', tagline: '러닝 페이스 · 골프 · 등산',
    tools: [
  ...
  {
    id: 'interior', icon: '🏠', name: '주거·인테리어', color: 'var(--cat-interior)', tagline: '평수 · 도배 · 에어컨 평형',
    tools: [
  ...
  {
    id: 'unit', icon: '📐', name: '단위·변환', color: 'var(--cat-unit)', tagline: '평↔㎡ · 사이즈 · 연비',
    tools: [
  ...
  {
    id: 'date', icon: '📅', name: '날짜·시간', color: 'var(--cat-date)', tagline: '만 나이 · D-Day · 전역일',
    tools: [
  ...
  {
    id: 'art', icon: '🎨', name: '예술·창작', color: 'var(--cat-art)', tagline: '음악 · 색상 · 글자수',
    tools: [
      /* 🎵 음악 */
  ...
  {
    id: 'edu', icon: '🔬', name: '교육·학습', color: 'var(--cat-edu)', tagline: '학점 환산 · 복습 간격',
    tools: [
  ...
  {
    id: 'dev', icon: '🖥️', name: '개발자', color: 'var(--cat-dev)', tagline: 'JSON · 정규식 · Base64',
    tools: [
